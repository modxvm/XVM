...
class BitmapWrapper extends Object
{
    ...
    private function onFail(param1:Event) : void
    {
        ...
        this.failed = true;
        this.counter = this.counter - this.onLoadCallbackList.length;
        this.onLoadCallbackList = null;
        this.loader.close();
        this.loader = null;
    }
    ...
    {
        return "[BitmapWrapper" + " imageId:" + this.imageId + " bitmap:" + this.bitmapData + " counter:" + this.counter + " callbacks_len:" + (this.onLoadCallbackList?this.onLoadCallbackList.length:"null") + " failed:" + this.failed + "]";
    }
}
