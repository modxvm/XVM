package net.wg.mock.utils
{
    ...
    public class MockClassFactory extends Object implements IClassFactory
    {
        ...
        public function getComponent(param1:String, param2:Class, param3:Object = null, param4:LoaderInfo = null) : *
        {
            ...
            var _loc6_:* = "object with \"" + param1 + "\" linkage ";
            var _loc7_:* = _loc6_ + "is not a component from library!";
