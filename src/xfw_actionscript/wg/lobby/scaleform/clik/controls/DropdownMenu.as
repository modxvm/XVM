    ...
    public class DropdownMenu extends Button
    {
        ...
        public function set selectedIndex(param1:int) : void
        {
            ...
            if(this._dropdownRef != null)
            {
                ...
                dispatchEventAndSound(new ListEvent(ListEvent.INDEX_CHANGE,true,false,this._selectedIndex,-1,-1,_loc2_.getRendererAt(this._selectedIndex,_loc3_),this._dataProvider?this._dataProvider.requestItemAt(this._selectedIndex):-1));
            }
        }
        ...
        public function set dataProvider(param1:IDataProvider) : void
        {
            ...
            var _loc2_:int = this._dataProvider == null?0:this._dataProvider.length;
