...
class StatsEntity extends Object
{
    ...
    public function set initTime(param1:Number) : void
    {
        ...
        this._initTime = this._initTime > 0?this._initTime + param1 >> 1:param1;
    }
    ...
    public function set loadTime(param1:Number) : void
    {
        ...
        this._loadTime = this._loadTime > 0?this._loadTime + param1 >> 1:param1;
    }
