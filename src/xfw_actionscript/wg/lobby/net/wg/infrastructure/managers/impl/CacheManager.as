package net.wg.infrastructure.managers.impl
{
    ...
    public class CacheManager extends CacheManagerMeta implements ICacheManager
    {
        ...
        {
            super();
            this.cachedEntities = new Vector.<CacheManager>();
        }
        ...
        public function add(param1:String, param2:Loader, param3:Class = null) : Boolean
        {
            ...
            {
                DebugUtils.LOG_WARNING(CacheManager.LOG_ID + " Not enough memory for the caching: entity \'" + _loc4_.url + "\' wasn\'t cached.");
                _loc4_.dispose();
...
class CacheSettings extends Object
{
    ...
    function CacheSettings(param1:Object)
    {
        ...
        if(param1)
        {
            ...
            if(this.forceCache)
            {
                DebugUtils.LOG_WARNING(CacheSettings.LOG_ID + " forceCache mode is enabled.");
            }
...
class CacheEntity extends Object
{
...
class CacheStats extends Object
{
    ...
    public function addSnapshot(param1:Vector.<CacheEntity>) : void
    {
        ...
        _loc2_ = _loc2_ + ("\n\tCache memory used:\t" + String(this.cacheManager.getTotalSize() / CacheStats.BYTES_IN_MB) + " MB");
        _loc2_ = _loc2_ + "\n";
        this.snapshots.push(_loc2_);
    }
