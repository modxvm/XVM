...
class TimedTaskStack extends Object implements IDisposable
{
    ...
    {
        super();
        this._tasks = new Vector.<TimedTaskStack>();
    }
...
class InProcessTaskStack extends Object implements IDisposable
{
    ...
    {
        super();
        this._tasks = new Vector.<InProcessTaskStack>();
    }
...
class NextFrameTasks extends Object implements IDisposable
{
    ...
    {
        super();
        this._tasks = new Vector.<NextFrameTasks>();
