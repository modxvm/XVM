package net.wg.gui.rally.controls
{
    public class RallyInvalidationType extends Object
    {
        ...
        public static const TEAM_LABEL:String = "teamLabel";

        public static const ACTION_BUTTON_DATA:String = "actionButtonData";

        public static const ROOM_STATUS_BUTTON_DATA:String = "roomStatusButtonData";

        public static const CONFIGURE_BUTTON_DATA:String = "configureButtonData";
