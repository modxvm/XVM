package net.wg.gui.utils
{
    ...
    public class FrameHelper extends Object implements IFramesHelper
    {
        ...
        public function getFrameBeforeLabel(param1:String) : int
        {
            ...
            return _loc2_ != NOT_EXIST_INDEX && _loc2_ > 0?_loc2_ - 1:NOT_EXIST_INDEX;
        }
        ...
        public function getFrameByLabel(param1:String) : int
        {
            ...
            return _loc2_?this._frames[param1]:NOT_EXIST_INDEX;
        }
