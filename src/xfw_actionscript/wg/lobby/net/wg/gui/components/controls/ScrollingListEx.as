package net.wg.gui.components.controls
{
    ...
    public class ScrollingListEx extends CoreListEx
    {
        ...
        protected function navigateSelection(param1:int, param2:ListSelectionDirection) : void
        {
            ...
            {
                var param1:int = this._selectionNavigator.navigate(param1,param2,this.isKeyScrollingRecurrent());
                if(param1 != -1)
                {
                    this.selectedIndex = param1;
                }
        ...
        {
            var param1:Number = _dataProvider?Math.max(0,Math.min(_dataProvider.length - _totalRenderers,Math.round(param1))):0;
