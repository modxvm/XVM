package net.wg.gui.components.controls
{
    ...
    public class DropdownMenuPrice extends DropdownMenu
    {
        ...
        private static const IMG_HTML_TAG_REG_EXP:RegExp = new RegExp(new RegExp("<IMG[ ]+SRC=","ig"));
        ...
        override protected function updateAfterStateChange() : void
        {
            ...
            textField.alpha = this.textFieldAction.alpha = this.textFieldWithoutIco.alpha = this.enabled?ENABLE_ALPHA:DISABLE_ALPHA;
        }
