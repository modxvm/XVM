package net.wg.gui.components.crosshairPanel
{
    ...
    public class CrosshairPanelSniperCameraTransitionFx extends Object implements IDisposable
    {
        ...
        {
            this._direction = param1 == ACTIVE_GUN_ID_RIGHT?DIRECTION_LEFT:DIRECTION_RIGHT;
        }
        ...
        private function updatePosition(param1:Number) : void
        {
            ...
            if(_loc3_ > 0)
            {
                _loc4_ = _loc4_ - 2 * CROSSHAIR_X_OFFSET;
            }
