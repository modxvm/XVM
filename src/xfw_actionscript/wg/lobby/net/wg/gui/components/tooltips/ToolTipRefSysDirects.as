package net.wg.gui.components.tooltips
{
    ...
    public class ToolTipRefSysDirects extends ToolTipSpecial
    {
        ...
        override protected function updateSize() : void
        {
            ...
            {
                background.height = background.height - DIR_OFFSET;
            }
            if(!this._model.infoValue1.length)
            {
                background.height = background.height - TEXT_OFFSET;
            }
        ...
        {
            this._infoDescription1TF.y = this._infoDescription1TF.y - param1;
            this._infoValue1TF.y = this._infoValue1TF.y - param1;
            this._infoIconValue1.y = this._infoIconValue1.y - param1;
        }

        private function offsetDescription2(param1:int) : void
        {
            this._infoDescription2TF.y = this._infoDescription2TF.y - param1;
            this._infoValue2TF.y = this._infoValue2TF.y - param1;
            this._infoIconValue2.y = this._infoIconValue2.y - param1;
        }

        private function offsetDescription3(param1:int) : void
        {
            this._infoDescription3TF.y = this._infoDescription3TF.y - param1;
            this._infoValue3TF.y = this._infoValue3TF.y - param1;
            this._infoIconValue3.y = this._infoIconValue3.y - param1;
        }
        ...
        override protected function updatePositions() : void
        {
            ...
            this._infoBack.y = this._infoBack.y - _loc2_;
            this._infoTotalValueTF.y = this._infoTotalValueTF.y - _loc2_;
            ...
            this._infoIconTotalValue.y = this._infoIconTotalValue.y - _loc2_;
            ...
            if(!this._model.infoValue1.length)
            {
                ...
                this._infoTotalDescriptionTF.y = this._infoTotalDescriptionTF.y - TEXT_OFFSET;
                _loc3_.y = _loc3_.y - TEXT_OFFSET;
            }
            if(!this._model.infoValue2.length)
            {
        ...
        private function setData() : void
        {
            ...
            this._infoTotalValueTF.htmlText = this._model.infoTotalValue?_loc1_.integer(this._model.infoTotalValue):this._model.infoTotalValue;
            this._infoDescription1TF.htmlText = this._model.infoDescription1;
            this._infoValue1TF.htmlText = this._model.infoValue1?_loc1_.integer(this._model.infoValue1):this._model.infoValue1;
            this._infoDescription2TF.htmlText = this._model.infoDescription2;
            this._infoValue2TF.htmlText = this._model.infoValue2?_loc1_.integer(this._model.infoValue2):this._model.infoValue2;
            this._infoDescription3TF.htmlText = this._model.infoDescription3;
            this._infoValue3TF.htmlText = this._model.infoValue3?_loc1_.integer(this._model.infoValue3):this._model.infoValue3;
