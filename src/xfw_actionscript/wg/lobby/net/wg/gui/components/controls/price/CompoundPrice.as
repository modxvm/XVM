package net.wg.gui.components.controls.price
{
    ...
    public class CompoundPrice extends UIComponentEx
    {
        ...
        private function updatePositions() : void
        {
            ...
            var _loc4_:* = this._itemsDirection == DIRECTION_LEFT;
            var _loc5_:* = this._itemsDirection == DIRECTION_RIGHT;
            var _loc6_:* = this._itemsDirection == DIRECTION_UP;
            var _loc7_:* = this._itemsDirection == DIRECTION_DOWN;
            var _loc8_:Boolean = _loc4_ || _loc5_;
            var _loc9_:* = !_loc8_;
            var _loc10_:int = _loc8_?PRICES_HORIZONTAL_OFFSET:PRICES_VERTICAL_OFFSET;
            ...
            var _loc16_:int = _loc11_?-1:1;
            var _loc17_:Number = 0;
            var _loc18_:Number = 0;
            var _loc20_:* = 0;
            while(_loc20_ < _loc2_)
            {
                _loc19_ = _loc11_?_loc2_ - 1 - _loc20_:_loc20_;
                _loc3_ = this._items[_loc19_];
                _loc3_.validateNow();
                _loc3_.x = _loc3_.y = 0;
                if(_loc4_)
                {
                    _loc1_ = _loc1_ + -_loc3_.contentWidth;
                    _loc3_.x = _loc1_;
                }
                else if(_loc5_)
                {
                ...
                {
                    _loc1_ = _loc1_ + -_loc3_.contentHeight;
                    _loc3_.y = _loc1_;
                }
                else if(_loc7_)
                {
                ...
                {
                    _loc1_ = _loc1_ + _loc10_ * _loc16_;
                }
                if(_loc9_ && this._itemsAnchor == ANCHOR_BOTTOM_RIGHT)
                {
                    _loc3_.x = _loc3_.x - _loc3_.contentWidth;
                }
                _loc17_ = _loc3_.x + _loc3_.contentWidth;
                _loc18_ = _loc3_.y + _loc3_.contentHeight;
                _loc12_ = _loc3_.x < _loc12_?_loc3_.x:_loc12_;
                _loc14_ = _loc3_.y < _loc14_?_loc3_.y:_loc14_;
                _loc13_ = _loc17_ > _loc13_?_loc17_:_loc13_;
                _loc15_ = _loc18_ > _loc15_?_loc18_:_loc15_;
                _loc20_++;
            }
            this.hit.x = _loc12_;
            this.hit.y = _loc14_;
