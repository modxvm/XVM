package net.wg.gui.components.questProgress
{
    ...
    public class ItemRendererTabView extends ItemRenderer
    {
        ...
        override public function init(param1:IQPInitData) : void
        {
            ...
            var _loc3_:int = orderType == QUEST_PROGRESS_BASE.ADD_ORDER_TYPE?MAX_TEXT_FIELD_WIDTH_FOR_ORDER_ADD:MAX_TEXT_FIELD_WIDTH_FOR_ORDER_MAIN;
        ...
        override protected function doLayout() : void
        {
            ...
            var _loc1_:* = orderType == QUEST_PROGRESS_BASE.ADD_ORDER_TYPE;
            ...
            {
                _loc2_.y = _loc2_.y + (_loc4_.componentHeight + TEXT_FIELDS_Y_GAP);
            }
            if(this.alertLabel.visible)
            {
                this.alertLabel.y = _loc2_.y;
                _loc2_.y = _loc2_.y + (this.alertLabel.height + TEXT_FIELDS_Y_GAP);
            }
            if(this.descrTf.visible)
            {
                this.descrTf.y = _loc2_.y;
                _loc2_.y = _loc2_.y + (this.descrTf.height + TEXT_FIELDS_Y_GAP);
            }
            if(this.multiplierTf.visible)
            {
                _loc2_.y = _loc2_.y + MULTIPLIER_TF_Y_GAP;
                this.multiplierTf.y = _loc2_.y;
                this.multiplierIcon.y = _loc2_.y + MULTIPLIER_ICON_Y_GAP;
                _loc2_.y = _loc2_.y + (this.multiplierTf.height + TEXT_FIELDS_Y_GAP);
            }
        ...
        private function setMetricPosition(param1:IMetricsComponent, param2:Point, param3:Boolean) : Point
        {
            if(param1.visible)
            {
                ...
                if(param3)
                {
                    param2.y = param2.y + (param1.componentHeight + TEXT_FIELDS_Y_GAP);
                }
                else
                {
                    param2.x = param2.x + (param1.componentWidth + METRICS_X_GAP_POINT);
                }
            }
            return param2;
        }
