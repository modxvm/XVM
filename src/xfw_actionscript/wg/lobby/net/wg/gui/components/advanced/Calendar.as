package net.wg.gui.components.advanced
{
    ...
    public class Calendar extends CalendarMeta implements ICalendarMeta, IFocusContainer
    {
        ...
        public function setStatus(param1:String, param2:String) : void
        {
            ...
            this.monthDaysContainer.y = this.monthDaysContainer.y + (this.statusLbl.height + STATUS_LBL_GAP);
            this.weekDaysContainer.y = this.weekDaysContainer.y + (this.statusLbl.height + STATUS_LBL_GAP);
            this.headerSeparator.y = this.headerSeparator.y + (this.statusLbl.height + STATUS_LBL_GAP);
            this.bottomSeparator.y = this.bottomSeparator.y + (this.statusLbl.height + STATUS_LBL_GAP);
        }
        ...
        private function updateMonthDays() : void
        {
            ...
            var _loc5_:* = this._lastVisibleIndex / Time.DAYS_IN_WEEK | 0;
        ...
        {
            dispatchEvent(new CalendarEvent(param1,this._dateTime.cloneDate(this._displayDate),this._currentSelectedDate?this._dateTime.cloneDate(this._currentSelectedDate):null));
        }
        ...
        private function getDayRowByDate(param1:Date, param2:Number = -1) : Number
        {
            if(param2 == -1)
            {
                var param2:Number = this.getWeekShift(param1);
            }
