    ...
    public class TutorialContextOverlay extends UIComponentEx
    {
        ...
        private function layoutHints() : void
        {
            ...
            while(_loc4_ < _loc1_)
            {
                ...
                _loc3_.width = _loc2_.width != Values.DEFAULT_INT?_loc2_.width:_width - _loc2_.padding.left - _loc2_.padding.right;
                _loc3_.height = _loc2_.height != Values.DEFAULT_INT?_loc2_.height:_height - _loc2_.padding.top - _loc2_.padding.bottom;
                _loc4_++;
            }
        }
