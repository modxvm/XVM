package net.wg.gui.components.carousels
{
    ...
    public class VehiclesFilterPopoverContent extends UIComponentEx
    {
        ...
        private static function listSetState(param1:SimpleTileList, param2:Vector.<Boolean>) : void
        {
        ...
        protected function getNewHeight(param1:int) : int
        {
            ...
            var param1:int = this.listNationType.y + this.listNationType.height + LIST_OFFSET;
