package net.wg.gui.components.tooltips
{
    ...
    public class ToolTipBuySkill extends ToolTipBase
    {
        ...
        private function getContDimension() : Dimension
        {
            ...
            _loc2_ = _loc2_ > this.header.textWidth?_loc2_:this.header.textWidth;
            ...
            if(_loc3_ != null)
            {
                _loc2_ = _loc2_ > _loc3_.width?_loc2_:_loc3_.width;
            }
            _loc2_ = _loc2_ < MAC_WIDTH?MAC_WIDTH:_loc2_;
            _loc1_.width = _loc2_ | 0;
            _loc1_.height = this.skillLevel?this.skillLevel.y + this.skillLevel.height + SKILL_LEVEL_HEIGHT_SHIFT | 0:this.skillCount?this.skillCount.y + this.skillCount.height + SKILL_LEVEL_HEIGHT_SHIFT | 0:_loc1_.height;
            return _loc1_;
        }
    }
}
