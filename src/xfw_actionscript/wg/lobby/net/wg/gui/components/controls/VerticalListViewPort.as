package net.wg.gui.components.controls
{
    ...
    public class VerticalListViewPort extends UIComponentEx implements IScrollerViewPortBase
    {
        ...
        private function updateAssertCacheValue() : void
        {
            ...
            this._assertCacheValue = _loc1_ > this._assertCacheValue?_loc1_:this._assertCacheValue;
        }
        ...
        private function getDefRendererHeight() : int
        {
            ...
            if(this._defRendererHeight <= 0)
            {
                ...
                this._defRendererHeight = _loc1_.height || MIN_DEF_RENDERER_HEIGHT;
        ...
        {
            return this._dataLen > 0?this.getRendererBottomY(this._dataLen - 1):0.0;
        }
        ...
        {
            return this._dataLen > 0?this.getRendererBottomY(this._dataLen - 1):0;
        }
