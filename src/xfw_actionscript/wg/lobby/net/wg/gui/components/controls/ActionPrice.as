package net.wg.gui.components.controls
{
    ...
    public class ActionPrice extends UIComponentEx implements ITextContainer
    {
        ...
        private function updateHitArea(param1:String) : void
        {
            ...
            switch(param1)
            {
                case ACTION_PRICE_CONSTANTS.STATE_CAMOUFLAGE:
                    _loc2_ = this.alertIco.visible?this.alertIco.x:this.textField.x + this.textField.width - this.textField.textWidth + TEXT_FIELD_LEFT_PADDING;
                ...
                case ACTION_PRICE_CONSTANTS.STATE_ALIGN_TOP:
                    ...
                    if(this.alertIco.visible)
                    {
                        this.hitMc.width = this._iconPosition == RIGHT_LBL?Math.abs(this.hitMc.x):Math.abs(this.hitMc.x - this.bg.x);
                    }
                    else
                    {
                        this.hitMc.width = this._iconPosition == RIGHT_LBL?Math.abs(this.hitMc.x):Math.abs(this.bg.x);
                    }
        ...
        override public function set enabled(param1:Boolean) : void
        {
            ...
            this.alpha = param1?ENABLE_ALPHA:DISABLE_ALPHA;
            this.updateEnabledMode();
