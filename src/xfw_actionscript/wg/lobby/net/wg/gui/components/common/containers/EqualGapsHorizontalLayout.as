package net.wg.gui.components.common.containers
{
    ...
    public class EqualGapsHorizontalLayout extends GroupLayout
    {
        ...
        override public function invokeLayout() : Object
        {
            ...
            var _loc6_:int = this._paddingGap?_loc3_ + 1:_loc3_ - 1;
            var _loc7_:int = (this._availableSize - _loc4_) / _loc6_;
            var _loc8_:Boolean = _loc7_ >= 0?this._paddingGap:false;
            var _loc9_:int = _loc8_?_loc7_:0;
            _loc5_ = 0;
            while(_loc5_ < _loc2_)
            {
                _loc1_ = _target.getChildAt(_loc5_);
                ...
                {
                    _loc1_.x = _loc9_;
                    _loc9_ = _loc9_ + (_loc1_.width + _loc7_ | 0);
                }
                _loc5_++;
            }
            if(!_loc8_)
