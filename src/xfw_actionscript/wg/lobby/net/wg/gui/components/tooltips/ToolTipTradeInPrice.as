package net.wg.gui.components.tooltips
{
    ...
    public class ToolTipTradeInPrice extends ToolTipSpecial
    {
        ...
        override protected function updatePositions() : void
        {
            ...
            topPosition = topPosition + (this._titleTF.height + TITLE_PADDING);
            this._bodyTF.y = topPosition ^ 0;
            topPosition = topPosition + (this._bodyTF.height + SEPARATOR_TOP_PADDING);
            ...
            topPosition = topPosition + SEPARATOR_BOTTOM_PADDING;
