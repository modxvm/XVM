    ...
    public class ToolTipAchievement extends ToolTipSpecial
    {
        ...
        override protected function redraw() : void
        {
            ...
            if(_loc5_.icon)
            {
                ...
                topPosition = topPosition + (ICO_DIMENSION + Utils.instance.MARGIN_AFTER_BLOCK - ICO_SHADOW * 2);
            ...
            if(_loc5_.vehicles && _loc5_.vehicles.length > 0)
            {
                ...
                while(_loc2_ < _loc3_)
                {
                    _loc10_ = _loc10_ + Utils.instance.htmlWrapper(_loc1_.makeString(TOOLTIPS.ACHIEVEMENT_PARAMS + "/" + _loc5_.params[_loc2_].id),Utils.instance.COLOR_ADD_INFO,TITLE_FONT_SIZE,TITLE_FONT_NAME);
                    _loc2_++;
                }
                ...
                topPosition = topPosition + (this._vLeftTF.textHeight + Utils.instance.MARGIN_AFTER_BLOCK | 0);
                ...
                if(_loc5_.vehiclesLeft)
                {
                    ...
                    topPosition = topPosition + (this._notEnoughTF.textHeight + Utils.instance.MARGIN_AFTER_BLOCK | 0);
                }
                else
                {
            ...
            if(_loc5_.historyDescr)
            {
                ...
                this._historyTF.width = _loc4_ != 0?_loc4_ - _loc6_:this._historyTF.textWidth + 5;
                this._historyTF.x = _loc6_;
                this._historyTF.y = topPosition;
                topPosition = topPosition + (this._historyTF.textHeight + Utils.instance.MARGIN_AFTER_BLOCK | 0);
            ...
            if(!_loc5_.isInDossier)
            {
                ...
                topPosition = topPosition + (this._isInDossierTF.textHeight + Utils.instance.MARGIN_AFTER_BLOCK | 0);
            ...
            if(_loc9_)
            {
                ...
                this._rewardHeaderTF.width = _loc4_ != 0?_loc4_ - _loc6_:this._rewardHeaderTF.textWidth + TF_PADDING;
                this._rewardHeaderTF.visible = true;
                topPosition = topPosition + (this._rewardHeaderTF.textHeight + REWARD_HEADER_TO_LABELS_OFFSET_Y | 0);
                if(_loc14_)
                {
                    ...
                    while(_loc2_ < _loc3_)
                    {
                        this._rewardLabelTF.htmlText = this._rewardLabelTF.htmlText + _loc12_[_loc2_];
                        _loc16_ = Math.round(this._rewardLabelTF.textHeight / REWARDS_LINE_HEIGHT);
                        this._rewardValueTF.htmlText = this._rewardValueTF.htmlText + _loc13_[_loc2_];
                        _loc17_ = _loc16_ - _loc15_;
                        while(_loc17_ > 1)
                        {
                            this._rewardValueTF.htmlText = this._rewardValueTF.htmlText + BR_TAG;
                            _loc17_--;
                        }
                        _loc15_ = _loc16_;
                        _loc2_++;
                    ...
                    topPosition = topPosition + (this._rewardLabelTF.textHeight + Utils.instance.MARGIN_AFTER_BLOCK | 0);
        ...
        protected function applyDescriptionParams(param1:String, param2:Number, param3:Number) : void
        {
            if(param1)
            {
                ...
                this._descrTF.width = param2 != 0?param2 - param3:this._descrTF.textWidth + 5;
                this._descrTF.x = param3;
                this._descrTF.y = topPosition;
                topPosition = topPosition + (this._descrTF.textHeight + Utils.instance.MARGIN_AFTER_BLOCK | 0);
            }
            else
            {
                this._descrTF.x = 0;
        ...
        protected function applyConditionParams(param1:String, param2:Boolean, param3:Number, param4:Number) : void
        {
            ...
            if(param1)
            {
                ...
                this._conditionTF.width = param3 != 0?param3 - param4:this._conditionTF.textWidth + 5;
                this._conditionTF.x = param4;
                this._conditionTF.y = topPosition;
                topPosition = topPosition + (this._conditionTF.textHeight + Utils.instance.MARGIN_AFTER_BLOCK | 0);
            }
            else
            {
        ...
        protected function applyClassParams(param1:AchievementVO, param2:Number) : void
        {
            ...
            if(param1.classParams)
            {
                ...
                while(_loc6_ < _loc5_)
                {
                    _loc4_.leftText = _loc4_.leftText + (Utils.instance.htmlWrapper(App.utils.locale.integer(param1.classParams[_loc6_]),Utils.instance.COLOR_NUMBER,TEXT_FONT_SIZE,TEXT_FONT_NAME) + BR_TAG);
        ...
        private function addCustomBlock(param1:MovieClip, param2:Object, param3:Number) : Number
        {
            ...
            var param3:Number = param3 + CUSTOM_BLOCK_SHIFT;
            return param3;
        }
        ...
        private function getInfoText(param1:String, param2:Array, param3:Number, param4:String, param5:String = null, param6:Array = null) : String
        {
                ...
                switch(param1)
                {
                    case TYPE_SERIES:
                        ...
                        while(_loc10_ < _loc9_)
                        {
                            ...
                            _loc7_ = _loc7_ + Utils.instance.htmlWrapper(_loc11_,Utils.instance.COLOR_NORMAL,TEXT_FONT_SIZE,TEXT_FONT_NAME);
                            _loc10_++;
                        }
                        break;
                    case TYPE_CLASS:
            ...
            if(param5)
            {
                _loc7_ = _loc7_ + (BR_TAG + Utils.instance.htmlWrapper(_loc8_.makeString(TOOLTIPS.ACHIEVEMENT_ACHIEVEDON) + param5,Utils.instance.COLOR_SUB_NORMAL,TEXT_FONT_SIZE,TEXT_FONT_NAME));
            }
            if(param6)
            {
                _loc7_ = _loc7_ + (FONT_TAG + Utils.instance.htmlWrapper(_loc8_.makeString(TOOLTIPS.ACHIEVEMENT_CLOSETORECORD),Utils.instance.COLOR_ADD_INFO,TEXT_FONT_SIZE,TEXT_FONT_NAME));
                ...
                while(_loc10_ < _loc9_)
                {
                    ...
                    _loc7_ = _loc7_ + (BR_TAG + Utils.instance.htmlWrapper(_loc12_,Utils.instance.COLOR_SUB_NORMAL,TEXT_FONT_SIZE,TEXT_FONT_NAME));
                    _loc7_ = _loc7_ + Utils.instance.htmlWrapper(_loc13_,Utils.instance.COLOR_NUMBER,TEXT_FONT_SIZE,TEXT_FONT_NAME);
                    _loc10_++;
                }
            }
            return _loc7_;
