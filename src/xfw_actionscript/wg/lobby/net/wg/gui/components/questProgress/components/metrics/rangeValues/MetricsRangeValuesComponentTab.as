package net.wg.gui.components.questProgress.components.metrics.rangeValues
{
    ...
    public class MetricsRangeValuesComponentTab extends MetricsRangeValuesComponentBase
    {
        ...
        override protected function doUpdateState(param1:int) : void
        {
            ...
            var _loc3_:uint = _loc2_?QUEST_PROGRESS_BASE.QP_TEXT_COLOR_STATE_COMPLETED_VALUE:QUEST_PROGRESS_BASE.QP_TEXT_COLOR_STATE_IN_PROGRESS_VALUE;
            var _loc4_:uint = _loc2_?QUEST_PROGRESS_BASE.QP_TEXT_COLOR_STATE_COMPLETED:QUEST_PROGRESS_BASE.QP_TEXT_COLOR_STATE_IN_PROGRESS;
