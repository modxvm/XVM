package net.wg.gui.components.advanced.tutorial
{
    ...
    public class TutorialHint extends UIComponentEx
    {
        ...
        public function updateRuntime() : void
        {
            ...
            {
                this._textAlpha = this._textAlpha - TEXT_ALPHA_DECREMENT;
                _loc1_ = true;
            }
        ...
        {
            var _loc1_:String = this._forcedDirection?this._forcedDirection:this._model.arrowDir;
        ...
        private function layoutTextAndBg() : void
        {
            ...
            var _loc2_:int = this.hintText.width + (TEXT_PADDING << 1) > HINT_BG_MIN_WIDTH?this.hintText.width + (TEXT_PADDING << 1):HINT_BG_MIN_WIDTH;
            ...
            {
                _loc5_ = this._forcedDirection?this._forcedDirection:this._model.arrowDir;
