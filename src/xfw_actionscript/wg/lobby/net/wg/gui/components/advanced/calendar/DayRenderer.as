    ...
    public class DayRenderer extends UIComponentEx
    {
        ...
        override protected function draw() : void
        {
            ...
            if(isInvalid(InvalidationType.STATE))
            {
                ...
                else
                {
                    ...
                    mouseEnabled = buttonMode = _loc2_?false:true;
                    if(_loc2_)
                    {
        ...
        public function setDateAndState(param1:Date, param2:Boolean) : void
        {
            ...
            if(param1)
            {
                ...
                this._state = param2?STATE_ENABLED:STATE_DISABLED;
                _loc3_ = App.utils.dateTime.isToday(param1);
                if(_loc3_)
                {
                    this._state = this._state | STATE_TODAY;
                }
                invalidate(InvalidationType.DATA,InvalidationType.STATE);
            }
            else
        ...
        public function switchHighlighted(param1:Boolean) : void
        {
            ...
            if(_loc2_)
            {
                if(param1)
                {
                    this._state = this._state | STATE_HIGHLIGHTED;
                }
        ...
        override public function set enabled(param1:Boolean) : void
        {
            ...
            if(!this._state)
            {
                this._state = param1?STATE_ENABLED:STATE_DISABLED;
            }
            else if(param1 && this._state & STATE_DISABLED)
            {
                this._state = this._state ^ STATE_DISABLED;
                this._state = this._state | STATE_ENABLED;
            }
            else
            {
