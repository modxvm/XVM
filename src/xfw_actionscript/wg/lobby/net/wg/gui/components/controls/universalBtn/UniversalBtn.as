package net.wg.gui.components.controls.universalBtn
{
    ...
    public class UniversalBtn extends SoundButtonEx implements IUniversalBtn, ISoundButtonEx
    {
        ...
        public function setStyle(param1:String, param2:IUniversalBtnStyledDisplayObjects, param3:uint, param4:uint, param5:Dictionary, param6:String, param7:DropShadowFilter) : void
        {
            ...
            _loc8_ = _loc8_ + DISPLAY_LIST_CHILD_INDEX_SHIFT;
        ...
        private function updatePositions() : void
        {
            ...
            if(_loc5_)
            {
                ...
                if(_loc6_)
                {
                    ...
                    {
                        _loc4_ = _loc4_ + (textField.width + (this._iconOffsetText - this.image.width >> 1));
                    }
                    else
                    {
        ...
        private function updateImageAlpha() : void
        {
            ...
            if(toggle)
            {
                _loc1_ = selected?this._enabledImageAlpha:this._disabledImageAlpha;
            }
            else
            {
                _loc1_ = enabled?this._enabledImageAlpha:this._disabledImageAlpha;
            }
        ...
        {
            return this._states != null?super.width * this._baseScaleX:super.width;
        }
        ...
        {
            return this._states != null?super.height * this._baseScaleY:super.height;
        }
