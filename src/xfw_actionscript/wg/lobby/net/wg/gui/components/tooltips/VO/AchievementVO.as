package net.wg.gui.components.tooltips.VO
{
    ...
    public class AchievementVO extends Object implements IDisposable
    {
        ...
        private function parsHash(param1:Object) : void
        {
            ...
            this.showCondSeparator = param1.hasOwnProperty("showCondSeparator") && param1["showCondSeparator"] != undefined?param1["showCondSeparator"]:false;
            ...
            var _loc4_:Boolean = param1.hasOwnProperty("params") && param1["params"] != undefined?true:false;
            if(_loc4_)
            {
            ...
            if(_loc5_)
            {
                ...
                if(this.hasReward)
                {
                    ...
                    if(_loc11_)
                    {
                        this.rewardsHeader = this.rewardsHeader + Utils.instance.htmlWrapper(_loc11_,Utils.instance.COLOR_CRYSTAL,TEXT_FONT_SIZE,TEXT_FONT_NAME);
                    }
                    else
                    {
