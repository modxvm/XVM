package net.wg.gui.components.tooltips.layout
{
    ...
    public class TooltipHorizontalLayout extends BaseTooltipLayout
    {
        ...
        override public function measureBlock(param1:ITooltipBlock, param2:BlockDataItemVO) : void
        {
            ...
            {
                param1.setBlockWidth(param2.blockWidth - (_loc3_ != null?_loc3_.left + _loc3_.right:0.0));
            }
        }
        ...
        override public function arrange(param1:ITooltipBlocks) : void
        {
            ...
            while(_loc12_ < _loc3_)
            {
                ...
                _loc8_ = _loc7_ != null;
                _loc10_ = _loc8_?_loc7_.top:0.0;
                _loc9_ = _loc9_ + ((_loc8_?_loc7_.left:0.0) + _loc4_);
                _loc6_ = _loc5_.getDisplayObject();
                _loc6_.x = _loc9_ | 0;
                _loc6_.y = _loc10_;
                _loc9_ = _loc9_ + (_loc5_.getWidth() + (_loc8_?_loc7_.right:0.0));
                _loc10_ = _loc10_ + (_loc5_.getHeight() + (_loc8_?_loc7_.bottom:0.0));
