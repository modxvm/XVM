package net.wg.gui.messenger.controls
{
    ...
    public class ContactsTreeItemRenderer extends ContactItemRenderer
    {
        ...
        // XFW
        public function get xfw_contactItem():ContactItem
        {
            return _contactItem;
        }
        public function set xfw_contactItem(value:ContactItem):void
        {
            _contactItem = value;
        }
        ...
        // XFW
        public function get xfw_currentContentItem():UIComponent
        {
            return _currentContentItem;
        }
        public function set xfw_currentContentItem(value:UIComponent):void
        {
            _currentContentItem = value;
        }
        ...
        override protected function draw() : void
        {
            ...
            {
                alpha = !isNaN(draggedItemId) && this._currentContentItem != null && this._currentContentItem == this._contactItem && ContactItemVO(this._contactItem.data).dbID == draggedItemId?0.3:1;
            }
        }
