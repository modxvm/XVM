package net.wg.gui.login.impl
{
    ...
    public class RudimentarySwfOnLoginCheckingHelper extends Object
    {
        ...
        private static const RUDIMENTARY_SWF_LIST:Vector.<String> = new <String>[RUDIMENTARY_SWF_BY_LINKAGE_GUI_CONTROLS_LOBBY,RUDIMENTARY_SWF_BY_LINKAGE_GUI_CONTROLS_LOBBY2,RUDIMENTARY_SWF_BY_LINKAGE_GUI_CONTROLS_LOBBY_DYNAMIC,RUDIMENTARY_SWF_BY_LINKAGE_GUI_CONTROLS_LOBBY_BATTLE_DYNAMIC,RUDIMENTARY_SWF_BY_LINKAGE_POPOVERS,RUDIMENTARY_SWF_BY_LINKAGE_ICON_LIBRARY];
        ...
        public function checkRudimentarySwf() : void
        {
            ...
            var _loc2_:* = ": must not load into login screen!";
            var _loc3_:* = ", ";
            var _loc4_:* = false;
