    ...
    public class VehicleSelector extends UIComponentEx implements IViewStackContent
    {
        ...
        override protected function draw() : void
        {
            ...
            if(isInvalid(InvalidationType.SIZE))
            {
                ...
                this.header.y = !this._filtersCBVisible && !this._filtersDDsVisible?HEADER_NO_FILTERS_Y:HEADER_DEFAULT_Y;
        ...
        public function setListItems(param1:DataProvider) : void
        {
            ...
            this.header.selectedIndex = this.multiSelection?HEADER_SHORT_USER_NAME_SORT_ORDER:HEADER_LEVEL_SORT_ORDER;
        ...
        private function getHeaderDP() : IDataProvider
        {
            ...
            _loc2_.buttonWidth = this.multiSelection?HEADER_NATION_ORDER_IDX_MULTI_WIDTH:HEADER_NATION_ORDER_IDX_WIDTH;
            _loc2_.defaultSortDirection = SortingInfo.ASCENDING_SORT;
            ...
            _loc2_.buttonWidth = this.multiSelection?HEADER_SHORT_USER_NAME_MULTI_WIDTH:HEADER_SHORT_USER_NAME_WIDTH;
            _loc2_.defaultSortDirection = SortingInfo.ASCENDING_SORT;
