package net.wg.gui.cyberSport.controls
{
    ...
    public class VehicleSelectorItemRenderer extends ListItemRendererWithFocusOnDis
    {
        ...
        override protected function getStatePrefixes() : Vector.<String>
        {
            ...
            var _loc2_:Vector.<String> = _loc1_?this._isVehicleReady?statesSelected:this.statesSelectedNotReady:this._isVehicleReady?statesDefault:this.statesNotReady;
            return _loc2_;
        }
