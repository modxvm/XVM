package net.wg.gui.cyberSport.controls
{
    ...
    public class ManualSearchRenderer extends TableRenderer implements IManualSearchRenderer
    {
        ...
        protected function populateUI(param1:CSCommandVO) : void
        {
            ...
            {
                _loc4_ = true;
                _loc5_ = _loc5_ + (this.freezeIcon.width + ICONS_GAP);
            }
            ...
            {
                _loc4_ = true;
                _loc5_ = _loc5_ + (this.restrictionIcon.width + ICONS_GAP);
            }
            ...
            {
                _loc4_ = true;
                _loc5_ = _loc5_ + (this.inBattleMC.width + ICONS_GAP);
            }
            if(!_loc4_)
            {
                _loc5_ = _loc5_ + NO_ICONS_OFFSET_X;
            }
