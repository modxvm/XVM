package net.wg.gui.lobby.header.headerButtonBar
{
    ...
    public class HBC_PremShop extends HeaderButtonContentItem
    {
        ...
        private static const WIDE_SCREEN_PRC_MIN_BORDER:Number = 0.26;
        ...
        override protected function updateData() : void
        {
            ...
            if(data != null)
            {
                ...
                _loc1_ = wideScreenPrc <= WIDE_SCREEN_PRC_BORDER && wideScreenPrc >= WIDE_SCREEN_PRC_MIN_BORDER || maxScreenPrc > MAX_SCREEN_PRC_BORDER;
                this._curTextOffset = _loc1_?TEXT_OFFSET_DEF:TEXT_OFFSET_MIN;
                if(_loc1_)
                {
