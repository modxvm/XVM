    ...
    public class VehicleCongratulationAnimation extends UIComponentEx implements IStageSizeDependComponent
    {
        ...
        override protected function draw() : void
        {
            ...
            if(isInvalid(InvalidationType.SIZE))
            {
                ...
                if(this._isElite)
                {
                    _loc1_ = _loc1_ + TF_ELITE_EXTRA_OFFSET;
                    _loc2_ = _loc2_ + TF_ELITE_EXTRA_OFFSET;
                }
                ...
                _loc4_ = _loc4_ + (_loc2_ + this._vehicleType.width);
            ...
            if(this._showAnimation && isInvalid(ANIMATION_FLAG))
            {
                ...
                this.vehicleLevelTF.y = this.vehicleLevelTF.y - TEXTS_TWEEN_TOP_PADDING;
                ...
                this._vehicleType.y = this._vehicleType.y - TEXTS_TWEEN_TOP_PADDING;
                ...
                this.vehicleNameTF.y = this.vehicleNameTF.y - TEXTS_TWEEN_TOP_PADDING;
