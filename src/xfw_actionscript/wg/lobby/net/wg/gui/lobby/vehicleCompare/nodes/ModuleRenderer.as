package net.wg.gui.lobby.vehicleCompare.nodes
{
    ...
    public class ModuleRenderer extends SoundListItemRenderer implements IRenderer
    {
        ...
        {
            return hitArea != null?hitArea.width:_width;
        }
        ...
        {
            return this._dataInited?this._valueObject.level:-1;
        }
        ...
        {
            return hitArea != null?Math.round(hitArea.height) >> 1:Math.round(_height) >> 1;
        }
