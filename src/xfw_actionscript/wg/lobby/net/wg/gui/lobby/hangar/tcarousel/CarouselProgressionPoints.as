package net.wg.gui.lobby.hangar.tcarousel
{
    ...
    public class CarouselProgressionPoints extends Sprite implements IDisplayable
    {
        ...
        public function setData(param1:ProgressionPointsVO, param2:int) : void
        {
            ...
            {
                this.textFieldSecond.alpha = this.textFieldFirst.alpha = param1.isSpecialVehicle?SPECIAL_LIMIT_REACHED_TEXT_FILED_ALPHA:LIMIT_REACHED_TEXT_FILED_ALPHA;
            }
            else
            {
                this.textFieldFirst.alpha = param1.isSpecialVehicle?SPECIAL_TEXT_FILED_ALPHA:VALUE_TEXT_FILED_ALPHA;
                this.textFieldSecond.alpha = param1.isSpecialVehicle?SPECIAL_TEXT_FILED_ALPHA:LIMIT_TEXT_FILED_ALPHA;
            }
        }
