package net.wg.gui.lobby.rankedBattles19.view.rewards.ranks
{
    ...
    public class RewardsRanksContainer extends Sprite implements IDisposable
    {
        ...
        {
            return this._currentRenderer?this._currentRenderer.x:-(this._renderersWidth >> 1);
        }
        ...
        private function updateRenderersPositions() : void
        {
            ...
            if(this._renderers)
            {
                ...
                while(_loc2_ < _loc1_)
                {
                    this._renderersWidth = this._renderersWidth + this._renderers[_loc2_].width;
                    _loc2_++;
                }
                ...
                while(_loc2_ < _loc1_)
                {
                    ...
                    _loc3_ = _loc3_ + this._renderers[_loc2_].width;
                    _loc2_++;
                }
            }
