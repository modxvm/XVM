    ...
    public class QuestConditions extends UIComponentEx
    {
        ...
        private static function layoutConditions(param1:Vector.<IQPItemRenderer>, param2:Vector.<IQPItemOrConditionIcon>, param3:int = 0) : void
        {
            ...
            for each(_loc6_ in param1)
            {
                ...
                _loc4_ = _loc4_ + (_loc6_.width + _loc5_);
            }
        }
        ...
        override protected function draw() : void
        {
            ...
            if(isInvalid(InvalidationType.SIZE))
            {
                ...
                else if(this._hasMainHeaderProgress)
                {
                    ...
                    _loc3_ = this._hasAddConditions || this._hasAddHeaderProgress?HEADER_PROGRESS_SMALL_WIDTH:HEADER_PROGRESS_WIDTH;
                }
                ...
                else if(this._hasAddHeaderProgress)
                {
                    ...
                    _loc3_ = this._hasMainConditions || this._hasMainHeaderProgress?HEADER_PROGRESS_SMALL_WIDTH:HEADER_PROGRESS_WIDTH;
                }
                if(_loc1_ != null)
                {
        ...
        public function show() : void
        {
            ...
            else if(this._hasMainHeaderProgress)
            {
                ...
                this._mainHeaderProgressItem.y = this._mainHeaderProgressItem.y + ANIM_Y_OFFSET;
                this._tweens.push(createTween(this._mainHeaderProgressItem,_loc3_++));
            }
            this.separator.y = this.separator.y + ANIM_Y_OFFSET;
            ...
            {
                this._addHeaderProgressItem.y = this._addHeaderProgressItem.y + ANIM_Y_OFFSET;
        ...
        private function createHeaderProgressItem(param1:IHeaderProgressData, param2:Boolean) : IHeaderProgressItem
        {
            ...
            _loc4_.setData(param1,param2?HEADER_PROGRESS_SMALL_WIDTH:HEADER_PROGRESS_WIDTH);
        ...
        private function cleanConditions(param1:Vector.<IQPItemRenderer>) : void
        {
            ...
            if(param1 != null)
            {
                ...
                var param1:Vector.<IQPItemRenderer> = null;
            }
        }
        ...
        private function cleanOrItems(param1:Vector.<IQPItemOrConditionIcon>) : void
        {
            ...
            if(param1)
            {
                ...
                param1.splice(0,param1.length);
                var param1:Vector.<IQPItemOrConditionIcon> = null;
            }
        }
