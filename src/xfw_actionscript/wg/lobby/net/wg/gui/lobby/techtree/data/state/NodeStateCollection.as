package net.wg.gui.lobby.techtree.data.state
{
    ...
    public class NodeStateCollection extends Object implements IDisposable
    {
        ...
        {
            var _loc2_:Boolean = param1 == NodeRendererState.UNLOCKED || param1 == NodeRendererState.NEXT2UNLOCK || param1 == NodeRendererState.NEXT4BUY || NodeRendererState.ROOT_BUY;
            return _loc2_;
        }
