package net.wg.gui.lobby.techtree.nodes
{
    ...
    public class ResearchRoot extends UIComponentEx implements IRenderer, ITutorialCustomComponent
    {
        ...
        {
            return this._nodeData?this._nodeData.displayInfo:null;
        }

        public function getEarnedXP() : Number
        {
            return this._nodeData?this._nodeData.earnedXP:0;
        }
        ...
        {
            return this._nodeData?this._nodeData.id:0;
        }
        ...
        {
            return this._nodeData?this._nodeData.level:0;
        }
        ...
        private function updateLayout() : void
        {
            ...
            if(this.price.visible)
            {
                ...
                _loc1_ = _loc1_ + (this.price.contentHeight + ACTION_BUTTON_Y_GAP);
            }
            if(this._changeNationBtn)
            {
                ...
                this._changeNationBtn.iconSource = RES_ICONS.MAPS_ICONS_BUTTONS_NC_ICON_MEDIUM;
                _loc1_ = _loc1_ + this._changeNationBtn.actualHeight;
            }
            if(this.actionButton.visible)
            {
                if(this._changeNationBtn)
                {
                    _loc1_ = _loc1_ + ACTION_BUTTON_Y_GAP;
                }
                this.actionButton.y = _loc1_ | 0;
                _loc1_ = _loc1_ + this.actionButton.actualHeight;
            }
            if(this._rentBtn)
            {
                _loc1_ = _loc1_ + ACTION_BUTTON_Y_GAP;
                ...
                _loc1_ = _loc1_ + this._rentBtn.actualHeight;
            }
            if(this._hangarBtn)
            {
                _loc1_ = _loc1_ + ACTION_BUTTON_Y_GAP;
                ...
                _loc1_ = _loc1_ + this._hangarBtn.actualHeight;
            }
            if(this.blueprintBar.visible)
            {
                _loc1_ = _loc1_ + BLUEPRINT_BAR_Y_GAP;
                this.blueprintBar.y = _loc1_ | 0;
                _loc1_ = _loc1_ + this.blueprintBar.actualHeight;
            }
            this.tradeOffWidget.visible = this.isTradeIn();
            if(this.tradeOffWidget.visible)
            {
                _loc1_ = _loc1_ + TRADE_OFF_WIDGET_OFFSET;
                this.tradeOffWidget.y = _loc1_ | 0;
                _loc1_ = _loc1_ + this.tradeOffWidget.actualHeight;
            }
            this.internalXShift = this._size == SMALL_SIZE && this.tradeOffWidget.visible?TRADE_OFF_WIDGET_DO_INTERNAL_X_SHIFT:Values.ZERO;
            if(this._experienceBlock && this._experienceBlock.visible)
            {
                _loc1_ = _loc1_ + EXPERIENCE_Y_GAP;
        ...
        private function setupOrRemoveExtraBtn(param1:UniversalBtn, param2:Boolean) : UniversalBtn
        {
            ...
            {
                var param1:UniversalBtn = this._classFactory.getComponent(Linkages.BUTTON_UNIVERSAL_HEAVY,UniversalBtn);
