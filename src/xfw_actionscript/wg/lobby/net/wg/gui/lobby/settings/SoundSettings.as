package net.wg.gui.lobby.settings
{
    ...
    public class SoundSettings extends SoundSettingsBase implements IPopOverCaller
    {
        ...
        private var _masterVolumeSelected:Boolean;

        private var _typeAcousticsSelected:Boolean;
        ...
        private function updateMasterVolumeEnabled() : void
        {
            ...
            commonForm.bulbIcon.alpha = this._masterVolumeSelected?ENABLE_ALPHA:DISABLE_ALPHA;
            ...
            commonForm.alternativeVoicesIcon.alpha = this._masterVolumeSelected?ENABLE_ALPHA:DISABLE_ALPHA;
