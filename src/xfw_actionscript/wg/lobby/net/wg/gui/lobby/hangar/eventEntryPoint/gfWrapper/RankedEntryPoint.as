...
{
    import net.wg.infrastructure.base.meta.impl.RankedBattlesEntryPointMeta;
    ...
    public class RankedEntryPoint extends RankedBattlesEntryPointMeta implements IRankedBattlesEntryPointMeta
    {
        ...
        public function RankedEntryPoint()
        {
            super();
        }
