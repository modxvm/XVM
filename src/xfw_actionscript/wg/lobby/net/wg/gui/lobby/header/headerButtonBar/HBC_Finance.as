package net.wg.gui.lobby.header.headerButtonBar
{
    ...
    public class HBC_Finance extends HBC_ActionItem implements ITweenAnimatorHandler
    {
        ...
        override protected function updateSize() : void
        {
            ...
            this.moneyIconText.y = _loc5_?MONEY_TOP_Y:MONEY_CENTER_Y;
            this.wallet.y = _loc5_?WALLET_TOP_Y:WALLET_CENTER_Y;
            super.updateSize();
        }
        ...
        override protected function updateData() : void
        {
            ...
            if(this._financeVo)
            {
                ...
                this.moneyIconText.xCorrect = _loc1_?SHORT_ICON_PADDING:0;
