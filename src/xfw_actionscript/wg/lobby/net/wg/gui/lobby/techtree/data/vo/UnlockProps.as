package net.wg.gui.lobby.techtree.data.vo
{
    ...
    public class UnlockProps extends Object implements IValueObject
    {
        ...
        public function fromArray(param1:Array, param2:ILocale) : void
        {
            ...
            {
                this._parentID = isNaN(param1[SOURCE_ARRAY_PARENT_ID_INDEX])?0:param1[SOURCE_ARRAY_PARENT_ID_INDEX];
                this._unlockIdx = isNaN(param1[SOURCE_ARRAY_UNLOCK_IDX_INDEX])?0:param1[SOURCE_ARRAY_UNLOCK_IDX_INDEX];
                this._xpCost = isNaN(param1[SOURCE_ARRAY_XP_COST_INDEX])?0:param1[SOURCE_ARRAY_XP_COST_INDEX];
