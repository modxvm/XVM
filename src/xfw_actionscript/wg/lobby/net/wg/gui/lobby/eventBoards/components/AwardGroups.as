    ...
    public class AwardGroups extends AwardGroupsMeta implements IAwardGroups
    {
        ...
        public function updateLayout() : void
        {
            ...
            if(this._separators != null)
            {
                ...
                _loc2_ = _loc1_?PLACE_OFFSET_MIN:PLACE_OFFSET_MAX;
                _loc3_ = _loc1_?SEPARATE_HEIGHT_MIN:SEPARATE_HEIGHT_MAX;
                _loc4_ = 0;
        ...
        override protected function setData(param1:Array) : void
        {
            ...
            var _loc5_:* = App.appHeight < HEIGHT_MIN;
            var _loc6_:int = _loc5_?PLACE_OFFSET_MIN:PLACE_OFFSET_MAX;
            var _loc7_:int = _loc5_?SEPARATE_HEIGHT_MIN:SEPARATE_HEIGHT_MAX;
            _loc2_ = 0;
            var _loc8_:* = 0;
        ...
        public function as_setSelected(param1:int, param2:Boolean) : void
        {
            ...
            for each(_loc3_ in this._groups)
            {
                if(_loc3_.enabled)
                {
                    _loc3_.selected = _loc3_ == this._groups[param1]?param2:false;
                    if(!_loc3_.selected)
                    {
