    ...
    public class MarathonHeaderConditionBlock extends UIComponentEx implements IMarathonHeaderBlock
    {
        ...
        override protected function draw() : void
        {
            ...
            if(isInvalid(InvalidationType.SIZE))
            {
                ...
                {
                    this._contentHeight = this._contentHeight + (RENDERER_HEIGHT + RENDERERS_VERTICAL_GAP);
                }
        ...
        private function updateListParams(param1:int) : void
        {
            if(param1 > 0)
            {
                this.tokensList.tileWidth = param1 <= BIG_RENDERERS_NUMBER?RENDERER_WIDTH_BIG:RENDERER_WIDTH_NORMAL;
                this.tokensList.horizontalGap = param1 >= MAX_RENDERERS_IN_ROW_NUMBER?RENDERERS_HORIZONTAL_GAP_SMALL:RENDERERS_HORIZONTAL_GAP_NORMAL;
            }
        }
