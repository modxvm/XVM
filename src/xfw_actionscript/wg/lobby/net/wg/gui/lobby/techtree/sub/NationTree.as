package net.wg.gui.lobby.techtree.sub
{
    ...
    public class NationTree extends UIComponentEx implements INodesContainer, IDraggable, ITutorialCustomComponent
    {
        ...
        private function updateLevelsBgColor() : void
        {
            ...
            _loc1_.color = this._blueprintModeOn?LEVELS_BG_COLOR_BP:LEVELS_BG_COLOR;
        ...
        private function drawLevels() : void
        {
            ...
            for each(_loc8_ in this._renderers)
            {
                ...
                if(_loc3_)
                {
                    _loc2_ = _loc7_?_loc7_.column - 1:-1;
                    if(_loc2_ >= 0)
                    {
        ...
        {
            return this.levels == null?0:this.levels.updateLevels(param1,param2,param3);
        }
        ...
        {
            var _loc3_:* = 0;
            var _loc2_:* = this.maxHScroll > 0;
            var param1:Number = Math.max(0,Math.min(this.maxHScroll,param1));
            if(this.scrollBar != null)
            {
            ...
            {
                _loc3_ = _loc3_ + NT_GRAPHICS_OFFSET_X;
            }
        ...
        {
            var param1:Number = Math.max(0,Math.min(this.maxVScroll,param1));
            var _loc2_:* = this.maxVScroll > 0;
            if(this.vScrollBar != null)
            {
        ...
        {
            return this.isPremiumPanelVisible()?PREMIUM_PANEL_VERTICAL_OFFSET:VSCROLL_NO_PANEL_OFFSET_Y;
        }
        ...
        private function onRendRollOverHandler(param1:MouseEvent) : void
        {
            ...
            if(this._curRend)
            {
                this.showLevelHighlight(_loc2_?_loc2_.column:0);
