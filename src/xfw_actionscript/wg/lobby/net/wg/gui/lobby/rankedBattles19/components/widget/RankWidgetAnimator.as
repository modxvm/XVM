package net.wg.gui.lobby.rankedBattles19.components.widget
{
    ...
    public class RankWidgetAnimator extends Object implements IDisposable
    {
        ...
        private function runMainRankToCenter() : void
        {
            ...
            var _loc1_:* = -this._secondaryRank.width >> 1;
        ...
        private function doSwitch() : void
        {
            ...
            this._widget.recalculateLayout();
            var _loc1_:int = this._animState == RANKEDBATTLES_ALIASES.RANK_LOST_STATE?this._widget.rightRankX:this._widget.leftRankX;
            var _loc2_:int = this._animState == RANKEDBATTLES_ALIASES.RANK_LOST_STATE?this._widget.leftRankX:this._widget.rightRankX;
...
final class FrameScriptData extends Object implements IDisposable
{
