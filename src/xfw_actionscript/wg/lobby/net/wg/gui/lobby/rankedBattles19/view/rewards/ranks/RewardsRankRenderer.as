package net.wg.gui.lobby.rankedBattles19.view.rewards.ranks
{
    ...
    public class RewardsRankRenderer extends UIComponentEx
    {
        ...
        private static function getBgFrameLabel(param1:Boolean, param2:Boolean, param3:Boolean) : String
        {
            ...
            _loc4_ = _loc4_ + (param1?BG_FRAME_POSTFIX_NEXT:BG_FRAME_POSTFIX_DEFAULT);
            return _loc4_;
        }
        ...
        private function updateData() : void
        {
            ...
            var _loc2_:* = _loc1_ == RANKEDBATTLES_CONSTS.RANKED_REWARDS_RANK_NEXT;
            ...
            this.levelTf.textColor = _loc1_ == RANKEDBATTLES_CONSTS.RANKED_REWARDS_RANK_LOCKED?FONT_COLOR_LOCKED:FONT_COLOR_RECEIVED;
        ...
        private function onMouseDownHandler(param1:MouseEvent) : void
        {
            ...
            var _loc4_:uint = _loc2_ == null?MouseEventEx.LEFT_BUTTON:_loc2_.buttonIdx;
