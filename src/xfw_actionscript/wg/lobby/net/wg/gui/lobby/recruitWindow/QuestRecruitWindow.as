package net.wg.gui.lobby.recruitWindow
{
    ...
    public class QuestRecruitWindow extends QuestRecruitWindowMeta implements IQuestRecruitWindowMeta
    {
        ...
        override public function setWindow(param1:IWindow) : void
        {
            ...
            _loc2_.bottom = _loc2_.bottom + (this.cancelButton.height + CANCEL_BTN_ADDITIONAL_HEIGHT);
        ...
        {
            this.applyButton.enabled = this.paramsComponent.vehicleClassDropdown.selectedIndex != 0 && this.paramsComponent.vehicleTypeDropdown.selectedIndex != 0 && (this.paramsComponent.roleDropdown.enabled?this.paramsComponent.roleDropdown.selectedIndex != 0:true);
        }
    }
}
