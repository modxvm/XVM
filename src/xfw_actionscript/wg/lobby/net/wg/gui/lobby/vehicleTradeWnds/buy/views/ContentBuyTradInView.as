package net.wg.gui.lobby.vehicleTradeWnds.buy.views
{
    ...
    public class ContentBuyTradInView extends ContentBuyViewBase implements IPopOverCaller
    {
        ...
        {
            var param1:String = this._tradeInWarningMessagege != null?this._tradeInWarningMessagege:Values.EMPTY_STR;
        ...
        override protected function updateTotalResult() : void
        {
            ...
            var _loc1_:Number = this.slotCheckbox.selected?contentData.slotPrice:0;
            var _loc2_:Number = this.ammoCheckbox.selected?contentData.ammoPrice:0;
            if(contentData.vehiclePrice.isGold)
            {
                _loc1_ = _loc1_ + contentData.vehiclePrice.price;
            }
            else
            {
                _loc2_ = _loc2_ + contentData.vehiclePrice.price;
            }
            if(vehicleBuyTradeOffVo && vehicleBuyTradeOffVo.price > Values.DEFAULT_INT)
            {
                _loc1_ = _loc1_ - vehicleBuyTradeOffVo.price;
            }
            if(!this.crewCheckbox.selected)
            {
                ...
                {
                    _loc1_ = _loc1_ + _loc3_.price;
                }
                else
                {
                    _loc2_ = _loc2_ + _loc3_.price;
                }
            }
        ...
        private function updateVehiclePrice() : void
        {
            ...
            this.tankPrice.textColor = contentData.tradeInVehiclePrice.isGold?CURRENCIES_CONSTANTS.GOLD_COLOR:CURRENCIES_CONSTANTS.CREDITS_COLOR;
        ...
        private function updatePriceDashLine() : void
        {
            ...
            {
                _loc2_ = _loc2_ + DASH_LINE_ACTION_PRICE_SHIFT;
            }
