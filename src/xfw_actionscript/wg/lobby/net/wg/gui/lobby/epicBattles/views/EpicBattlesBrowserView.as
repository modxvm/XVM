...
{
    import net.wg.infrastructure.base.meta.impl.EpicBattlesBrowserViewMeta;
    ...
    public class EpicBattlesBrowserView extends EpicBattlesBrowserViewMeta implements IEpicBattlesBrowserViewMeta
    {
        ...
        public function EpicBattlesBrowserView()
        {
            super();
        }
        ...
        {
            this.waiting.hide();
            setChildIndex(this.closeBtn,this.numChildren - 1);
        }
