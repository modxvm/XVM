package net.wg.gui.lobby.moduleInfo
{
    ...
    public class ModuleEffects extends UIComponentEx
    {
        ...
        {
            var param1:String = param1 == ""?"":Utils.instance.htmlWrapper(param1,COLOR_EQUIPMENT_USAGE,SIZE_EQUIPMENT_USAGE,FIELD_FONT) + Utils.instance.htmlWrapper(Values.SPACE_STR,COLOR_EQUIPMENT_USAGE,param3,FIELD_FONT);
            var param2:String = param2 == ""?"":Utils.instance.htmlWrapper(param2,COLOR_EQUIPMENT_USAGE_BODY,SIZE_EQUIPMENT_USAGE_BODY,FIELD_FONT);
