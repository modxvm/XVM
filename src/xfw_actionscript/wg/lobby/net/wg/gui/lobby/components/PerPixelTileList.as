package net.wg.gui.lobby.components
{
    ...
    public class PerPixelTileList extends TileList
    {
        ...
        {
            _totalRenderers = dataProvider?dataProvider.length:0;
            if(_totalRenderers)
            {
        ...
        {
            var param1:Number = Math.max(0,Math.min(this._maxDifSize,Math.round(param1)));
        ...
        override public function handleInput(param1:InputEvent) : void
        {
            ...
            if(_loc5_ != int.MIN_VALUE)
            {
                ...
                {
                    selectedIndex = _loc5_ < 0?_dataProvider.length - 1:selectedIndex < _dataProvider.length - 1?_dataProvider.length - 1:0;
                    param1.handled = true;
                }
            }
        }
