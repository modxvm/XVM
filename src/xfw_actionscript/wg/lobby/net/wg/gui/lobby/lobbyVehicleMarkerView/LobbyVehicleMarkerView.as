package net.wg.gui.lobby.lobbyVehicleMarkerView
{
    ...
    public class LobbyVehicleMarkerView extends LobbyVehicleMarkerViewMeta implements ILobbyVehicleMarkerViewMeta
    {
        ...
        public function as_updateMarker(param1:String, param2:String, param3:int, param4:int) : void
        {
            var _loc5_:LobbyVehicleMarkers = null;
            var _loc6_:int = this._vehicleMarkers.length;
            var _loc7_:* = 0;
            while(_loc7_ < _loc6_)
            {
                _loc5_ = this._vehicleMarkers[_loc7_];
                if(_loc5_.id == param3)
                {
                    _loc5_.gotoAndStop(param4);
                    _loc5_.setVehicleInfo(param1,param2);
