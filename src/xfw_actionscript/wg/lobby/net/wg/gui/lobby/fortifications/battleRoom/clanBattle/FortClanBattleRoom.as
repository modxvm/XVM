package net.wg.gui.lobby.fortifications.battleRoom.clanBattle
{
    ...
    public class FortClanBattleRoom extends FortClanBattleRoomMeta implements IFortClanBattleRoomMeta
    {
        ...
        override protected function setBattleRoomData(param1:FortClanBattleRoomVO) : void
        {
            ...
            this.separatorBack2.y = param1.isBattleType?SEPARATOR_BATTLE_BACK_Y:SEPARATOR_BACK_Y;
            SortieChatSection(chatSection).lblChatHeader.y = param1.isBattleType?CHAT_BATTLE_HEADER_Y:CHAT_HEADER_Y;
            var _loc2_:ChannelComponent = getChannelComponent();
            _loc2_.y = param1.isBattleType?CHAT_BATTLE_CHANNEL_COMPONENT_Y:CHAT_CHANNEL_COMPONENT_Y;
            _loc2_.messageInput.y = param1.isBattleType?CHAT_BATTLE_MESSAGE_INPUT_Y:CHAT_MESSAGE_INPUT_Y;
            _loc2_.messageArea.height = param1.isBattleType?CHAT_BATTLE_MESSAGE_AREA_HEIGHT:CHAT_MESSAGE_AREA_HEIGHT;
        ...
        {
            super.draw();
            this._isCommander = rallyData?rallyData.isCommander:false;
            this._canInvite = rallyData?rallyData.canInvite:false;
        ...
        private function layoutConfigureInfo() : void
        {
            ...
            this.separatorBack1.y = _loc1_?SEPARATOR_CANINVITE_Y:SEPARATOR_Y;
            this.waitingListButtonBar.y = _loc1_?WAITING_LIST_BUTTON_BAR_CANINVITE_Y:WAITING_LIST_BUTTON_BAR_Y;
            waitingListSection.y = _loc1_?WAITING_LIST_SECTION_CANINVITE_Y:WAITING_LIST_SECTION_Y;
            waitingListSection.lblCandidatesHeader.y = _loc1_?CANDIDATES_HEADER_CANINVITE_Y:CANDIDATES_HEADER_Y;
        }
