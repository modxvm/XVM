package net.wg.gui.lobby.storage.categories.storage
{
    ...
    public class ExtraParams extends GroupEx
    {
        ...
        {
            return dataProvider?Math.min(dataProvider.length,this._maxLines):0;
        }
        ...
        override protected function draw() : void
        {
            ...
            if(isInvalid(InvalidationType.SIZE))
            {
                ...
                while(_loc2_ < _loc3_)
                {
                    ...
                    _loc6_.y = _loc1_;
                    _loc5_ = _loc5_ + _loc6_.getLinesCount();
                    _loc1_ = _loc1_ + (_loc6_.height + _loc4_);
                    _loc2_++;
                }
            ...
            if(param1 > this._maxLines)
            {
                ...
                while(_loc3_ >= 0)
                {
                    ...
                    if(_loc5_.getLinesCount() > 1)
                    {
                        ...
                        _loc2_ = _loc2_ - _loc5_.getLinesCount();
                        _loc5_.truncateText();
                    }
                    _loc3_--;
                }
        ...
        private function updateLayout() : void
        {
            ...
            while(_loc2_ < _loc3_)
            {
                ...
                _loc5_.y = _loc1_;
                _loc1_ = _loc1_ + (_loc5_.actualHeight + _loc4_);
                _loc2_++;
            }
        }
    }
