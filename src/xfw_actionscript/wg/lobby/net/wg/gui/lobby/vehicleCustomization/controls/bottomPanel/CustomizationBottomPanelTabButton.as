package net.wg.gui.lobby.vehicleCustomization.controls.bottomPanel
{
    ...
    public class CustomizationBottomPanelTabButton extends ResizableButton
    {
        ...
        {
            var _loc1_:int = this.plus.visible || this.hasText?this._offsetFromIcon:0;
        ...
        override protected function setState(param1:String) : void
        {
            ...
            {
                this.plus.alpha = param1 == ComponentState.OVER?HOVER_PLUS_ALPHA:INACTIVE_PLUS_ALPHA;
                this.icon.alpha = param1 == ComponentState.OVER?HOVER_ICON_ALPHA:INACTIVE_ICON_ALPHA;
            }
        }
        ...
        override protected function updateChildPositions() : void
        {
            ...
            if(_loc3_)
            {
                ...
                if(_loc4_)
                {
                    _loc2_ = _loc2_ - (this.icon.width + this._offsetFromIcon >> 1);
                }
            }
            else if(_loc4_)
            {
