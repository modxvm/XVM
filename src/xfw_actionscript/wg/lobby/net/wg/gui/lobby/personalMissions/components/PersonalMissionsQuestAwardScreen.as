    ...
    public class PersonalMissionsQuestAwardScreen extends PersonalMissionsQuestAwardScreenMeta implements IPersonalMissionsQuestAwardScreenMeta
    {
        ...
        override protected function draw() : void
        {
            ...
            if(this._vo != null && isInvalid(InvalidationType.DATA))
            {
                ...
                this.mainBtn.width = this.extraBtn.visible?MAIN_BTN_BIG_WIDTH:MAIN_BTN_SMALL_WIDTH;
            }
            if(this._vo != null && isInvalid(InvalidationType.SIZE))
            {
                ...
                {
                    this.ribbonAwards.y = this.ribbonAwards.y + RIBBON_AWARDS_Y_OFFSET_SMALL;
                ...
                {
                    this.ribbonAwards.y = this.ribbonAwards.y + RIBBON_AWARDS_Y_OFFSET_BIG;
                ...
                this.nextQuestTitle.y = this.nextQuestTitle.y + (this.ribbonAwards.y + RIBBON_AWARDS_HEIGHT | 0);
                if(this.nextQuestTF.visible)
                {
                ...
                this.mainBtn.y = this.mainBtn.y + (this.nextQuestTitle.y + this.nextQuestTitle.height | 0);
                if(this.extraBtn.visible)
                {
        ...
        private function layoutQuestConditions() : void
        {
            ...
            this.questConditions.y = _height < HEIGHT_BIG?QUEST_CONDITIONS_Y_SMALL_OFFSET:QUEST_CONDITIONS_Y_BIG_OFFSET;
            this.questConditions.y = this.questConditions.y + (this.ribbonAwards.y + this.questStatus.y + this.questStatus.height - this.questConditions.height >> 1);
        }

        private function animateTitle() : void
        {
            this.operationTF.y = this.operationTF.y + TITLE_ANIM_Y_OFFSET;
            this.questTF.y = this.questTF.y + TITLE_ANIM_Y_OFFSET;
            var _loc1_:Object = {
                "paused":false,
        ...
        {
            this.questStatus.y = this.questStatus.y + STATUS_ANIM_Y_OFFSET;
        ...
        {
            this.nextQuestTF.y = this.nextQuestTF.y + FOOTER_ANIM_Y_OFFSET;
            this.nextQuestTitle.y = this.nextQuestTitle.y + FOOTER_ANIM_Y_OFFSET;
            this.nextQuestLink.y = this.nextQuestLink.y + FOOTER_ANIM_Y_OFFSET;
            this.mainBtn.y = this.mainBtn.y + FOOTER_ANIM_Y_OFFSET;
            this.extraBtn.y = this.extraBtn.y + FOOTER_ANIM_Y_OFFSET;
            var _loc1_:Object = {
                "paused":false,
                "ease":Quintic.easeOut
            };
