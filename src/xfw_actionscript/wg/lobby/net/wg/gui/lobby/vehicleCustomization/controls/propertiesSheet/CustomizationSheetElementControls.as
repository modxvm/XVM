package net.wg.gui.lobby.vehicleCustomization.controls.propertiesSheet
{
    ...
    public class CustomizationSheetElementControls extends UIComponentEx
    {
        ...
        private function setPositions() : void
        {
            ...
            _loc1_ = this._activeRenderersCount >= START_BY_ZERO_RENDERERS_COUNT?_loc1_ - ZERO_RADIUS_GAP:_loc1_;
            var _loc2_:Number = Math.PI / _loc1_;
            var _loc3_:Number = _loc2_;
            var _loc4_:Number = Math.PI / 2;
            var _loc5_:int = this._isBigRadius?LAYOUT_BIG_RADIUS:LAYOUT_RADIUS;
            _loc5_ = this._activeRenderersCount == MAX_RENDERERS_COUNT?LAYOUT_BIG_RADIUS:_loc5_;
            _loc5_ = this._activeRenderersCount < MAX_RENDERERS_LAYOUT_COUNT?_loc5_:LAYOUT_VERY_BIG_RADIUS;
        ...
        {
            this._hideElementsAnimationsCount = this._hideElementsAnimationsCount - 1;
