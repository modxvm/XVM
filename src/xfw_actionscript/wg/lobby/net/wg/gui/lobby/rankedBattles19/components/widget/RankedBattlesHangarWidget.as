package net.wg.gui.lobby.rankedBattles19.components.widget
{
    ...
    public class RankedBattlesHangarWidget extends RankedBattlesHangarWidgetMeta implements IRankedBattlesHangarWidgetMeta, IHeaderFlagsEntryPoint, ISoundable
    {
        ...
        private function setFinalStateLayout() : void
        {
            ...
            var _loc2_:* = _loc1_.rankRightVO != null;
            if(_loc2_)
            {
                this.standardLayout();
        ...
        private function getShieldOffset(param1:IRankIcon) : int
        {
            ...
            if(isNaN(_loc2_))
            {
                _loc2_ = param1.hasVisibleShield()?RankShield.SHIELD_OFFSETS[this._widgetSize]:0;
            }
            return _loc2_;
        }
        ...
        private function resizeHit() : void
        {
            ...
            if(this._model == null || this._model.leagueVO == null)
            {
                ...
                {
                    this.bonusBattles.y = this.bonusBattles.y + BONUS_BATTLES_SHIELD_GAP;
                }
            }
            else
            {
