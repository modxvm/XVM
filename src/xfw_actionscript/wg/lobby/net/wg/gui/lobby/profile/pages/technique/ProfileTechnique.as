package net.wg.gui.lobby.profile.pages.technique
{
    ...
    public class ProfileTechnique extends ProfileTechniqueMeta implements IProfileTechniqueMeta
    {
        ...
        override protected function configUI() : void
        {
            ...
            this.stackComponent.addEventListener(ProfileTechniqueEvent.VIEW_RATING_BTN_CLICK,this.onStackComponentRatingBtnClickHandler);
        }
        ...
        override protected function onDispose() : void
        {
            ...
            {
                this.stackComponent.removeEventListener(ProfileTechniqueEvent.VIEW_RATING_BTN_CLICK,this.onStackComponentRatingBtnClickHandler);
        ...
        private function onListComponentSelectedIndexChangedHandler(param1:Event) : void
        {
        ...
        private function onStackComponentRatingBtnClickHandler(param1:ProfileTechniqueEvent) : void
        {
            showVehiclesRatingS();
        }
    }
