package net.wg.gui.lobby.eventBoards.components
{
    ...
    public class MissionsEventBoardsBody extends MissionPackMarathonBody implements IPopOverCaller
    {
        ...
        {
            var _loc1_:int = missionsList.height?missionsList.height + LIST_PADDING_BOTTOM_MIN:0;
            return dummy.visible?dummy.height:_loc1_;
        }

        override public function get height() : Number
        {
            var _loc1_:int = this._isEventBegan?OFFSET_MIN:OFFSET_MAX;
            if(this._isEventBegan)
            {
                if(this.serverBlock.visible)
                {
                    _loc1_ = _loc1_ + SERVER_BLOCK_OFFSET;
                }
                else if(this.reloginBlock.visible)
                {
                    _loc1_ = _loc1_ + RELOGIN_BLOCK_OFFSET;
                }
            }
        ...
        override public function update(param1:Object) : void
        {
            ...
            if(param1 != null)
            {
                ...
                this.uiDecoration.alpha = this._isEventBegan?DECORATION_ALPHA:1;
        ...
        {
            var _loc1_:* = width == BIG_WIDTH;
            this.uiDecoration.width = _loc1_?DECORATION_WIDTH_MAX:DECORATION_WIDTH_MIN;
            this.uiDecoration.height = _loc1_?DECORATION_HEIGHT_MAX:DECORATION_HEIGHT_MIN;
            this.uiDecoration.x = width - this.uiDecoration.width >> 1;
        }

        private function getBottomOffset() : int
        {
            var _loc1_:int = this.description1.visible?TEXT1_OFFSET:0;
            var _loc2_:int = this.btnRegistration.visible && !this._isRegistrationTop?BUTTON_OFFSET:_loc1_;
            return this.description2.visible?TEXT2_OFFSET:_loc2_;
        }
        ...
        override protected function updateContentWidth() : void
        {
            ...
            {
                _loc4_ = this._isRegistrationTop?REGISTRATION_OFFSET_Y1:REGISTRATION_OFFSET_Y2;
            ...
            if(this.btnRating.visible)
            {
                ...
                _loc6_ = _loc5_?RATING_OFFSET_X_MAX:RATING_OFFSET_X_MIN;
