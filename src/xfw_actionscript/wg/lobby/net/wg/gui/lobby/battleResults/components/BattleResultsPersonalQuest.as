package net.wg.gui.lobby.battleResults.components
{
    ...
    public class BattleResultsPersonalQuest extends UIComponentEx implements ISubtaskComponent
    {
        ...
        {
            var _loc2_:DisplayObjectContainer = this._factory.getComponent(param1,DisplayObjectContainer);
            return _loc2_;
        }
        ...
        {
            this._toolTipMgr.show(this._linkBtn.enabled?TOOLTIPS.QUESTS_LINKBTN_TASK:TOOLTIPS.QUESTS_DISABLELINKBTN_TASK);
        }
