package net.wg.gui.lobby.rankedBattles19.components.widget
{
    ...
    public class WidgetLeague extends UIComponentEx implements IUpdatableComponent, IResizableRankedComponent
    {
        ...
        override protected function configUI() : void
        {
            ...
            this.statsInfo.buttonMode = this.statsInfo.useHandCursor = true;
            this.statsDelta.iconBlendMode = this.statsInfo.iconBlendMode = BlendMode.ADD;
            ...
            this.statsInfo.addEventListener(MouseEvent.ROLL_OUT,this.onCmpRollOutHandler);
            this.statsInfo.valueYOffsetBig = STATS_VALUE_Y_OFFSET;
            this.statsInfo.valueStyleBig = TEXT_MANAGER_STYLES.PROMO_TITLE;
            this.statsInfo.iconSizeBig = StatsConsts.ICON_SIZE_42;
        ...
        override protected function onDispose() : void
        {
            ...
            this.statsInfo.removeEventListener(MouseEvent.ROLL_OUT,this.onCmpRollOutHandler);
        ...
        public function update(param1:Object) : void
        {
            if(param1 != null && this._data != param1)
            {
                ...
                this.statsInfo.setData(this._data.positionData);
                invalidateData();
            }
        }
