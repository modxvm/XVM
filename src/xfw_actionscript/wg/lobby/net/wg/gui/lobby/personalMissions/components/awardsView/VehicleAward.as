    ...
    public class VehicleAward extends UIComponentEx implements IUpdatable
    {
        ...
        private function updatePositions() : void
        {
            ...
            if(this._currentVehicle == EXCALIBUR_ID || this._currentVehicle == CHIMERA_ID || this._currentVehicle == OBJ729_ID)
            {
                ...
                _loc1_.x = _loc2_.x = this._isCompact?ALLIANCE_LEFT_SLOTS_COMPACT_X:ALLIANCE_LEFT_SLOTS_X;
                _loc3_.x = _loc4_.x = this._isCompact?ALLIANCES_RIGHT_SLOTS_COMPACT_X:ALLIANCES_RIGHT_SLOTS_X;
                _loc1_.y = _loc3_.y = this._isCompact?TOP_ALLIANCES_COMPACT_Y:TOP_ALLIANCES_Y;
                _loc2_.y = _loc4_.y = this._isCompact?BOTTOM_ALLIANCES_COMPACT_Y:BOTTOM_ALLIANCES_Y;
                this.animatorMc.x = this._isCompact?SECOND_COMPANY_COMPACT_X_SHIFT:SECOND_COMPANY_X_SHIFT;
            }
            else
            {
                ...
                _loc6_.y = this._isCompact?COMPACT_RADIO_Y:RADIO_Y;
                _loc9_.y = this._isCompact?COMPACT_BODY_Y:BODY_Y;
                _loc7_.y = this._isCompact?COMPACT_TRACK_Y:TRACK_Y;
                _loc5_.y = GUN_Y;
                _loc8_.y = ENGINE_Y;
                if(this._currentVehicle == OBJ260_ID)
                {
                    _loc7_.x = _loc6_.x = _loc5_.x = this._isCompact?OBJ260_COMPACT_LEFT_SLOTS_X:OBJ260_LEFT_SLOTS_X;
                    _loc9_.x = _loc8_.x = this._isCompact?OBJ260_COMPACT_RIGHT_SLOTS_X:OBJ260_RIGHT_SLOTS_X;
                    this.animatorMc.x = this._isCompact?OBJ260_COMPACT_X_SHIFT:OBJ260_X_SHIFT;
                }
                else
                {
