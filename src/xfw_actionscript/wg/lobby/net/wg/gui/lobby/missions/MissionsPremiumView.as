package net.wg.gui.lobby.missions
{
    ...
    public class MissionsPremiumView extends GFInjectComponent implements IViewStackContent
    {
        ...
        public function MissionsPremiumView()
        {
            super();
        ...
        {
            alpha = 0;
            var _loc1_:int = this._hasBeenShownBefore?SMALL_FADE_IN_DELAY:0;
