package net.wg.gui.lobby.techtree.nodes
{
    ...
    public class Renderer extends SoundListItemRenderer implements IRenderer
    {
        ...
        {
            return this.hit != null?this.hit.width:width;
        }
        ...
        {
            return this._dataInited?this._valueObject.earnedXP:0;
        }
        ...
        {
            return this._dataInited?this._valueObject.id:0;
        }
        ...
        {
            return this._dataInited?this._valueObject.level:0;
        }
        ...
        {
            this._stateProps = NodeStateCollection.instance.getStateProps(this._entityType,this._dataInited?this._valueObject.state:0,this.getExtraState());
        ...
        {
            return this._dataInited?this._valueObject.blueprintProgress:0;
        }

        protected function get blueprintCanConvert() : Boolean
        {
            return this._dataInited?this._valueObject.blueprintCanConvert:false;
        }
