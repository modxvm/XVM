    ...
    public class CustomizationAnchorsSet extends UIComponentEx implements IMagneticClickHandler
    {
        ...
        override protected function draw() : void
        {
            ...
            if(isInvalid(InvalidationType.DATA))
            {
                ...
                {
                    for each(_loc2_[_loc3_.uid] in this._anchorItemData)
                    {
                    }
        ...
        public function setInitData(param1:CustomizationAnchorInitVO) : void
        {
            ...
            this._numAnchors = this._anchorItemData?this._anchorItemData.length:0;
        ...
        {
            var _loc2_:* = 0;
            var _loc3_:int = this._anchorItemData != null?this._anchorItemData.length:0;
            _loc2_ = 0;
            while(_loc2_ < _loc3_)
            {
