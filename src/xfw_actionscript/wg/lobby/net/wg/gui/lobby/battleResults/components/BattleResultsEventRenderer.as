    ...
    public class BattleResultsEventRenderer extends UIComponentEx implements ISubtaskComponent
    {
        ...
        override protected function draw() : void
        {
            ...
            if(isInvalid(InvalidationType.DATA))
            {
                if(this._data != null)
                {
                    ...
                    _loc1_ = _loc1_ + this.checkAlertMsg(_loc1_);
                    _loc1_ = _loc1_ + this.checkProgressList(_loc1_);
        ...
        private function checkAwards(param1:int) : int
        {
            ...
            if(_loc2_ && _loc2_.length)
            {
                ...
                return this.awards.height > 0?this.awards.height + AWARDS_PADDING:0;
            }
        ...
        private function checkProgressList(param1:int) : int
        {
            ...
            return _loc2_?this.progressList.height + BOTTOM_PADDING:0;
        }
        ...
        private function checkAlertMsg(param1:int) : int
        {
            ...
            this.alert.y = param1;
            return StringUtils.isNotEmpty(_loc2_)?TextField(this.alert.msgTF).textHeight + BOTTOM_PADDING:0;
        }
