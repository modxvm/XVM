package net.wg.gui.lobby.vehicleTradeWnds.buy.views
{
    ...
    public class ContentBuyView extends ContentBuyViewBase
    {
        ...
        {
            var param1:String = contentData && contentData.warningMsg != null?contentData.warningMsg:Values.EMPTY_STR;
        ...
        override protected function updateTotalResult() : void
        {
            ...
            if(!this.crewCheckbox.selected)
            {
                ...
                {
                    _loc1_ = _loc1_ + this.selectedPrice;
                }
                else
                {
                    _loc2_ = _loc2_ + this.selectedPrice;
                }
            }
        ...
        private function updateVehiclePrice() : void
        {
            ...
            this.tankPrice.textColor = contentData.vehiclePrice.isGold?CURRENCIES_CONSTANTS.GOLD_COLOR:CURRENCIES_CONSTANTS.CREDITS_COLOR;
