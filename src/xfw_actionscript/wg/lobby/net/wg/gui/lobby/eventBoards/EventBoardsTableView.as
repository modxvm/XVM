package net.wg.gui.lobby.eventBoards
{
    ...
    public class EventBoardsTableView extends EventBoardsTableViewMeta implements IEventBoardsTableViewMeta, IPopOverCaller
    {
        ...
        {
            this._freeSpace = this.status.visible?param2 - y - this.status.getHeight() - UNAVAILABLE_HEIGHT:param2 - y - UNAVAILABLE_HEIGHT;
            ...
            if(isInvalid(INV_SCROLL_POSITION))
            {
                ...
                if(this._content && this._scrollIndex > 1)
                {
                    ...
                    if(this._isCentered)
                    {
                        ...
                        {
                            this._currentOffset = this._currentOffset - _loc1_;
        ...
        override protected function setAwardsStripes(param1:EventBoardTableRendererContainerVO) : void
        {
            ...
            this._firstAwardVO = this._awardsData.tableDP[0]?AwardStripeRendererVO(this._awardsData.tableDP[0]):null;
            this._secondAwardVO = this._awardsData.tableDP[1]?AwardStripeRendererVO(this._awardsData.tableDP[1]):null;
        ...
        private function updateLayout() : void
        {
            ...
            this._freeSpace = this.status.visible?height - y - this.status.getHeight() - UNAVAILABLE_HEIGHT:height - y - UNAVAILABLE_HEIGHT;
        ...
        {
            var _loc3_:Number = Math.round(param1 >= param2?param2:param1);
