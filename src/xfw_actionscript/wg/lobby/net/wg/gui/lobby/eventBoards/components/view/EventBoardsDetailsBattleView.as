package net.wg.gui.lobby.eventBoards.components.view
{
    ...
    public class EventBoardsDetailsBattleView extends EventBoardsBattleOverlayMeta implements IEventBoardsBattleOverlayMeta
    {
        ...
        {
            this.experienceBlock.y = this.tableHeaderBattle.visible?EXPERIENCE_OFFSET_Y2:EXPERIENCE_OFFSET_Y1;
            this.fadeBillet.y = this.tableHeaderBattle.visible?FADE_BILLET_Y2:FADE_BILLET_Y1;
            this.fadeBillet.height = this.tableHeaderBattle.visible?FADE_BILLET_HEIGHT2:FADE_BILLET_HEIGHT1;
        }
