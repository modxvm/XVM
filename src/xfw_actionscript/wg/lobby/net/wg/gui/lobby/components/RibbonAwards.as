package net.wg.gui.lobby.components
{
    ...
    public class RibbonAwards extends UIComponentEx
    {
        ...
        private function fadeInAwards() : void
        {
            ...
            var _loc2_:uint = this._awardItemRenderers.length <= this._awardsCount?this._awardItemRenderers.length:this._awardsCount;
            var _loc3_:uint = 0;
            while(_loc3_ < _loc2_)
            {
        ...
        private function drawAwardItemRenderers() : void
        {
            ...
            var _loc3_:* = _loc2_ * this._awardsCount - this._data.gap >> 1;
            var _loc4_:* = -this._data.rendererHeight >> 1;
            var _loc5_:uint = 0;
