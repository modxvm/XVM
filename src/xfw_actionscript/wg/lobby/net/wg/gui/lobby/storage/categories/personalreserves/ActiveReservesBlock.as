    ...
    public class ActiveReservesBlock extends BaseDAAPIComponent
    {
        ...
        override protected function draw() : void
        {
            ...
            if(isInvalid(InvalidationType.SIZE))
            {
                ...
                this.title.x = this._isSmall?TITLE_HORIZONTAL_OFFSET_SMALL:TITLE_HORIZONTAL_OFFSET_TALL;
                this.title.y = height - this.title.height >> 1;
                this.navigateToShopButton.validateNow();
                _loc1_ = this._isSmall?NAVIGATE_BUTTON_OFFSET_SMALL:NAVIGATE_BUTTON_OFFSET_TALL;
