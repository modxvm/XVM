package net.wg.gui.lobby.vehicleCustomization
{
    ...
    public class CustomizationEditedKitPopover extends CustomizationEditedKitPopoverMeta implements ICustomizationEditedKitPopoverMeta
    {
        ...
        override protected function configUI() : void
        {
            ...
            this.defaultBtn.addEventListener(MouseEvent.CLICK,this.onDefaultBtnClickHandler);
        ...
        override protected function onDispose() : void
        {
            ...
            this.defaultBtn.removeEventListener(MouseEvent.CLICK,this.onDefaultBtnClickHandler);
        ...
        private function onDefaultBtnClickHandler(param1:Event) : void
        {
            setToDefaultS();
        }
