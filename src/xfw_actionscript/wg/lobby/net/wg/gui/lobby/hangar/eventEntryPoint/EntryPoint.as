package net.wg.gui.lobby.hangar.eventEntryPoint
{
    ...
    public class EntryPoint extends EventDispatcher implements IDisposable
    {
        ...
        private static const GF_WRAPPER_PACKAGE:String = "net.wg.gui.lobby.hangar.eventEntryPoint.gfWrapper.";
        ...
        private function createEntry() : void
        {
            ...
            if(_loc1_ == null)
            {
                _loc1_ = _classFactory.getClass(GF_WRAPPER_PACKAGE + this._vo.entryLinkage);
            }
            if(_loc1_)
            {
