        ...
        override protected function draw() : void
        {
            ...
            if(this._initData != null)
            {
                ...
                if(isInvalid(InvalidationType.SIZE))
                {
                    ...
                    _loc1_ = _loc1_ + (this.lblTitle.height + ELEMENT_PADDING);
                    if(this.lblGroups.visible)
                    {
                        this.lblGroups.y = _loc1_ + GROUPS_OFFSET;
                        _loc1_ = _loc1_ + this.lblGroups.height;
                    }
                    if(this.ddlGroups.visible)
                    {
                        this.ddlGroups.y = _loc1_ + DD_OFFSET;
                        _loc1_ = _loc1_ + this.ddlGroups.height;
                    }
                    ...
                    _loc1_ = _loc1_ + this.btnDefault.height;
