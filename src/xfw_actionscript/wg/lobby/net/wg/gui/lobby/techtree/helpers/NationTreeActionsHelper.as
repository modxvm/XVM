package net.wg.gui.lobby.techtree.helpers
{
    ...
    public class NationTreeActionsHelper extends Object implements IDisposable
    {
        ...
        private function layoutHint() : void
        {
            ...
            var _loc2_:Number = this._hintTarget.scaleX || 1;
            var _loc3_:Number = this._hintTarget.scaleY || 1;
            ...
            var _loc4_:* = this._hintTarget.width - (this._hintModel.padding.left + this._hintModel.padding.right) * _loc2_ | 0;
            var _loc5_:* = this._hintTarget.height - (this._hintModel.padding.top + this._hintModel.padding.bottom) * _loc3_ | 0;
...
class AnimSequenceItem extends Object implements IDisposable
{
