package net.wg.gui.lobby.header.itemSelectorPopover
{
    ...
    public class ItemSelectorRenderer extends SoundListItemRenderer
    {
        ...
        private var _dataVo:ItemSelectorRendererVO;
        ...
        private function applyData(param1:ItemSelectorRendererVO) : void
        {
            ...
            this.icon.visible = _loc2_ && _loc2_ != Values.EMPTY_STR;
        ...
        {
            super.data = param1;
            this._dataVo = ItemSelectorRendererVO(data);
        }

        override public function set enabled(param1:Boolean) : void
        {
            super.enabled = param1;
            this.icon.alpha = param1?1:ICON_DISABLED_ALPHA;
        }
