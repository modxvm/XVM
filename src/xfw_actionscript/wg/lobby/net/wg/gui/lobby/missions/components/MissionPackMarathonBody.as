package net.wg.gui.lobby.missions.components
{
    ...
    public class MissionPackMarathonBody extends UIComponentEx implements IMissionPackBody
    {
        ...
        {
            this.visibleMaskPart = this._collapsed?0:1;
        ...
        protected function updateContentWidth() : void
        {
            ...
            else
            {
                ...
                this.missionsList.horizontalGap = this._large?RENDERERS_HORIZONTAL_GAP_MAX:RENDERERS_HORIZONTAL_GAP_MIN;
                this.missionsList.verticalGap = this._large?RENDERERS_VERTICAL_GAP_MAX:RENDERERS_VERTICAL_GAP_MIN;
        ...
        {
            return this.dummy.visible?this.dummy.height:this.missionsList.height + LIST_PADDING_BOTTOM_MIN;
        }
