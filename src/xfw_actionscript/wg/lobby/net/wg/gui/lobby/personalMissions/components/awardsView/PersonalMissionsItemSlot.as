    ...
    public class PersonalMissionsItemSlot extends UIComponentEx implements ISoundable
    {
        ...
        override protected function draw() : void
        {
            ...
            if(isInvalid(InvalidationType.DATA))
            {
                if(this._slotData)
                {
                    ...
                    this.iconLoader.alpha = this.tankTypes.alpha = this.allianceIcon.alpha = _loc4_?BASE_ALPHA:NOT_COLLECTED_ALPHA;
        ...
        private function onMouseOutHandler(param1:MouseEvent) : void
        {
            ...
            if(this._slotData)
            {
                ...
                {
                    this.iconLoader.alpha = this.tankTypes.alpha = this.allianceIcon.alpha = this._slotData.isCollected?BASE_ALPHA:NOT_COLLECTED_ALPHA;
                }
            }
        }
