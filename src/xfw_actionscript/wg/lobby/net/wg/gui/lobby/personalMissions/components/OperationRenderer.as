    ...
    public class OperationRenderer extends UIComponentEx
    {
        ...
        override protected function draw() : void
        {
            ...
            if(this._data != null && isInvalid(InvalidationType.DATA))
            {
                ...
                this.icon.alpha = _loc2_?ICON_ALPHA_LOCKED:ICON_ALPHA_UNLOCKED;
        ...
        {
            this.icon.scaleX = this.icon.scaleY = this._data.state == PERSONAL_MISSIONS_ALIASES.OPERATION_CURRENT_STATE?ICON_SCALE_CURRENT:ICON_SCALE_DEF;
            invalidateSize();
        }
    }
}
