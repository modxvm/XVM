package net.wg.gui.lobby.battleResults.controller
{
    ...
    public class TeamStatsControllerAbstract extends Object implements IDisposable
    {
        ...
        private function setupColumns(param1:ColumnCollection, param2:CommonStatsVO) : void
        {
            ...
            for each(_loc4_ in _loc3_)
            {
                ...
                {
                    _loc6_ = _loc4_ in this._sortingIsNumeric?this._sortingIsNumeric[_loc4_]:true;
