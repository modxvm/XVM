    ...
    public class RankedListWithBackground extends UIComponentEx
    {
        ...
        override protected function draw() : void
        {
            ...
            if(this._topData)
            {
                ...
                {
                    this.topElement.scaleX = this.topToMiddleElement.scaleX = this.middleElement.scaleX = _loc5_.scaleX = this.middleToBottomElement.scaleX = this.bottomElement.scaleX = this._isLeftSidePlacement?1:-1;
                    ...
                    this.list.x = this._isLeftSidePlacement?0:LIST_X_OFFSET_LEFTSIDE;
                    _loc9_ = this._topData.backgroundType;
                    if(_loc3_)
                    {
                        _loc9_ = _loc9_ + BLIND_FILL_POSTFIX;
                    }
                    _loc9_ = _loc9_ + Linkages.RANKED_TOP_BG_BITMAPDATA_POSTFIX;
                    if(!_loc4_)
                    {
                ...
                if(_loc8_ || isInvalid(InvalidationType.SIZE))
                {
                    ...
                    if(_loc4_)
                    {
                        ...
                        {
                            _loc10_ = _loc10_ + TOP1_COMPACT_POSTFIX;
                        ...
                        _loc12_ = this._isCompactSize?ICON_POS_TOP1_Y_COMPACT:ICON_POS_TOP1;
                    }
                    else
                    {
                        _loc14_ = 0;
                        ...
                        _loc14_ = _loc14_ + this._topElementHeight;
                        ...
                        _loc14_ = _loc14_ + this._middleElementHeight;
                    ...
                    _loc13_ = this._isLeftSidePlacement?TOP_ICON_X_OFFSET_LEFTSIDE:TOP_ICON_X_OFFSET_RIGHTSIDE;
        ...
        public function setCompact(param1:Boolean) : void
        {
            ...
            this._rendererHeight = param1?PlayerRankedRenderer.RENDERER_HEIGHT:PlayerRankedRenderer.HUGE_RENDERER_HEIGHT;
            invalidateSize();
        }
