package net.wg.gui.lobby.eventBoards.components
{
    ...
    public class MissionsEventBoardsHeader extends MissionPackHeaderBase
    {
        ...
        {
            this.title.visible = param1?this._isTitleVisible:false;
            this.informationIcon.visible = param1?this._isInformationIconVisible:false;
            this.btnRegistration.visible = param1?this._isBtnRegistrationVisible:false;
            var _loc2_:int = this.title.visible?HEIGHT_OFFSET_TITLE:HEIGHT_OFFSET_REGISTRATION;
            this._heightHeader = param1 && this.btnRegistration.visible?_loc2_:HEIGHT_OFFSET;
        }
        ...
        private function updateContentWidth() : void
        {
            ...
            if(this.participateTf.visible)
            {
                ...
                this.participateTf.y = this.btnParticipate.visible?TEXT_Y1:TEXT_Y2;
            }
            ...
            if(this.btnRegistration.visible)
            {
                ...
                this.btnRegistration.y = this.title.visible?BUTTON_OFFSET_REGISTRATION_Y1:BUTTON_OFFSET_REGISTRATION_Y2;
            }
        }
