    ...
    public class StatusFooter extends UIComponentEx implements IUpdatableComponent
    {
        ...
        override protected function draw() : void
        {
            ...
            if(this._data != null && isInvalid(InvalidationType.DATA))
            {
                ...
                {
                    this.statusText.width = this.statusText.width - this.skipTaskBtn.width;
                }
            ...
            if(isInvalid(InvalidationType.SIZE))
            {
                ...
                {
                    this.skipTaskBtn.x = this.statusText.numLines > 1?FREE_SHEET_BTN_X_BIG:this.statusText.x + this.statusText.textWidth + FREE_SHEET_BTN_X_SHIFT | 0;
                }
