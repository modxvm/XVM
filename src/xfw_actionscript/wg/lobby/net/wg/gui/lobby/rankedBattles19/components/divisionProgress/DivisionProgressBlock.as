package net.wg.gui.lobby.rankedBattles19.components.divisionProgress
{
    ...
    public class DivisionProgressBlock extends UIComponentEx implements IStageSizeDependComponent
    {
        ...
        private function updateViewParams() : void
        {
            ...
            {
                _loc1_ = this._currentState == this._inactiveState?StageSizeBoundaries.WIDTH_1600:StageSizeBoundaries.WIDTH_1366;
        ...
        private function updateLayout() : void
        {
            ...
            {
                this.stepsContainer.x = this._selectedIndex == 0?-this.blockParams.firstStep - this.stepsContainer.width:-(this.stepsContainer.width >> 1);
        ...
        {
            return this._blockParams?this._blockParams.bigRank.height:super.height;
        }
        ...
        public function set selectedIndex(param1:int) : void
        {
            if(this._data)
            {
                var param1:int = Math.max(0,Math.min(param1,this._data.blocks.length - 1));
            }
