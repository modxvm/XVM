package net.wg.gui.lobby.vehiclePreview20.infoPanel.crew
{
    ...
    public class VPCrewTab extends VehiclePreviewCrewTabMeta implements IViewStackExContent, IVehiclePreviewCrewTabMeta
    {
        ...
        override protected function onDispose() : void
        {
            ...
            this.uniqueCrewList.removeEventListener(VehiclePreview20Event.SHOW_TOOLTIP,this.onCrewListShowTooltipHandler);
            this.uniqueCrewList.dispose();
            this.uniqueCrewList = null;
            this.regularCrewList.removeEventListener(VehiclePreview20Event.SHOW_TOOLTIP,this.onCrewListShowTooltipHandler);
        ...
        override protected function configUI() : void
        {
            ...
            this.uniqueCrewList.addEventListener(VehiclePreview20Event.SHOW_TOOLTIP,this.onCrewListShowTooltipHandler);
            this.regularCrewList.addEventListener(VehiclePreview20Event.SHOW_TOOLTIP,this.onCrewListShowTooltipHandler);
        }
        ...
        private function onCrewListShowTooltipHandler(param1:VehiclePreview20Event) : void
        {
