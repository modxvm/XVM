package net.wg.gui.lobby.header.headerButtonBar
{
    ...
    public class HBC_Squad extends HeaderButtonContentItem
    {
                ...
                if(this._squadDataVo.squadExtendInfoVo.squadManStates.length <= NORMAL_SIZE_PLATOON)
                {
                    switch(this._squadDataVo.squadExtendInfoVo.platoonState)
                    {
                        case PlatoonShieldIconContainer.STATES.create:
                            ...
                            this.arrow.x = this._isWideScreen?this._arrowXDefault:this._arrowXDefault + DIMENSIONS.minResArrowPadding;
                            break;
        ...
        {
            this.restoreDefaultPositions();
            this.mainIconContainer.x = this._isWideScreen?this.textField.x + this.textField.width + DIMENSIONS.shieldDistanceToText >> 0:this.leftIconContainer.x;
        }
