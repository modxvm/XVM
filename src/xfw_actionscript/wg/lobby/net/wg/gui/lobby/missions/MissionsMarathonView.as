package net.wg.gui.lobby.missions
{
    ...
    public class MissionsMarathonView extends MissionsMarathonViewMeta implements IMissionsMarathonViewMeta, IViewStackContent
    {
        ...
        public function MissionsMarathonView()
        {
            super();
        }
