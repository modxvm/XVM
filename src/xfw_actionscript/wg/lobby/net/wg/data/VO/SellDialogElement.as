package net.wg.data.VO
{
    ...
    public class SellDialogElement extends Object implements IDisposable
    {
        ...
        {
            this._sellExternalData.splice(0,this._sellExternalData.length);
            this._sellExternalData = null;
            this._removePrice.splice(0,this._sellExternalData.length);
        ...
        public function set removePrice(param1:Array) : void
        {
