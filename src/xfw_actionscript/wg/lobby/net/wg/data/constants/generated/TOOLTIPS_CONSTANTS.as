...
{
    public class TOOLTIPS_CONSTANTS extends Object
    {
        ...
        public static const WULF_CAROUSEL_VEHICLE:String = "wulfCarouselVehicle";
        ...
        public static const WT_QUESTS_PREVIEW:String = "WTQuestsPreview";
        ...
        public static const WT_EVENT_BOSS_TICKET:String = "eventBossTicket";

        public static const WT_EVENT_LOOT_BOX:String = "eventLootBox";

        public static const WT_EVENT_SHELL_BATTLE:String = "eventShellBattle";

        public static const WT_EVENT_LOOT_BOX_VEHICLES:String = "eventLootBoxVehicles";

        public static const EVENT_UNAVAILABLE_UNFO:String = "eventUnavailableInfo";
        ...
        public static const BATTLE_TRAINING:String = "battleTraining";
        ...
        public static const RANKED_BATTLES_ROLES:String = "rankedBattlesRoles";
        ...
        public static const EVENT_PROGRESSION_PROGRESS_INFO:String = "eventProgressionProgressInfo";

        public static const EVENT_PROGRESSION_SELECTOR_INFO:String = "eventProgressionSelectorInfo";

        public static const EPIC_PRESTIGE_PROGRESS_BLOCK_INFO:String = "epicPrestigeProgressBlockInfo";

        public static const BATTLE_ROYALE_WEAK_ZONES:String = "BattleRoyaleWeakZonesBlockUI";
        ...
        public static const COMMON_SET:Array = [IGR_INFO,CONTACT,SORTIE_DIVISION,MAP,MAP_SMALL,CLAN_COMMON_INFO,ACTION_PRICE,ACTION_SLOT_PRICE,PRICE_DISCOUNT,FRONTLINE_PRICE_DISCOUNT,ACTION_XP,QUESTS_VEHICLE_BONUSES,ENVIRONMENT,SQUAD_RESTRICTIONS_INFO,MISSIONS_TOKEN,RESERVE_MODULE,CRYSTAL_INFO,EVENT_COIN_INFO,CREDITS_INFO,GOLD_INFO,FREEXP_INFO,VEHICLE_FILTER,VEHICLE_ELITE_BONUS,VEHICLE_HISTORICAL_REFERENCE,BATTLE_TRAINING,SQUAD_BONUS,BATTLE_PASS_VEHICLE_POINTS,BATTLE_PASS_IN_PROGRESS,BATTLE_PASS_COMPLETED,BATTLE_PASS_CHOSE_WINNER,TECHTREE_DISCOUNT_INFO,TECHTREE_NATION_DISCOUNT];

        public static const CUSTOMIZATION_SET:Array = [TECH_CUSTOMIZATION_ITEM,TECH_CUSTOMIZATION_NONHISTORIC_ITEM,TECH_CUSTOMIZATION_POPOVER_ITEM,TECH_CUSTOMIZATION_ITEM_ICON,TECH_CUSTOMIZATION_ITEM_AWARD,TECH_CUSTOMIZATION_ITEM_PURCHASE,SHOP_CUSTOMIZATION_ITEM];
        ...
        public static const EVENT_PROGRESSION_SET:Array = [EVENT_PROGRESSION_SELECTOR_INFO,EVENT_PROGRESSION_PROGRESS_INFO];

        public static const EPIC_BATTLE_SET:Array = [EPIC_SKILL_INFO,EPIC_SKILL_SLOT_INFO,EPIC_PRESTIGE_PROGRESS_BLOCK_INFO,EPIC_QUESTS_PREVIEW,EVENT_PROGRESSION_COMPLETED_QUESTS_INFO];
        ...
        public static const RANKED_SET:Array = [RANKED_BATTLES_POSITION,RANKED_BATTLES_EFFICIENCY,RANKED_BATTLES_LEAGUE,RANKED_BATTLES_BONUS,RANKED_BATTLES_RANK,RANKED_STEP,RANKED_CALENDAR_DAY_INFO,RANKED_CALENDAR_STEPS_INFO,RANKED_SELECTOR_INFO,RANKED_UNAVAILABLE_INFO,RANKED_DIVISION_INFO,RANKED_BATTLES_YEAR_REWARD,RANKED_SERVER_PRIMETIME,RANKED_BATTLES_ROLES,RANKED_QUESTS_PREVIEW];

        public static const SETTINGS_SET:Array = [SETTINGS_CONTROL,SETTINGS_BUTTON,SETTINGS_MINIMAP_CIRCLES,SETTINGS_KEY_SWITCH_MODE,SETTINGS_KEY_HIGHLIGHTLOCATION,SETTINGS_KEY_HIGHLIGHTTARGET,SETTINGS_KEY_SHOWRADIALMENU,SETTINGS_KEY_CHARGE_FIRE];
        ...
        public static const EVENT_SET:Array = [EVENT_SELECTOR_INFO,EVENT_UNAVAILABLE_UNFO,WT_QUESTS_PREVIEW,WT_EVENT_BOSS_TICKET,WT_EVENT_LOOT_BOX,WT_EVENT_LOOT_BOX_VEHICLES];

        public static const WT_BATTLE_SET:Array = [WT_EVENT_SHELL_BATTLE];

        public static const EFFICIENCY_SET:Array = [EFFICIENCY_PARAM,TOTAL_EFFICIENCY_PARAM];
