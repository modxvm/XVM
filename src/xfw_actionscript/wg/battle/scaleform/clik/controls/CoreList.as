    ...
    public class CoreList extends UIComponent implements ITutorialCustomComponent
    {
        ...
        public function set selectedIndex(param1:int) : void
        {
            ...
            if(this._selectedIndex > -1)
            {
                ...
                _loc3_ = this.dataProvider?this.dataProvider.requestItemAt(this._selectedIndex):null;
            }
        ...
        protected function dispatchItemEvent(param1:Event) : Boolean
        {
            ...
            var _loc7_:ListEvent = new ListEvent(_loc2_,false,true,_loc3_.index,0,_loc3_.index,_loc3_,this.dataProvider?this.dataProvider.requestItemAt(_loc3_.index):null,_loc4_,_loc5_,_loc6_);
