package
{
    public class MENU extends Object
    {
        ...
        public static const TANK_PARAMS_S_S:String = "#menu:tank_params/s_s";
        ...
        public static const HEADERBUTTONS_BATTLE_TYPES_BOB_AVAILABILITY_UNTIL:String = "#menu:headerButtons/battle/types/bob/availability/until";

        public static const HEADERBUTTONS_BATTLE_TYPES_BOB_AVAILABILITY_FROZEN:String = "#menu:headerButtons/battle/types/bob/availability/frozen";

        public static const HEADERBUTTONS_BATTLE_TYPES_BOB_AVAILABILITY_POSTEVENT:String = "#menu:headerButtons/battle/types/bob/availability/postEvent";

        public static const HEADERBUTTONS_BATTLE_TYPES_BOB_AVAILABILITY_TIMELEFT_DAYS:String = "#menu:headerButtons/battle/types/bob/availability/timeLeft/days";

        public static const HEADERBUTTONS_BATTLE_TYPES_BOB_AVAILABILITY_TIMELEFT_HOURS:String = "#menu:headerButtons/battle/types/bob/availability/timeLeft/hours";

        public static const HEADERBUTTONS_BATTLE_TYPES_BOB_AVAILABILITY_TIMELEFT_MIN:String = "#menu:headerButtons/battle/types/bob/availability/timeLeft/min";

        public static const HEADERBUTTONS_BATTLE_TYPES_BOB_AVAILABILITY_TIMELEFT_LESSMIN:String = "#menu:headerButtons/battle/types/bob/availability/timeLeft/lessMin";
        ...
        public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_EPICLEVELREQUIRED_HEADER:String = "#menu:headerButtons/fightBtn/tooltip/epicLevelRequired/header";

        public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_EPICLEVELREQUIRED_BODYSTART:String = "#menu:headerButtons/fightBtn/tooltip/epicLevelRequired/bodyStart";

        public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_EPICLEVELREQUIRED_BODYEND:String = "#menu:headerButtons/fightBtn/tooltip/epicLevelRequired/bodyEnd";

        public static const HEADERBUTTONS_FIGHTBTN_TOOLTIP_EPICBATTLEONLY_HEADER:String = "#menu:headerButtons/fightBtn/tooltip/epicBattleOnly/header";
        ...
        public static const VEHICLE_RENTLEFT_EPIC_CYCLE:String = "#menu:vehicle/rentLeft/epic/cycle";

        public static const VEHICLE_RENTLEFT_EPIC_CYCLES:String = "#menu:vehicle/rentLeft/epic/cycles";
        ...
        public static const CONTEXTMENU_PERSONALTRADEEXCHANGE:String = "#menu:contextMenu/personalTradeExchange";
        ...
        public static const CONTEXTMENU_VEHICLERENTRENEW:String = "#menu:contextMenu/vehicleRentRenew";
        ...
        public static const CONTEXTMENU_TAKEEQUIPMENTCOMMANDER:String = "#menu:contextMenu/takeEquipmentCommander";

        public static const CONTEXTMENU_GIVEEQUIPMENTCOMMANDER:String = "#menu:contextMenu/giveEquipmentCommander";
        ...
        public static const HEADERBUTTONS_BATTLE_TYPES_EPIC_EXTRA_CURRENTCYCLE:String = "#menu:headerButtons/battle/types/epic/extra/currentCycle";

        public static const HEADERBUTTONS_BATTLE_TYPES_EPIC_EXTRA_CURRENTSEASON:String = "#menu:headerButtons/battle/types/epic/extra/currentSeason";
        ...
        public static const TECHTREE_INTRO_TITLE:String = "#menu:techtree/intro/title";

        public static const TECHTREE_INTRO_BLOCK0_TITLE:String = "#menu:techtree/intro/block0/title";

        public static const TECHTREE_INTRO_BLOCK0_DESC:String = "#menu:techtree/intro/block0/desc";

        public static const TECHTREE_INTRO_BLOCK1_TITLE:String = "#menu:techtree/intro/block1/title";

        public static const TECHTREE_INTRO_BLOCK1_DESC:String = "#menu:techtree/intro/block1/desc";

        public static const TECHTREE_INTRO_BLOCK2_TITLE:String = "#menu:techtree/intro/block2/title";

        public static const TECHTREE_INTRO_BLOCK2_DESC:String = "#menu:techtree/intro/block2/desc";

        public static const TECHTREE_INTRO_COMPENSATION_TITLE:String = "#menu:techtree/intro/compensation/title";

        public static const TECHTREE_INTRO_FOOTER:String = "#menu:techtree/intro/footer";

        public static const TECHTREE_INTRO_BTNYES:String = "#menu:techtree/intro/btnYes";
        ...
        public static const CST_ITEM_CTX_MENU_PERSONALTRADEEXCHANGE:String = "#menu:cst_item_ctx_menu/personalTradeExchange";
        ...
        public static const ROLEEXP_ACTIONSGROUP_TANK2:String = "#menu:roleExp/actionsGroup/tank2";

        public static const ROLEEXP_ACTIONSGROUP_FIRSTLINESUPPORT1:String = "#menu:roleExp/actionsGroup/firstLineSupport1";

        public static const ROLEEXP_ACTIONSGROUP_FIRSTLINESUPPORT2:String = "#menu:roleExp/actionsGroup/firstLineSupport2";

        public static const ROLEEXP_ACTIONSGROUP_FIRSTLINESUPPORT3:String = "#menu:roleExp/actionsGroup/firstLineSupport3";

        public static const ROLEEXP_ACTIONSGROUP_FIRESUPPORT1:String = "#menu:roleExp/actionsGroup/fireSupport1";

        public static const ROLEEXP_ACTIONSGROUP_SNIPER1:String = "#menu:roleExp/actionsGroup/sniper1";

        public static const ROLEEXP_ACTIONSGROUP_SCOUT1:String = "#menu:roleExp/actionsGroup/scout1";

        public static const ROLEEXP_ACTIONSGROUP_SCOUT2:String = "#menu:roleExp/actionsGroup/scout2";

        public static const ROLEEXP_ACTIONSGROUP_SPG1:String = "#menu:roleExp/actionsGroup/SPG1";

        public static const ROLEEXP_ACTIONSGROUP_HASHSUPPORT1:String = "#menu:roleExp/actionsGroup/hashSupport1";

        public static const ROLEEXP_CURRENTVEHICLESTATUS:String = "#menu:roleExp/currentVehicleStatus";
        ...
        public static function skilldropwindow_study(param1:String) : String
        {
            ...
            if(SKILLDROPWINDOW_STUDY_ENUM.indexOf(_loc2_) == -1)
            {
                DebugUtils.LOG_WARNING("[skilldropwindow_study]:locale key \"" + _loc2_ + "\" was not found");
                return null;
            }
            return _loc2_;
        }
        ...
        public static function tankmanpersonalcase_modifiers(param1:String) : String
        {
            ...
            if(TANKMANPERSONALCASE_MODIFIERS_ENUM.indexOf(_loc2_) == -1)
            {
                DebugUtils.LOG_WARNING("[tankmanpersonalcase_modifiers]:locale key \"" + _loc2_ + "\" was not found");
                return null;
            }
            return _loc2_;
        }
