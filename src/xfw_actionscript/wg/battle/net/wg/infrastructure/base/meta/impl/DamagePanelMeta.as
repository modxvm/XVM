package net.wg.infrastructure.base.meta.impl
{
    ...
    public class DamagePanelMeta extends BattleDisplayable
    {
        ...
        public final function as_setup(param1:String, param2:int, param3:String, param4:Array, param5:Array, param6:Boolean, param7:Boolean, param8:Boolean) : void
        {
            var _loc9_:Array = this._array;
            this._array = param4;
            var _loc10_:Array = this._array1;
            this._array1 = param5;
            this.setup(param1,param2,param3,this._array,this._array1,param6,param7,param8);
            if(_loc9_)
            {
        ...
        protected function setup(param1:String, param2:int, param3:String, param4:Array, param5:Array, param6:Boolean, param7:Boolean, param8:Boolean) : void
        {
            var _loc9_:String = "as_setup" + Errors.ABSTRACT_INVOKE;
