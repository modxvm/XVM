package net.wg.infrastructure.base.meta
{
    ...
    public interface IRibbonsPanelMeta extends IEventDispatcher
    {
        ...
        function as_addBattleEfficiencyEvent(param1:String, param2:Number, param3:String, param4:String, param5:String, param6:String, param7:int) : void;

        function as_updateBattleEfficiencyEvent(param1:String, param2:Number, param3:String, param4:String, param5:String, param6:String, param7:int) : void;
