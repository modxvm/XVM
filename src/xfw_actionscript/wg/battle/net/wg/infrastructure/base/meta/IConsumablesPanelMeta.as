package net.wg.infrastructure.base.meta
{
    ...
    public interface IConsumablesPanelMeta extends IEventDispatcher
    {
        ...
        function as_addEquipmentSlot(param1:int, param2:Number, param3:Number, param4:String, param5:int, param6:Number, param7:Number, param8:String, param9:String) : void;
        ...
        function as_setEquipmentActivated(param1:int) : void;
