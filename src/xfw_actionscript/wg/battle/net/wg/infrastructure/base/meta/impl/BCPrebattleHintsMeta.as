package net.wg.infrastructure.base.meta.impl
{
    ...
    public class BCPrebattleHintsMeta extends AbstractView
    {
        ...
        public function BCPrebattleHintsMeta()
        {
            super();
        }
        ...
        public final function as_setHintsVisibility(param1:Array, param2:Array) : void
        {
            ...
            this.setHintsVisibility(this._vectorString,this._vectorString1);
            if(_loc3_)
            {
        ...
        protected function setHintsVisibility(param1:Vector.<String>, param2:Vector.<String>) : void
        {
            var _loc3_:String = "as_setHintsVisibility" + Errors.ABSTRACT_INVOKE;
