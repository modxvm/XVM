package net.wg.infrastructure.base.meta.impl
{
    ...
    import net.wg.gui.battle.battleRoyale.views.BattleRoyalePlayersPanel;
    import net.wg.gui.battle.battleRoyale.views.BattleRoyalePlayersPanelListItem;
    ...
    import net.wg.gui.battle.battleRoyale.views.components.tooltips.inblocks.blocks.BattleRoyaleWeakZonesBlock;
    ...
    import net.wg.gui.battle.pveEvent.components.eventPointCounter.EventPointCounterAnimation;
    import net.wg.gui.battle.pveEvent.components.eventTimer.EventTimer;
    import net.wg.gui.battle.pveEvent.components.eventTimer.TimerMovie;
    import net.wg.gui.battle.pveEvent.views.EventBattleLoading;
    import net.wg.gui.battle.pveEvent.views.EventBattlePage;
    import net.wg.gui.battle.pveEvent.views.battleHints.EventBattleHint;
    import net.wg.gui.battle.pveEvent.views.battleHints.InfoContainer;
    import net.wg.gui.battle.pveEvent.views.battleHints.TextContainer;
    ...
    import net.wg.gui.battle.pveEvent.views.buffsPanel.EventBuffButton;
    import net.wg.gui.battle.pveEvent.views.buffsPanel.EventBuffIcon;
    import net.wg.gui.battle.pveEvent.views.consumablesPanel.EventBattleEquipmentActiveGlow;
    import net.wg.gui.battle.pveEvent.views.consumablesPanel.EventBattleEquipmentButton;
    import net.wg.gui.battle.pveEvent.views.consumablesPanel.EventBattleEquipmentButtonGlow;
    import net.wg.gui.battle.pveEvent.views.consumablesPanel.EventConsumablesPanel;
    import net.wg.gui.battle.pveEvent.views.eventPlayersPanel.EventHealthBar;
    import net.wg.gui.battle.pveEvent.views.eventPlayersPanel.EventHealthBarFx;
    import net.wg.gui.battle.pveEvent.views.eventPlayersPanel.EventMatterIndicator;
    import net.wg.gui.battle.pveEvent.views.eventPlayersPanel.EventPlayersInfo;
    import net.wg.gui.battle.pveEvent.views.eventPlayersPanel.EventPlayersPanel;
    import net.wg.gui.battle.pveEvent.views.eventPlayersPanel.EventPlayersPanelListItem;
    ...
    import net.wg.gui.battle.views.actionMarkers.StickyArrow;
    ...
    import net.wg.gui.battle.views.destroyTimers.components.notifiers.BaseBarNotifier;
    ...
    import net.wg.gui.battle.views.destroyTimers.components.notifiers.TimerNotifier;
    ...
    import net.wg.gui.battle.views.directionIndicator.EventDirectionIndicatorImage;
    ...
    import net.wg.gui.battle.views.epicRandomScorePanel.EpicRandomScorePanel;
    import net.wg.gui.battle.views.epicRandomScorePanel.components.ERScoreHealthBar;
    ...
    import net.wg.gui.battle.views.minimap.components.entries.event.EventCloudBigMinimapEntry;
    import net.wg.gui.battle.views.minimap.components.entries.event.EventCloudBigSpecialMinimapEntry;
    import net.wg.gui.battle.views.minimap.components.entries.event.EventCloudSmallMinimapEntry;
    import net.wg.gui.battle.views.minimap.components.entries.event.EventCloudSmallSpecialMinimapEntry;
    import net.wg.gui.battle.views.minimap.components.entries.event.EventCollectorGreenMinimapEntry;
    import net.wg.gui.battle.views.minimap.components.entries.event.EventCollectorMinimapEntry;
    import net.wg.gui.battle.views.minimap.components.entries.event.EventEnemyCampMinimapEntry;
    import net.wg.gui.battle.views.minimap.components.entries.event.EventMinimapEntry;
    import net.wg.gui.battle.views.minimap.components.entries.event.EventSoulMinimapEntry;
    import net.wg.gui.battle.views.minimap.components.entries.event.EventVolotMinimapEntry;
    ...
    public class ClassManagerMeta extends Object
    {
        ...
        public static const NET_WG_DATA_CONSTANTS_PLAYERSTATUS:Class = net.wg.data.constants.PlayerStatus;

        public static const NET_WG_DATA_CONSTANTS_STATISTICDATAFACADENAME:Class = StatisticDataFacadeName;

        public static const NET_WG_DATA_CONSTANTS_VEHICLESTATUS:Class = net.wg.data.constants.VehicleStatus;
        ...
        public static const NET_WG_GUI_BATTLE_BATTLELOADING_BATTLELOADING:Class = net.wg.gui.battle.battleloading.BattleLoading;

        public static const NET_WG_GUI_BATTLE_BATTLELOADING_BATTLELOADINGFORM:Class = net.wg.gui.battle.battleloading.BattleLoadingForm;
        ...
        public static const NET_WG_GUI_BATTLE_BATTLELOADING_RENDERERS_TABLEPLAYERITEMRENDERER:Class = net.wg.gui.battle.battleloading.renderers.TablePlayerItemRenderer;

        public static const NET_WG_GUI_BATTLE_BATTLELOADING_RENDERERS_TIPPLAYERITEMRENDERER:Class = net.wg.gui.battle.battleloading.renderers.TipPlayerItemRenderer;
        ...
        public static const NET_WG_GUI_BATTLE_BATTLEROYALE_VIEWS_BATTLEROYALEPLAYERSPANEL:Class = BattleRoyalePlayersPanel;

        public static const NET_WG_GUI_BATTLE_BATTLEROYALE_VIEWS_BATTLEROYALEPLAYERSPANELLISTITEM:Class = BattleRoyalePlayersPanelListItem;
        ...
        public static const NET_WG_GUI_BATTLE_BATTLEROYALE_VIEWS_COMPONENTS_VEHICLEWEAKZONESCMP:Class = VehicleWeakZonesCmp;
        ...
        public static const NET_WG_GUI_BATTLE_BATTLEROYALE_VIEWS_COMPONENTS_TOOLTIPS_INBLOCKS_BLOCKS_BATTLEROYALEWEAKZONESBLOCK:Class = BattleRoyaleWeakZonesBlock;

        public static const NET_WG_GUI_BATTLE_BATTLEROYALE_VIEWS_COMPONENTS_TOOLTIPS_INBLOCKS_DATA_BATTLEROYALEWEAKZONESBLOCKVO:Class = BattleRoyaleWeakZonesBlockVO;
        ...
        public static const NET_WG_GUI_BATTLE_EPICRANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_PLAYERSPANEL:Class = net.wg.gui.battle.epicRandom.views.stats.components.playersPanel.PlayersPanel;

        public static const NET_WG_GUI_BATTLE_EPICRANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_EVENTS_PLAYERSPANELITEMEVENT:Class = net.wg.gui.battle.epicRandom.views.stats.components.playersPanel.events.PlayersPanelItemEvent;
        ...
        public static const NET_WG_GUI_BATTLE_EPICRANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLIST:Class = net.wg.gui.battle.epicRandom.views.stats.components.playersPanel.list.PlayersPanelList;

        public static const NET_WG_GUI_BATTLE_EPICRANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLISTITEM:Class = net.wg.gui.battle.epicRandom.views.stats.components.playersPanel.list.PlayersPanelListItem;

        public static const NET_WG_GUI_BATTLE_EPICRANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLISTITEMHOLDER:Class = net.wg.gui.battle.epicRandom.views.stats.components.playersPanel.list.PlayersPanelListItemHolder;
        ...
        public static const NET_WG_GUI_BATTLE_EPICRANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLISTLEFT:Class = net.wg.gui.battle.epicRandom.views.stats.components.playersPanel.list.PlayersPanelListLeft;

        public static const NET_WG_GUI_BATTLE_EPICRANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLISTRIGHT:Class = net.wg.gui.battle.epicRandom.views.stats.components.playersPanel.list.PlayersPanelListRight;
        ...
        public static const NET_WG_GUI_BATTLE_PVEEVENT_COMPONENTS_BOSSINDICATORPROGRESS_BOSSINDICATOREVENT:Class = BossIndicatorEvent;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_COMPONENTS_BOSSINDICATORPROGRESS_BOSSINDICATORPROGRESS:Class = BossIndicatorProgress;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_COMPONENTS_EVENTPOINTCOUNTER_EVENTPOINTCOUNTER:Class = EventPointCounter;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_COMPONENTS_EVENTPOINTCOUNTER_EVENTPOINTCOUNTERANIMATION:Class = EventPointCounterAnimation;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_COMPONENTS_EVENTTIMER_EVENTTIMER:Class = EventTimer;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_COMPONENTS_EVENTTIMER_TIMERMOVIE:Class = TimerMovie;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_EVENTBATTLELOADING:Class = EventBattleLoading;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_EVENTBATTLEPAGE:Class = EventBattlePage;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_BATTLEHINTS_EVENTBATTLEHINT:Class = EventBattleHint;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_BATTLEHINTS_INFOCONTAINER:Class = InfoContainer;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_BATTLEHINTS_TEXTCONTAINER:Class = TextContainer;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_BATTLEHINTS_DATA_HINTINFOVO:Class = HintInfoVO;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_BUFFSPANEL_BUFFSPANEL:Class = BuffsPanel;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_BUFFSPANEL_EVENTBUFFBUTTON:Class = EventBuffButton;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_BUFFSPANEL_EVENTBUFFICON:Class = EventBuffIcon;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_CONSUMABLESPANEL_EVENTBATTLEEQUIPMENTACTIVEGLOW:Class = EventBattleEquipmentActiveGlow;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_CONSUMABLESPANEL_EVENTBATTLEEQUIPMENTBUTTON:Class = EventBattleEquipmentButton;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_CONSUMABLESPANEL_EVENTBATTLEEQUIPMENTBUTTONGLOW:Class = EventBattleEquipmentButtonGlow;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_CONSUMABLESPANEL_EVENTCONSUMABLESPANEL:Class = EventConsumablesPanel;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_EVENTPLAYERSPANEL_EVENTHEALTHBAR:Class = EventHealthBar;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_EVENTPLAYERSPANEL_EVENTHEALTHBARFX:Class = EventHealthBarFx;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_EVENTPLAYERSPANEL_EVENTMATTERINDICATOR:Class = EventMatterIndicator;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_EVENTPLAYERSPANEL_EVENTPLAYERSINFO:Class = EventPlayersInfo;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_EVENTPLAYERSPANEL_EVENTPLAYERSPANEL:Class = EventPlayersPanel;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_EVENTPLAYERSPANEL_EVENTPLAYERSPANELLISTITEM:Class = EventPlayersPanelListItem;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_EVENTPLAYERSPANEL_VO_DAAPIPLAYERPANELINFOVO:Class = DAAPIPlayerPanelInfoVO;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_EVENTSTATS_EVENTSTATS:Class = EventStats;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_EVENTSTATS_RENDERERS_STATSPLAYERRENDERER:Class = StatsPlayerRenderer;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_EVENTSTATS_VO_EVENTSTATSPLAYERVO:Class = EventStatsPlayerVO;

        public static const NET_WG_GUI_BATTLE_PVEEVENT_VIEWS_PHASEINDICATOR_PHASEINDICATOR:Class = PhaseIndicator;
        ...
        public static const NET_WG_GUI_BATTLE_RANDOM_VIEWS_STATS_COMPONENTS_FULLSTATS_FULLSTATS:Class = net.wg.gui.battle.random.views.stats.components.fullStats.FullStats;

        public static const NET_WG_GUI_BATTLE_RANDOM_VIEWS_STATS_COMPONENTS_FULLSTATS_FULLSTATSTABLE:Class = net.wg.gui.battle.random.views.stats.components.fullStats.FullStatsTable;

        public static const NET_WG_GUI_BATTLE_RANDOM_VIEWS_STATS_COMPONENTS_FULLSTATS_FULLSTATSTABLECTRL:Class = net.wg.gui.battle.random.views.stats.components.fullStats.FullStatsTableCtrl;
        ...
        public static const NET_WG_GUI_BATTLE_RANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_EVENTS_PLAYERSPANELITEMEVENT:Class = net.wg.gui.battle.random.views.stats.components.playersPanel.events.PlayersPanelItemEvent;
        ...
        public static const NET_WG_GUI_BATTLE_RANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLIST:Class = net.wg.gui.battle.random.views.stats.components.playersPanel.list.PlayersPanelList;

        public static const NET_WG_GUI_BATTLE_RANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLISTITEM:Class = net.wg.gui.battle.random.views.stats.components.playersPanel.list.PlayersPanelListItem;

        public static const NET_WG_GUI_BATTLE_RANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLISTITEMHOLDER:Class = net.wg.gui.battle.random.views.stats.components.playersPanel.list.PlayersPanelListItemHolder;

        public static const NET_WG_GUI_BATTLE_RANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLISTLEFT:Class = net.wg.gui.battle.random.views.stats.components.playersPanel.list.PlayersPanelListLeft;

        public static const NET_WG_GUI_BATTLE_RANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLISTRIGHT:Class = net.wg.gui.battle.random.views.stats.components.playersPanel.list.PlayersPanelListRight;

        public static const NET_WG_GUI_BATTLE_RANDOM_VIEWS_STATS_COMPONENTS_PLAYERSPANEL_PANELSWITCH_PLAYERSPANELSWITCH:Class = net.wg.gui.battle.random.views.stats.components.playersPanel.panelSwitch.PlayersPanelSwitch;
        ...
        public static const NET_WG_GUI_BATTLE_RANKED_BATTLELOADING_BATTLELOADING:Class = net.wg.gui.battle.ranked.battleloading.BattleLoading;

        public static const NET_WG_GUI_BATTLE_RANKED_BATTLELOADING_BATTLELOADINGFORM:Class = net.wg.gui.battle.ranked.battleloading.BattleLoadingForm;
        ...
        public static const NET_WG_GUI_BATTLE_RANKED_BATTLELOADING_RENDERERS_TABLEPLAYERITEMRENDERER:Class = net.wg.gui.battle.ranked.battleloading.renderers.TablePlayerItemRenderer;

        public static const NET_WG_GUI_BATTLE_RANKED_BATTLELOADING_RENDERERS_TIPPLAYERITEMRENDERER:Class = net.wg.gui.battle.ranked.battleloading.renderers.TipPlayerItemRenderer;
        ...
        public static const NET_WG_GUI_BATTLE_RANKED_STATS_COMPONENTS_FULLSTATS_FULLSTATS:Class = net.wg.gui.battle.ranked.stats.components.fullStats.FullStats;

        public static const NET_WG_GUI_BATTLE_RANKED_STATS_COMPONENTS_FULLSTATS_FULLSTATSTABLE:Class = net.wg.gui.battle.ranked.stats.components.fullStats.FullStatsTable;

        public static const NET_WG_GUI_BATTLE_RANKED_STATS_COMPONENTS_FULLSTATS_FULLSTATSTABLECTRL:Class = net.wg.gui.battle.ranked.stats.components.fullStats.FullStatsTableCtrl;

        public static const NET_WG_GUI_BATTLE_RANKED_STATS_COMPONENTS_FULLSTATS_TABLEITEM_STATSTABLEITEM:Class = net.wg.gui.battle.ranked.stats.components.fullStats.tableItem.StatsTableItem;

        public static const NET_WG_GUI_BATTLE_RANKED_STATS_COMPONENTS_FULLSTATS_TABLEITEM_STATSTABLEITEMHOLDER:Class = net.wg.gui.battle.ranked.stats.components.fullStats.tableItem.StatsTableItemHolder;

        public static const NET_WG_GUI_BATTLE_RANKED_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLIST:Class = net.wg.gui.battle.ranked.stats.components.playersPanel.list.PlayersPanelList;

        public static const NET_WG_GUI_BATTLE_RANKED_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLISTITEM:Class = net.wg.gui.battle.ranked.stats.components.playersPanel.list.PlayersPanelListItem;

        public static const NET_WG_GUI_BATTLE_RANKED_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLISTITEMHOLDER:Class = net.wg.gui.battle.ranked.stats.components.playersPanel.list.PlayersPanelListItemHolder;

        public static const NET_WG_GUI_BATTLE_RANKED_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLISTLEFT:Class = net.wg.gui.battle.ranked.stats.components.playersPanel.list.PlayersPanelListLeft;

        public static const NET_WG_GUI_BATTLE_RANKED_STATS_COMPONENTS_PLAYERSPANEL_LIST_PLAYERSPANELLISTRIGHT:Class = net.wg.gui.battle.ranked.stats.components.playersPanel.list.PlayersPanelListRight;
        ...
        public static const NET_WG_GUI_BATTLE_VIEWS_ACTIONMARKERS_STICKYARROW:Class = StickyArrow;
        ...
        public static const NET_WG_GUI_BATTLE_VIEWS_DAMAGEPANEL_COMPONENTS_HEALTHBAR:Class = net.wg.gui.battle.views.damagePanel.components.HealthBar;
        ...
        public static const NET_WG_GUI_BATTLE_VIEWS_DESTROYTIMERS_COMPONENTS_NOTIFIERS_BASEBARNOTIFIER:Class = BaseBarNotifier;

        public static const NET_WG_GUI_BATTLE_VIEWS_DESTROYTIMERS_COMPONENTS_NOTIFIERS_COLLAPSEDTIMERNOTIFIER:Class = CollapsedTimerNotifier;

        public static const NET_WG_GUI_BATTLE_VIEWS_DESTROYTIMERS_COMPONENTS_NOTIFIERS_INOTIFIER:Class = INotifier;

        public static const NET_WG_GUI_BATTLE_VIEWS_DESTROYTIMERS_COMPONENTS_NOTIFIERS_NORMALTIMERNOTIFIER:Class = NormalTimerNotifier;

        public static const NET_WG_GUI_BATTLE_VIEWS_DESTROYTIMERS_COMPONENTS_NOTIFIERS_PROGRESSNOTIFIER:Class = ProgressNotifier;

        public static const NET_WG_GUI_BATTLE_VIEWS_DESTROYTIMERS_COMPONENTS_NOTIFIERS_SIMPLENOTIFIER:Class = SimpleNotifier;

        public static const NET_WG_GUI_BATTLE_VIEWS_DESTROYTIMERS_COMPONENTS_NOTIFIERS_TEXTNOTIFIER:Class = TextNotifier;

        public static const NET_WG_GUI_BATTLE_VIEWS_DESTROYTIMERS_COMPONENTS_NOTIFIERS_TIMERNOTIFIER:Class = TimerNotifier;
        ...
        public static const NET_WG_GUI_BATTLE_VIEWS_DESTROYTIMERS_UTILS_PAIRS_NOTIFIERPAIR:Class = NotifierPair;

        public static const NET_WG_GUI_BATTLE_VIEWS_DESTROYTIMERS_UTILS_PAIRS_NOTIFIERPAIRSTATE:Class = NotifierPairState;

        public static const NET_WG_GUI_BATTLE_VIEWS_DESTROYTIMERS_UTILS_PAIRS_PROGRESSNOTIFIERPAIR:Class = ProgressNotifierPair;

        public static const NET_WG_GUI_BATTLE_VIEWS_DESTROYTIMERS_UTILS_PAIRS_TIMERNOTIFIERPAIR:Class = TimerNotifierPair;
        ...
        public static const NET_WG_GUI_BATTLE_VIEWS_DIRECTIONINDICATOR_EVENTDIRECTIONINDICATORIMAGE:Class = EventDirectionIndicatorImage;
        ...
        public static const NET_WG_GUI_BATTLE_VIEWS_EPICRANDOMSCOREPANEL_EPICRANDOMSCOREPANEL:Class = EpicRandomScorePanel;

        public static const NET_WG_GUI_BATTLE_VIEWS_EPICRANDOMSCOREPANEL_COMPONENTS_ERSCOREHEALTHBAR:Class = ERScoreHealthBar;

        public static const NET_WG_GUI_BATTLE_VIEWS_EPICRANDOMSCOREPANEL_COMPONENTS_ERSCOREHEALTHBARPANEL:Class = ERScoreHealthBarPanel;
        ...
        public static const NET_WG_GUI_BATTLE_VIEWS_MINIMAP_COMPONENTS_ENTRIES_EVENT_EVENTCLOUDBIGMINIMAPENTRY:Class = EventCloudBigMinimapEntry;

        public static const NET_WG_GUI_BATTLE_VIEWS_MINIMAP_COMPONENTS_ENTRIES_EVENT_EVENTCLOUDBIGSPECIALMINIMAPENTRY:Class = EventCloudBigSpecialMinimapEntry;

        public static const NET_WG_GUI_BATTLE_VIEWS_MINIMAP_COMPONENTS_ENTRIES_EVENT_EVENTCLOUDSMALLMINIMAPENTRY:Class = EventCloudSmallMinimapEntry;

        public static const NET_WG_GUI_BATTLE_VIEWS_MINIMAP_COMPONENTS_ENTRIES_EVENT_EVENTCLOUDSMALLSPECIALMINIMAPENTRY:Class = EventCloudSmallSpecialMinimapEntry;

        public static const NET_WG_GUI_BATTLE_VIEWS_MINIMAP_COMPONENTS_ENTRIES_EVENT_EVENTCOLLECTORGREENMINIMAPENTRY:Class = EventCollectorGreenMinimapEntry;

        public static const NET_WG_GUI_BATTLE_VIEWS_MINIMAP_COMPONENTS_ENTRIES_EVENT_EVENTCOLLECTORMINIMAPENTRY:Class = EventCollectorMinimapEntry;

        public static const NET_WG_GUI_BATTLE_VIEWS_MINIMAP_COMPONENTS_ENTRIES_EVENT_EVENTENEMYCAMPMINIMAPENTRY:Class = EventEnemyCampMinimapEntry;

        public static const NET_WG_GUI_BATTLE_VIEWS_MINIMAP_COMPONENTS_ENTRIES_EVENT_EVENTMINIMAPENTRY:Class = EventMinimapEntry;

        public static const NET_WG_GUI_BATTLE_VIEWS_MINIMAP_COMPONENTS_ENTRIES_EVENT_EVENTSOULMINIMAPENTRY:Class = EventSoulMinimapEntry;

        public static const NET_WG_GUI_BATTLE_VIEWS_MINIMAP_COMPONENTS_ENTRIES_EVENT_EVENTVOLOTMINIMAPENTRY:Class = EventVolotMinimapEntry;
        ...
        public static const NET_WG_GUI_BATTLE_WINDOWS_VO_INGAMEDETAILSHELPVO:Class = IngameDetailsHelpVO;
        ...
        public static const NET_WG_INFRASTRUCTURE_BASE_META_IBCBATTLEPAGEMETA:Class = IBCBattlePageMeta;
        ...
        public static const NET_WG_INFRASTRUCTURE_BASE_META_IEPICBATTLETIMERMETA:Class = IEpicBattleTimerMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IEPICDEPLOYMENTMAPMETA:Class = IEpicDeploymentMapMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IEPICDESTROYTIMERSPANELMETA:Class = IEpicDestroyTimersPanelMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IEPICFULLSTATSMETA:Class = IEpicFullStatsMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IEPICINGAMERANKMETA:Class = IEpicInGameRankMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IEPICMINIMAPMETA:Class = IEpicMinimapMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IEPICMISSIONSPANELMETA:Class = IEpicMissionsPanelMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IEPICOVERVIEWMAPSCREENMETA:Class = IEpicOverviewMapScreenMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IEPICRANDOMPLAYERSPANELMETA:Class = IEpicRandomPlayersPanelMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IEPICRANDOMSCOREPANELMETA:Class = IEpicRandomScorePanelMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IEPICREINFORCEMENTPANELMETA:Class = IEpicReinforcementPanelMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IEPICRESPAWNVIEWMETA:Class = IEpicRespawnViewMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IEPICSCOREPANELMETA:Class = IEpicScorePanelMeta;
        ...
        public static const NET_WG_INFRASTRUCTURE_BASE_META_IPHASEINDICATORMETA:Class = IPhaseIndicatorMeta;
        ...
        public static const NET_WG_INFRASTRUCTURE_BASE_META_IPVEBOSSINDICATORPROGRESSMETA:Class = IPveBossIndicatorProgressMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IPVEEVENTPOINTCOUNTERMETA:Class = IPveEventPointCounterMeta;
        ...
        public static const NET_WG_INFRASTRUCTURE_BASE_META_ISUPERPLATOONPANELMETA:Class = ISuperPlatoonPanelMeta;
        ...
        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_BCBATTLEPAGEMETA:Class = BCBattlePageMeta;
        ...
        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICBATTLESTATISTICDATACONTROLLERMETA:Class = EpicBattleStatisticDataControllerMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICBATTLETIMERMETA:Class = EpicBattleTimerMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICDEPLOYMENTMAPMETA:Class = EpicDeploymentMapMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICDESTROYTIMERSPANELMETA:Class = EpicDestroyTimersPanelMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICFULLSTATSMETA:Class = EpicFullStatsMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICINGAMERANKMETA:Class = EpicInGameRankMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICMINIMAPMETA:Class = EpicMinimapMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICMISSIONSPANELMETA:Class = EpicMissionsPanelMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICOVERVIEWMAPSCREENMETA:Class = EpicOverviewMapScreenMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICRANDOMPLAYERSPANELMETA:Class = EpicRandomPlayersPanelMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICRANDOMSCOREPANELMETA:Class = EpicRandomScorePanelMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICREINFORCEMENTPANELMETA:Class = EpicReinforcementPanelMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICRESPAWNVIEWMETA:Class = EpicRespawnViewMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_EPICSCOREPANELMETA:Class = EpicScorePanelMeta;
        ...
        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_PHASEINDICATORMETA:Class = PhaseIndicatorMeta;
        ...
        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_PVEBOSSINDICATORPROGRESSMETA:Class = PveBossIndicatorProgressMeta;

        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_PVEEVENTPOINTCOUNTERMETA:Class = PveEventPointCounterMeta;
        ...
        public static const NET_WG_INFRASTRUCTURE_BASE_META_IMPL_SUPERPLATOONPANELMETA:Class = SuperPlatoonPanelMeta;
