package net.wg.infrastructure.base.meta.impl
{
    ...
    public class TutorialManagerMeta extends BaseDAAPIModule
    {
        ...
        public final function as_showEffect(param1:String, param2:String, param3:Object) : void
        {
            var _loc4_:TutorialBuilderVO = this._tutorialBuilderVO;
            this._tutorialBuilderVO = new TutorialBuilderVO(param3);
            this.showEffect(param1,param2,this._tutorialBuilderVO);
            if(_loc4_)
            {
                _loc4_.dispose();
            }
        ...
        protected function showEffect(param1:String, param2:String, param3:TutorialBuilderVO) : void
        {
            var _loc4_:String = "as_showEffect" + Errors.ABSTRACT_INVOKE;
