package net.wg.infrastructure.managers.impl.tutorial
{
    ...
    public class AbstractTriggerWatcher extends EventDispatcher implements ITriggerWatcher
    {
        ...
        public function AbstractTriggerWatcher(param1:String, param2:String)
        {
            super();
