package net.wg.gui.lobby.settings
{
    ...
    public class SettingsArcadeForm extends SettingsNewCountersForm
    {
                        ...
                        switch(_loc7_.type)
                        {
                            case SettingsConfigHelper.TYPE_SLIDER:
                                ...
                                if(_loc7_.hasValue && this[_loc6_ + SettingsConfigHelper.TYPE_VALUE])
                                {
                                    ...
                                    _loc12_.text = _loc7_.current?_loc7_.current.toString():Values.EMPTY_STR;
                                }
                            ...
                            case SettingsConfigHelper.TYPE_DROPDOWN:
                                ...
                                _loc11_.menuRowCount = _loc7_.options is Array?_loc7_.options.length:0;
