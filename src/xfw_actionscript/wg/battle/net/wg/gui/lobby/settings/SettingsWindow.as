    ...
    public class SettingsWindow extends SettingsWindowMeta implements ISettingsWindowMeta
    {
        ...
        public function as_openTab(param1:Number) : void
        {
            ...
            if(this.tabs.dataProvider)
            {
                ...
                this._tabToSelect = _loc2_ > param1?param1:_loc2_ - 1;
            }
            else
            {
        ...
        private function updateTabs(param1:Boolean) : void
        {
            ...
            if(this.tabs.selectedIndex == -1)
            {
                ...
                {
                    this.tabs.selectedIndex = _currentTab = _loc3_ - 1;
                }
                else
                {
        ...
        private function normalizeKeys(param1:Object, param2:SettingsDataVo, param3:Vector.<String>) : void
        {
            ...
            while(_loc18_ < _loc17_)
            {
                ...
                param2.values.push(new SettingsKeyProp(_loc4_,true,_loc4_,null,NaN,NaN,null,false,_loc18_ == 0?0:MAX_RENDERER_Y_OFFSET));
                _loc19_ = 0;
        ...
        private function sendData(param1:Boolean) : void
        {
            ...
            if(_loc3_ || _loc4_)
            {
                ...
                _loc6_ = _loc6_ + (_loc4_?SETTINGS_DIALOGS.SOUND_MODE_INVALID:Values.EMPTY_STR);
        ...
        private function markVisitedCounterItems(param1:int) : void
        {
            ...
            var _loc2_:String = this._settingsConfigHelper.tabsDataProviderWithOther[_currentTab].linkage;
        ...
        {
            var _loc2_:* = App.appHeight < REFERENCE_HEIGHT;
            var _loc3_:int = _loc2_?SMALL_TEXTURE_SIZE:BIG_TEXTURE_SIZE;
            var _loc4_:* = App.appWidth - _loc3_ >> 1;
