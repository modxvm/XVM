package net.wg.gui.lobby.settings
{
    ...
    public class GraphicSettings extends GraphicSettingsBase
    {
        ...
        private function updateInterfaceScale() : void
        {
            ...
            {
                _loc8_ = _loc3_.selectedIndex < _loc7_.length?_loc3_.selectedIndex:_loc7_.length - 1;
            }
            _loc3_.dataProvider = new DataProvider(_loc7_);
            _loc3_.selectedIndex = this._isInited?_loc8_:int(_loc2_.current);
        ...
        private function getClosestRefreshRate(param1:int, param2:IDataProvider) : Number
        {
            ...
            while(_loc5_ < _loc4_)
            {
                ...
                if(_loc6_ > param1 && (isNaN(_loc3_)?true:_loc6_ < _loc3_))
                {
                    _loc3_ = _loc6_;
                }
                _loc5_++;
        ...
        private function updateAdvancedQualityControl(param1:String, param2:SettingsControlProp) : void
        {
            ...
            switch(param2.type)
            {
                ...
                case SettingsConfigHelper.TYPE_STEP_SLIDER:
                    ...
                    _loc12_.value = _loc4_ != -1?_loc4_:0;
                ...
                case SettingsConfigHelper.TYPE_DROPDOWN:
                    ...
                    _loc13_.menuRowCount = _loc9_.length <= 7?_loc9_.length:7;
                    _loc13_.dataProvider = new DataProvider(_loc9_);
                    _loc6_ = _loc13_.selectedIndex;
                    _loc13_.selectedIndex = _loc4_ != -1?_loc4_:0;
        ...
        {
            param1.viewId = param1.viewId?param1.viewId:viewId;
            ...
            if(_loc5_ && this[_loc4_ + _loc5_.type] != undefined)
            {
                ...
                if(_loc8_ != _loc9_)
                {
                    ...
                    if(_loc10_ != -1)
                    {
                        ...
                        _loc12_ = _loc11_.hasOwnProperty(SUPPORTED_STR)?_loc11_[SUPPORTED_STR]:true;
                        if(_loc12_)
                        {
        ...
        private function onDropDownIndexChangeHandler(param1:ListEvent) : void
        {
            ...
            var _loc5_:Number = _loc4_.isDataAsSelectedIndex && _loc4_.options[param1.index].hasOwnProperty(DATA_STR)?_loc4_.options[param1.index].data:param1.index;
        ...
        private function onDropDownOrderedIndexChangeHandler(param1:ListEvent) : void
        {
            ...
            var _loc6_:Number = _loc5_.hasOwnProperty(DATA_STR)?_loc5_.data:param1.index;
