package net.wg.gui.lobby.settings.feedback.borderMap
{
    ...
    public class BattleBorderMapForm extends FeedbackBaseForm
    {
        ...
        {
            var _loc1_:* = this.battleBorderMapTypeButtonBar.dataProvider[this.battleBorderMapTypeButtonBar.selectedIndex].data != BORDER_MAP_TYPE_HIDE_INDEX;
        ...
        {
            var _loc2_:* = param1 == BORDER_MAP_TYPE_HIDE_INDEX;
            var _loc3_:int = this._colorMgr.getIsColorBlindS() && !_loc2_?param1 + BLIND_OFFSET:param1;
