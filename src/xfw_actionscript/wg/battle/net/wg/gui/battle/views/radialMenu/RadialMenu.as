package net.wg.gui.battle.views.radialMenu
{
    ...
    public class RadialMenu extends RadialMenuMeta implements IRadialMenuMeta
    {
        ...
        override protected function show(param1:Number, param2:Number, param3:String, param4:Array, param5:Array) : void
        {
            ...
            this._state = param3;
            if(RADIAL_MENU_CONSTS.WHITE_TARGET_STATES.indexOf(param3) >= 0)
            {
                this._color = RADIAL_MENU_CONSTS.WHITE_STATE;
                this._backgroundColor = RADIAL_MENU_CONSTS.WHITE_STATE;
            }
            else if(RADIAL_MENU_CONSTS.GREEN_TARGET_STATES.indexOf(param3) >= 0)
            {
