package net.wg.gui.battle.views.battleLevelPanel
{
    ...
    public class BattleLevelPanel extends BattleLevelPanelMeta implements IBattleLevelPanelMeta
    {
        ...
        {
            var _loc1_:Boolean = this.progressDeltaAnimation.isActive || this.experienceDiffAnimation.isActive || this.progressDeltaAnimation.isActive || this.newLvlTextAnimation.isActive;
            if(_loc1_)
            {
                return;
            }
