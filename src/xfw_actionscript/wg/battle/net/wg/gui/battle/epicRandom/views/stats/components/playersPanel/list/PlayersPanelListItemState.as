package net.wg.gui.battle.epicRandom.views.stats.components.playersPanel.list
{
    ...
    public class PlayersPanelListItemState extends Object
    {
        ...
        public static function transformToSingleColumnListItemState(param1:int, param2:uint) : uint
        {
            ...
            {
                _loc3_ = param1 == PLAYERS_PANEL_STATE.EPIC_RANDOM_THREE_COLUMN_SHORT || param1 == PLAYERS_PANEL_STATE.EPIC_RANDOM_THREE_COLUMN_SHORT_SECOND_FOCUS || param1 == PLAYERS_PANEL_STATE.EPIC_RANDOM_THREE_COLUMN_SHORT_THIRD_FOCUS?TINY_SHORT_STATE:TINY_LONG_STATE;
            }
            return _loc3_;
        }
