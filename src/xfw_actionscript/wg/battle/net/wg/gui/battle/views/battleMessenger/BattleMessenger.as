package net.wg.gui.battle.views.battleMessenger
{
    ...
    public class BattleMessenger extends BattleMessengerMeta implements IBattleMessenger
    {
        ...
        private function showPrevVisibleMessages() : void
        {
            ...
            _loc1_.setState(this._isTopMessageVisible?BattleMessage.VISIBLE_WHEEL_MES:BattleMessage.HIDEHALF_MES);
        ...
        private function showNextVisibleMessages() : void
        {
            ...
            if(this._isFullVisibleMessagesInHistoryStack && _loc1_)
            {
                ...
                this._messages[this._topMessageIndex].setState(this._isTopMessageVisible?BattleMessage.VISIBLE_WHEEL_MES:BattleMessage.HIDEHALF_MES);
            }
            this._bottomMessageIndex++;
            this.updateHistoryButtons();
            this.moveUpMessages();
        ...
        private function showMessageByIndex(param1:int, param2:Boolean = false, param3:Boolean = false) : void
        {
            ...
            if(param2)
            {
                this._hoverHeight = this._hoverHeight + _loc4_.height;
            }
            if(param3)
            {
        ...
        private function hideMessageByIndex(param1:int, param2:Boolean = false) : void
        {
            ...
            if(param2)
            {
                this._hoverHeight = this._hoverHeight - _loc3_.height;
            }
        }
        ...
        private function showLastIndexMessages() : void
        {
            ...
            var _loc6_:int = this._isFocused || this._isCtrlButtonPressed?BattleMessage.VISIBLE_MES:BattleMessage.RECOVERED_MES;
            _loc3_ = 0;
            while(_loc3_ < _loc5_)
            {
        ...
        {
            return this._receivers.length > 0?this._receivers[this._receiverIdx].inputColor:DEFAULT_RECEIVER_COLOR;
        }
