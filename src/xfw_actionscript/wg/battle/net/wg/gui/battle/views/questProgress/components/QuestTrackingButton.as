package net.wg.gui.battle.views.questProgress.components
{
    ...
    public class QuestTrackingButton extends SoundButtonEx
    {
        ...
        override protected function draw() : void
        {
            ...
            {
                _loc1_ = _selected?Values.DEFAULT_ALPHA:INACTIVE_ALPHA;
        ...
        {
            return this._dataVo?this._dataVo.questID:Values.DEFAULT_INT;
        }

        public function get fullMissionName() : String
        {
            return this._dataVo?this._dataVo.fullMissionName:Values.EMPTY_STR;
        }
    }
}
