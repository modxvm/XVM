package net.wg.gui.battle.views.minimap.components.entries.fortconsumables
{
    ...
    public class BomberMinimapEntry extends BattleUIComponent
    {
        ...
        {
            super.configUI();
            this._atlasManager.drawGraphics(ATLAS_CONSTANTS.BATTLE_ATLAS,FortConsumablesMinimapEntryConst.BOMBER_ATLAS_ITEM_NAME,this.atlasPlaceholder.graphics,EpicMinimapEntryConst.EMPTY_DOUBLE_STR,true);
        }
