package net.wg.gui.battle.views.upgradePanel
{
    ...
    public class BattleUpgradePanel extends BattleUpgradePanelMeta implements IBattleUpgradePanelMeta
    {
        ...
        public function as_setVisible(param1:Boolean) : void
        {
            if(param1)
            {
                this.state = this.state - STATE_DISABLED_FLAG;
            }
            else
            {
                this.state = this.state + STATE_DISABLED_FLAG;
        ...
        public function as_showSelectAnim(param1:int) : void
        {
            ...
            this.state = this.state + STATE_SELECT_FLAG;
        }
        ...
        public function as_toggleAlertState(param1:Boolean, param2:String) : void
        {
            ...
            if(param1)
            {
                this.state = this.state + STATE_ALERT_FLAG;
            }
            else
            {
                this.state = this.state - STATE_ALERT_FLAG;
        ...
        private function implyPhase(param1:int) : void
        {
            ...
            {
                var param1:int = param1 + this._scheduledPhase;
                this._scheduledPhase = param1 - this._scheduledPhase;
                param1 = param1 - this._scheduledPhase;
            }
        ...
        private function applyPhase(param1:int) : void
        {
            ...
            switch(this._phase)
            {
                case PHASE_SELECT:
                    ...
                    this.selectBG.x = this._selectIdx == 0?-this.selectBG.width:0;
        ...
        private function updateLayout() : void
        {
            ...
            var _loc1_:* = this.choicePanel.getModuleInfoMaxBorderSize() << 1;
            ...
            {
                this.notificationBorderAnimation.y = this.notificationBorderAnimation.y + this.choicePanel.y;
            }
        ...
        private function set state(param1:int) : void
        {
            ...
            this._stateMask = _loc2_ >= 0?this._stateMask | _loc2_:this._stateMask & _loc2_ - 1;
