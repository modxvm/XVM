package net.wg.gui.battle.views.ribbonsPanel
{
    ...
    public class RibbonCtrl extends Object implements IDisposable
    {
        ...
        public function updateData(param1:Number, param2:String, param3:String, param4:String, param5:String, param6:String) : void
        {
            ...
            this._bonus.update(param6,this._texts.left);
