package net.wg.gui.battle.views.minimap.components.entries.fortconsumables
{
    ...
    public class SmokeMinimapEntry extends BattleUIComponent
    {
        ...
        public function SmokeMinimapEntry()
        {
        ...
        {
            super.configUI();
            this._atlasManager.drawGraphics(ATLAS_CONSTANTS.BATTLE_ATLAS,FortConsumablesMinimapEntryConst.SMOKE_ATLAS_ITEM_NAME,this.atlasPlaceholder.graphics,EpicMinimapEntryConst.EMPTY_DOUBLE_STR,true);
        }
