package net.wg.gui.battle.battleRoyale.views.components
{
    ...
    public class EventViewHeader extends Sprite implements IDisposable
    {
        ...
        {
            return this._isSmallScreenSize?CONTENT_SMALL_SIZE:CONTENT_BIG_SIZE;
        }
        ...
        private function onBattleIconChangeHandler(param1:Event) : void
        {
            var _loc4_:* = 0;
            var _loc5_:* = 0;
            var _loc2_:Number = this._isSmallScreenSize?HEADER_BG_SMALL_HEIGHT:HEADER_BG_BIG_HEIGHT;
            ...
            _loc5_ = this._isSmallScreenSize?ICON_SMALL_MARGIN_X:ICON_BIG_MARGIN_X;
