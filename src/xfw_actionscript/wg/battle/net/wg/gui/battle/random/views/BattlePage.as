package net.wg.gui.battle.random.views
{
    ...
    public class BattlePage extends BattlePageQuestsProgress
    {
        ...
        {
            var _loc2_:Number = App.appHeight - this.getPlayersPanelHeight() - MINIMAP_MARGIN_HEIGHT;
        ...
        {
            if(!this.battleMessenger.isEnterButtonPressed && this.playersPanel != null)
            {
        ...
        protected function getPlayersPanelHeight() : int
        {
            if(this.playersPanel != null)
            {
                return this.playersPanel.panelHeight;
            }
            return 0;
        }
    }
