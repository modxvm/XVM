package net.wg.gui.battle.battleRoyale.views.components.fullStats.nationsVehiclesCounter
{
    ...
    public class BattleRoyaleNationsVehiclesRenderer extends UIComponent
    {
        ...
        private function layout() : void
        {
            ...
            var _loc2_:* = this._tileListRowHeight * _loc1_ | 0;
            if(_loc1_ > 1)
            {
            ...
            {
                this.tileList.y = this.tileList.y + SMALL_RESOLUTION_OFFSET;
                this.separator.y = this.separator.y + (SMALL_RESOLUTION_OFFSET << 1);
