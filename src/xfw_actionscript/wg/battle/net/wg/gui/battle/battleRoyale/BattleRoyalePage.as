package net.wg.gui.battle.battleRoyale
{
    ...
    public class BattleRoyalePage extends BattleRoyalePageMeta implements IBattleRoyalePageMeta
    {
        ...
        public var teamPanel:BattleRoyalePlayersPanel = null;
        ...
        private var _isDamageScreenNotificationVisible:Boolean = false;
        ...
        override protected function getAllowedMinimapSizeIndex(param1:Number) : Number
        {
            ...
            if(this._minimap.isTabMode)
            {
                ...
                _loc6_ = _loc5_?EpicMinimap.TAB_MODE_502_IDX:EpicMinimap.TAB_MODE_700_IDX;
                return _loc6_;
            }
        ...
        override protected function updateMinimapPosition() : void
        {
            ...
            if(this._minimap.isTabMode)
            {
                ...
                _loc2_ = _loc1_?MINIMAP_TAB_MODE_SMALL_OFFSET_Y:MINIMAP_TAB_MODE_BIG_OFFSET_Y;
                ...
                if(_loc1_)
                {
                    this._minimap.x = this._minimap.x + MINIMAP_SMALL_SCREEN_OFFSET_X;
        ...
        {
            this._isDamageScreenNotificationVisible = param1;
        ...
        {
            var _loc1_:int = this._respawnVisible?(width >> 1) - RESPAWN_MAP_HALF_WIDTH:BattleMessage.DEFAULT_TEXT_WIDTH;
