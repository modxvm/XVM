package net.wg.gui.battle.battleloading
{
    ...
    public class BattleLoadingHelper extends Object
    {
        ...
        public function getColorSchemeName(param1:DAAPIVehicleInfoVO, param2:Boolean) : String
        {
            ...
            _loc3_ = _loc3_ + (!UserTags.isCurrentPlayer(param1.userTags) && (!param1.isAlive() || !param1.isReady())?VehicleStatusSchemes.OFFLINE_POSTFIX:"");
            return _loc3_;
        }
