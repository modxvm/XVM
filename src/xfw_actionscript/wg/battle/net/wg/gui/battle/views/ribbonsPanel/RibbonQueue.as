package net.wg.gui.battle.views.ribbonsPanel
{
    ...
    public class RibbonQueue extends Object implements IDisposable
    {
        ...
        public function pushShow(param1:String, param2:Number, param3:String, param4:String, param5:String, param6:String, param7:Boolean, param8:String) : void
        {
            var _loc9_:RibbonQueueItem = this._queueMapById[param2];
            if(_loc9_ == null)
            {
                _loc9_ = this.getItemFromPool();
                this._queueMapById[param2] = _loc9_;
                this._queue.push(_loc9_);
            }
            _loc9_.setData(RibbonQueueItem.SHOW,param1,param2,param3,param4,param5,param6,param7,param8);
        }
        ...
        public function unShiftHide(param1:Number) : void
        {
            ...
            _loc2_.setData(RibbonQueueItem.HIDE,Values.EMPTY_STR,param1,Values.EMPTY_STR,Values.EMPTY_STR,Values.EMPTY_STR,Values.EMPTY_STR,false,Values.EMPTY_STR);
