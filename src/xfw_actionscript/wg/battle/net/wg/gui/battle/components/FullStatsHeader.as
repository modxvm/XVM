package net.wg.gui.battle.components
{
    ...
    public class FullStatsHeader extends BattleDisplayable implements IDisposable, IUpdatable
    {
        ...
        public function updateSize(param1:Number, param2:Number) : void
        {
            ...
            {
                this.mapTF.y = this.mapTF.y - TF_SMALL_Y_SHIFT;
                this.battleTF.y = this.battleTF.y - TF_SMALL_Y_SHIFT;
                this.winTF.y = this.winTF.y - TF_SMALL_Y_SHIFT;
                this.mapTF.x = this.mapTF.x + TF_SMALL_X_SHIFT;
                this.battleTF.x = this.battleTF.x - TF_SMALL_X_SHIFT;
            }
