package net.wg.gui.battle.views.vehicleMarkers.VO
{
    ...
    public class VehicleMarkerPart extends Object implements IDisposable
    {
        ...
        public function offsetFromPart(param1:VehicleMarkerPart) : int
        {
            ...
            {
                _loc3_ = param1.part;
                _loc2_ = this._crossOffset.hasOffset(_loc3_)?this._crossOffset.getOffset(_loc3_):this._offset;
            }
            return _loc2_;
        }
