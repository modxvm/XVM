package net.wg.gui.battle.battleRoyale.views
{
    ...
    public class BattleRoyalePlayersPanelListItem extends BattleUIComponent
    {
        ...
        public function BattleRoyalePlayersPanelListItem()
        {
            super();
        ...
        private function applyState() : void
        {
            ...
            var _loc2_:Number = !this._isReady || !this._isAlive?NOT_READY_STATUS_ALPHA:Values.DEFAULT_ALPHA;
            alpha = _loc2_;
        }
    }
}
