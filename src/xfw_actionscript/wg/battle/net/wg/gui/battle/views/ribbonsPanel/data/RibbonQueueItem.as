...
{
    public class RibbonQueueItem extends Object
    {
        ...
        public function setData(param1:String, param2:String, param3:Number, param4:String, param5:String, param6:String, param7:String, param8:Boolean, param9:String) : void
        {
            this.isNew = param8;
