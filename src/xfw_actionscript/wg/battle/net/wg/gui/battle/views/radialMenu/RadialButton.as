    ...
    public class RadialButton extends BattleUIComponent
    {
        ...
        override protected function draw() : void
        {
            ...
            if(isInvalid(TITLE_VALIDATION))
            {
                ...
                if(this.rotation < 0)
                {
                    _loc1_ = this._keyStr.indexOf(ARROW_TEXT) >= 0?KEY_TEXT_FIELD_X_OFFSET:CUSTOM_ICON_FIELD_X_OFFSET;
        ...
        {
            var _loc1_:* = this._buttonVisualState == RADIAL_MENU_CONSTS.NORMAL_BUTTON_STATE;
