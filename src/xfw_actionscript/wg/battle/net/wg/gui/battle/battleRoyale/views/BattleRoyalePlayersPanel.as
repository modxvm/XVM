package net.wg.gui.battle.battleRoyale.views
{
    ...
    public class BattleRoyalePlayersPanel extends BattleRoyalePlayersPanelMeta implements IBattleRoyalePlayersPanelMeta
    {
        ...
        private var _listItems:Vector.<BattleRoyalePlayersPanelListItem> = null;
        ...
        public function BattleRoyalePlayersPanel()
        {
            ...
            this._listItems = new Vector.<BattleRoyalePlayersPanelListItem>(0);
        ...
        override protected function setInitData(param1:String, param2:Array, param3:Array) : void
        {
            ...
            var _loc6_:BattleRoyalePlayersPanelListItem = null;
            while(_loc4_ < _loc5_)
            {
                _loc6_ = this.addItem();
        ...
        {
            var _loc3_:BattleRoyalePlayersPanelListItem = this.getListItem(param1);
            if(_loc3_)
            {
        ...
        {
            var _loc8_:BattleRoyalePlayersPanelListItem = this.getListItem(param1);
            if(_loc8_)
            {
        ...
        {
            var _loc4_:BattleRoyalePlayersPanelListItem = this.getListItem(param1);
            if(_loc4_)
            {
        ...
        private function getListItem(param1:int) : BattleRoyalePlayersPanelListItem
        {
            var _loc2_:BattleRoyalePlayersPanelListItem = null;
        ...
        private function addItem() : BattleRoyalePlayersPanelListItem
        {
            var _loc1_:BattleRoyalePlayersPanelListItem = App.utils.classFactory.getComponent(Linkages.PLAYERS_PANEL_LIST_ITEM,BattleRoyalePlayersPanelListItem);
            _loc1_.x = PADDING_H;
        ...
        {
            var _loc1_:BattleRoyalePlayersPanelListItem = null;
