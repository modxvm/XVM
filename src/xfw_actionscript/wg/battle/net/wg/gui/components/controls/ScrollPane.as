package net.wg.gui.components.controls
{
    ...
    public class ScrollPane extends UIComponentEx
    {
        ...
        public function doMouseWheel(param1:int) : void
        {
            ...
            {
                this.scrollPosition = this.scrollPosition - (param1 > 0?1:-1);
            }
        }
        ...
        protected function drawBackground() : void
        {
            ...
            _loc1_.drawRect(this._isTargetHorizontalCentered?-_width >> 1:0,0,_width + this._scrollBarShiftHorizontal,this.availableHeight);
            _loc1_.endFill();
        }
        ...
        protected function applyScrollBarUpdating() : void
        {
            ...
            if(this._target && enabled)
            {
                ...
                _loc7_ = _loc5_ >= _loc6_?_loc6_:_loc5_;
        ...
        public function get maxScroll() : Number
        {
            ...
            return this._isSmoothScroll?_loc1_:Math.ceil(_loc1_);
        }
