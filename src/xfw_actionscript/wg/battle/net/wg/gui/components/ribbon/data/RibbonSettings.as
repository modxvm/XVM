package net.wg.gui.components.ribbon.data
{
    ...
    public class RibbonSettings extends Object implements IDisposable
    {
        ...
        private static const BUFFS_PADDINGS:String = "buffsPaddings";
        ...
        public static function getBuffsPaddings() : PaddingSettings
        {
            return PADDINGS_X[BUFFS_PADDINGS];
        }
        ...
        protected function atlasInit() : void
        {
            ...
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.EVENT_DEATH_ON_PHASE_CHANGE] = new RibbonSettingByType(_loc2_,BATTLEATLAS.RIBBONS_DAMAGE_ENEMY,_loc3_,BATTLEATLAS.RIBBONS_DAMAGE_ENEMY_BLIND,1);
            ...
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.ENEMY_SECTOR_CAPTURED] = new RibbonSettingByType(_loc1_,BATTLEATLAS.RIBBONS_ENEMY_SECTOR_CAPTURED,_loc1_,BATTLEATLAS.RIBBONS_ASSIST_STUN,1);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.DESTRUCTIBLE_DAMAGED] = new RibbonSettingByType(_loc1_,BATTLEATLAS.RIBBONS_DESTRUCTIBLE_DAMAGED,_loc1_,BATTLEATLAS.RIBBONS_ASSIST_STUN,1);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.DESTRUCTIBLE_DESTROYED] = new RibbonSettingByType(_loc1_,BATTLEATLAS.RIBBONS_DESTRUCTIBLE_DESTROYED,_loc1_,BATTLEATLAS.RIBBONS_ASSIST_STUN,1);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.DESTRUCTIBLES_DEFENDED] = new RibbonSettingByType(_loc1_,BATTLEATLAS.RIBBONS_DESTRUCTIBLES_DEFENDED,_loc1_,BATTLEATLAS.RIBBONS_ASSIST_STUN,1);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.DEFENDER_BONUS] = new RibbonSettingByType(_loc1_,BATTLEATLAS.RIBBONS_DEFENDER_BONUS,_loc1_,BATTLEATLAS.RIBBONS_ASSIST_STUN,1);
            ...
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.RECEIVED_BY_MINEFIELD] = new RibbonSettingByType(_loc2_,BATTLEATLAS.RIBBONS_DAMAGE_BY_MINE_FIELD,_loc3_,BATTLEATLAS.RIBBONS_DAMAGE_BY_MINE_FIELD,1);
            ...
            var _loc5_:String = RibbonColors.BUFFS;
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.BUFFS_RATION] = new RibbonSettingByType(_loc5_,BATTLEATLAS.LOG_BUFFS_RATION,_loc5_,BATTLEATLAS.LOG_BUFFS_RATION,1);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.BUFFS_FUEL] = new RibbonSettingByType(_loc5_,BATTLEATLAS.LOG_BUFFS_FUEL,_loc5_,BATTLEATLAS.LOG_BUFFS_FUEL,1);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.BUFFS_RATE_FIRE] = new RibbonSettingByType(_loc5_,BATTLEATLAS.LOG_BUFFS_RATE_FIRE,_loc5_,BATTLEATLAS.LOG_BUFFS_RATE_FIRE,1);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.BUFFS_CONVERSION_SPEED] = new RibbonSettingByType(_loc5_,BATTLEATLAS.LOG_BUFFS_CONVERSION_SPEED,_loc5_,BATTLEATLAS.LOG_BUFFS_CONVERSION_SPEED,1);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.BUFFS_INCREASED_MAXIMUM_DAMAGE] = new RibbonSettingByType(_loc5_,BATTLEATLAS.LOG_BUFFS_INCREASED_MAXIMUM_DAMAGE,_loc5_,BATTLEATLAS.LOG_BUFFS_INCREASED_MAXIMUM_DAMAGE,1);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.BUFFS_DOUBLE_DAMAGE] = new RibbonSettingByType(_loc5_,BATTLEATLAS.LOG_BUFFS_DOUBLE_DAMAGE,_loc5_,BATTLEATLAS.LOG_BUFFS_DOUBLE_DAMAGE,1);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.BUFFS_INCENDIARY_SHOT] = new RibbonSettingByType(_loc5_,BATTLEATLAS.LOG_BUFFS_INCENDIARY_SHOT,_loc5_,BATTLEATLAS.LOG_BUFFS_INCENDIARY_SHOT,1);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.BUFFS_VAMPIRIC_SHOT] = new RibbonSettingByType(_loc5_,BATTLEATLAS.LOG_BUFFS_VAMPIRIC_SHOT,_loc5_,BATTLEATLAS.LOG_BUFFS_VAMPIRIC_SHOT,1);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.BUFFS_CONSTANT_HP_REGENERATION] = new RibbonSettingByType(_loc5_,BATTLEATLAS.LOG_BUFFS_CONSTANT_HP_REGENERATION,_loc5_,BATTLEATLAS.LOG_BUFFS_CONSTANT_HP_REGENERATION,1);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.BUFFS_ARMOR] = new RibbonSettingByType(_loc5_,BATTLEATLAS.LOG_BUFFS_ARMOR,_loc5_,BATTLEATLAS.LOG_BUFFS_ARMOR,1);
            ...
            BACKGROUNDS[_loc5_] = new BackgroundAtlasNames(RibbonColors.ORANGE);
            ...
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.BOSS] = new DamageSourceSetting(BATTLEATLAS.EVENT_BIG_BOSS_BOT);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.BOMBER] = new DamageSourceSetting(BATTLEATLAS.EVENT_BOMBER_BOT);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.HUNTER] = new DamageSourceSetting(BATTLEATLAS.EVENT_HUNTER_BOT);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.RUNNER] = new DamageSourceSetting(BATTLEATLAS.EVENT_RUNNER_BOT);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.RUNNER_SHOOTER] = new DamageSourceSetting(BATTLEATLAS.EVENT_RUNNER_BOT);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.SENTRY] = new DamageSourceSetting(BATTLEATLAS.EVENT_SENTRY_BOT);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.TURRET] = new DamageSourceSetting(BATTLEATLAS.EVENT_TURRET_BOT);
        ...
        private function init() : void
        {
            if(!_isInit)
            {
                ...
                TEXT_SETTINGS[RibbonColors.BUFFS] = new RibbonTextSettings(RibbonColors.BUFFS);
                PADDINGS_X[WITH_NAME_WITH_TANKNAME_PADDINGS] = new PaddingSettings(-156,0,0,7,26);
                PADDINGS_X[WITHOUT_NAME_WITH_TANKNAME_PADDINGS] = new PaddingSettings(-112,3,0,0,24);
                PADDINGS_X[WITH_NAME_WITHOUT_TANKNAME_PADDINGS] = new PaddingSettings(-135,0,0,0,0);
                PADDINGS_X[WITHOUT_NAME_WITHOUT_TANKNAME_PADDINGS] = new PaddingSettings(-94,4,0,0,0);
                PADDINGS_X[BUFFS_PADDINGS] = new PaddingSettings(-180,0,0,7,26);
                ...
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.SENTRY] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.RUNNER] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.RUNNER_SHOOTER] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.HUNTER] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.BOMBER] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.TURRET] = 0;
                ...
                ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.SENTRY] = 11;
                ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.RUNNER] = 11;
                ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.RUNNER_SHOOTER] = 11;
                ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.HUNTER] = 11;
                ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.BOMBER] = 11;
                ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.TURRET] = 11;
            }
        }
    }
}
