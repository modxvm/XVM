package net.wg.gui.components.ribbon.data
{
    ...
    public class RibbonSettings extends Object implements IDisposable
    {
        ...
        protected function atlasInit() : void
        {
            ...
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.EVENT_ABILITY_DAMAGE] = new RibbonSettingByType(_loc1_,BATTLEATLAS.RIBBONS_DAMAGE,_loc1_,BATTLEATLAS.RIBBONS_DAMAGE,3);
            RIBBON_TYPES_MAP[BATTLE_EFFICIENCY_TYPES.EVENT_DEATHZONE_DAMAGE] = new RibbonSettingByType(_loc2_,BATTLEATLAS.RIBBONS_DAMAGE_ENEMY,_loc3_,BATTLEATLAS.RIBBONS_DAMAGE,3);
            ...
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.AT_SPG_NORMAL] = new DamageSourceSetting(BATTLEATLAS.AT_SPG_NORMAL);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.SPG_NORMAL] = new DamageSourceSetting(BATTLEATLAS.SPG_NORMAL);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.HEAVY_TANK_NORMAL] = new DamageSourceSetting(BATTLEATLAS.HEAVY_TANK_NORMAL);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.LIGHT_TANK_NORMAL] = new DamageSourceSetting(BATTLEATLAS.LIGHT_TANK_NORMAL);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.MEDIUM_TANK_NORMAL] = new DamageSourceSetting(BATTLEATLAS.MEDIUM_TANK_NORMAL);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.AT_SPG_ELITE] = new DamageSourceSetting(BATTLEATLAS.AT_SPG_ELITE);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.SPG_ELITE] = new DamageSourceSetting(BATTLEATLAS.SPG_ELITE);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.HEAVY_TANK_ELITE] = new DamageSourceSetting(BATTLEATLAS.HEAVY_TANK_ELITE);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.LIGHT_TANK_ELITE] = new DamageSourceSetting(BATTLEATLAS.LIGHT_TANK_ELITE);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.MEDIUM_TANK_ELITE] = new DamageSourceSetting(BATTLEATLAS.MEDIUM_TANK_ELITE);
            DAMAGE_SOURCE_MAP[DAMAGE_SOURCE_TYPES.BOSS_KILL] = new DamageSourceSetting(BATTLEATLAS.BOSS_KILL);
        ...
        private function init() : void
        {
            if(!_isInit)
            {
                ...
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.AT_SPG_NORMAL] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.SPG_NORMAL] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.HEAVY_TANK_NORMAL] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.LIGHT_TANK_NORMAL] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.MEDIUM_TANK_NORMAL] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.AT_SPG_ELITE] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.SPG_ELITE] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.HEAVY_TANK_ELITE] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.LIGHT_TANK_ELITE] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.MEDIUM_TANK_ELITE] = 0;
                ICON_X_PADDINGS[DAMAGE_SOURCE_TYPES.BOSS_KILL] = 0;
                ...
                ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.AT_SPG_NORMAL] = 11;
                ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.SPG_NORMAL] = 11;
                ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.HEAVY_TANK_NORMAL] = 11;
                ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.LIGHT_TANK_NORMAL] = 11;
                ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.MEDIUM_TANK_NORMAL] = 11;
                ...
                ICON_Y_PADDINGS[DAMAGE_SOURCE_TYPES.BOSS_KILL] = 11;
            }
        }
    }
}
