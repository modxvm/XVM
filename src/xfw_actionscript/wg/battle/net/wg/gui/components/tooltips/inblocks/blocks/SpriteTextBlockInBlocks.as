package net.wg.gui.components.tooltips.inblocks.blocks
{
    ...
    public class SpriteTextBlockInBlocks extends BaseTooltipBlock
    {
        ...
        {
            var _loc6_:int = param4 != null?param4.left - param4.right:0;
            ...
            if(this._blockWidth > 0)
            {
                ...
                {
                    param1.width = param1.width - (this.getImageWidth() - _loc6_);
                }
            }
            else
            {
        ...
        {
            return this._blockWidth > 0?this._blockWidth:super.getWidth();
        }
        ...
        private function layout() : void
        {
            ...
            if(this.descriptionTF != null && this.descriptionTF.text != Values.EMPTY_STR)
            {
                if(this.descriptionTF.visible)
                {
                    ...
                    this.onLayoutText(this.descriptionTF,_loc4_,_loc2_,_loc10_?_loc10_:_loc11_,this._originDescriptionWidth);
            ...
            if(this.content != null)
            {
                if(this.content.visible)
                {
                    ...
                    if(!_loc6_)
                    {
                        _loc5_ = _loc5_ + Math.max(_loc12_,_loc13_);
                    }
