package net.wg.gui.components.windows
{
    ...
    public class Window extends scaleform.clik.controls.Window implements IWindow
    {
        ...
        public function getBtnsBounds() : Rectangle
        {
            ...
            _loc1_.x = this.minimizeBtn.visible?this.minimizeBtn.x:closeBtn.x;
            _loc1_.y = closeBtn.y;
        ...
        public function updateSize(param1:Number, param2:Number, param3:Boolean = false) : void
        {
            if(param3)
            {
                var param1:Number = param1 + contentPadding.horizontal;
                var param2:Number = param2 + contentPadding.vertical;
            }
            if(this.initialized)
            {
        ...
        private function updateTopButtonPositions() : Boolean
        {
            ...
            {
                _loc3_ = this.minimizeBtn.visible?this.minimizeBtn.width:0;
        ...
        public function set useBottomBtns(param1:Boolean) : void
        {
            ...
            this.formBgPadding.bottom = this._useBottomBtns?this.getBgFormDefPadding().bottom + BTN_PADDING_Y:this.getBgFormDefPadding().bottom;
            invalidate(INVALID_PADDING);
        }
