package net.wg.gui.components.questProgress
{
    ...
    public class QuestProgressAtlasSprite extends Sprite
    {

        private var _imageName:String = "";

        private var _imageAltName:String = "";

        private var _isFilled:Boolean = false;

        private var _drawImmediately:Boolean = false;
        ...
        public function QuestProgressAtlasSprite(param1:Boolean = false)
        {
            super();
        ...
        {
            return ATLAS_CONSTANTS.QUESTS_PROGRESS;
        }
