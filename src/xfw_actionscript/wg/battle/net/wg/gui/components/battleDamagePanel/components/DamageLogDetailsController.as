package net.wg.gui.components.battleDamagePanel.components
{
    ...
    public class DamageLogDetailsController extends Object implements IDisposable
    {
        ...
        public function setDetailsCount(param1:int) : void
        {
            ...
            var _loc4_:* = this._visibilityRowsCount < param1;
            if(_loc4_)
            {
        ...
        private function scroll(param1:int) : void
        {
            ...
            {
                var param1:int = this._totalFilledData - this._scrollPosition;
            }
            ...
            while(this._scrollPosition != _loc2_)
            {
                ...
                this._scrollPosition = this._scrollPosition + _loc3_;
            }
        ...
        private function makePool(param1:int) : void
        {
            ...
            var _loc2_:int = this._atlasName == ATLAS_CONSTANTS.BATTLE_ATLAS?Math.max(BattleDamageLogConstants.DEFAULT_POOL_COUNT,param1):BattleDamageLogConstants.SETTINGS_POOL_COUNT;
            var _loc4_:* = 0;
            while(_loc4_ < _loc2_)
            {
                _loc3_ = new Sprite();
                ...
                _loc3_.y = _loc3_.y + this._lastYValue;
