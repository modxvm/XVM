    ...
    public class ImageTextComponent extends UIComponentEx
    {
        ...
        protected function updateLayout() : void
        {
            ...
            if(this._horizontalAlign == AlignType.LEFT)
            {
                ...
                {
                    this.textField.x = this.textField.x + (this.icon.width + this._gap);
                }
                else if(this._iconPosition == IconTextPosition.RIGHT)
                {
                    this.icon.x = this.icon.x + (this.textField.width + this._gap);
                }
            }
            ...
            if(this._verticalAlign == AlignType.TOP)
            {
                ...
                {
                    this.textField.y = this.textField.y + (this.icon.height + this._gap);
                }
                else if(this._iconPosition == IconTextPosition.BOTTOM)
                {
                    this.icon.y = this.icon.y + (this.textField.height + this._gap);
                }
            }
