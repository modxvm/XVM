package net.wg.gui.components.paginator
{
    ...
    public class PaginationGroup extends GroupEx
    {
        ...
        override public function getProviderLength() : uint
        {
            ...
            {
                _loc1_ = _loc1_ - this._currentPageIndex * this._maxElementsPerPage;
        ...
        {
            var _loc2_:int = this.isMultiPages()?param1 + this._maxElementsPerPage * this._currentPageIndex:param1;
        ...
        public function getRendererIndex(param1:int) : int
        {
            if(this.isMultiPages())
            {
                var param1:int = param1 % this._maxElementsPerPage;
            }
            return param1;
        }
        ...
        {
            return this.isMultiPages()?super.width / this.getProviderLength() * this._maxElementsPerPage:super.width;
        }
