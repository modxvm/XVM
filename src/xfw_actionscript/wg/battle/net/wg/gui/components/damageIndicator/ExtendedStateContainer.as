package net.wg.gui.components.damageIndicator
{
    ...
    public class ExtendedStateContainer extends StandardStateContainer
    {
        ...
        private static const TANK_TYPE_ICONS:Vector.<String> = new <String>[DAMAGEINDICATOR.HEAVY_TANK,DAMAGEINDICATOR.MEDIUM_TANK,DAMAGEINDICATOR.LIGHT_TANK,DAMAGEINDICATOR.AT_SPG,DAMAGEINDICATOR.SPG,DAMAGEINDICATOR.ALLY_HEAVY_TANK,DAMAGEINDICATOR.ALLY_MEDIUM_TANK,DAMAGEINDICATOR.ALLY_LIGHT_TANK,DAMAGEINDICATOR.ALLY_AT_SPG,DAMAGEINDICATOR.ALLY_SPG,DAMAGE_SOURCE_TYPES.AT_SPG_NORMAL,DAMAGE_SOURCE_TYPES.SPG_NORMAL,DAMAGE_SOURCE_TYPES.HEAVY_TANK_NORMAL,DAMAGE_SOURCE_TYPES.LIGHT_TANK_NORMAL,DAMAGE_SOURCE_TYPES.MEDIUM_TANK_NORMAL,DAMAGE_SOURCE_TYPES.AT_SPG_ELITE,DAMAGE_SOURCE_TYPES.SPG_ELITE,DAMAGE_SOURCE_TYPES.HEAVY_TANK_ELITE,DAMAGE_SOURCE_TYPES.LIGHT_TANK_ELITE,DAMAGE_SOURCE_TYPES.MEDIUM_TANK_ELITE,DAMAGE_SOURCE_TYPES.BOSS_KILL];
        ...
        override public function rotateInfo(param1:Number) : void
        {
            ...
            this.tankName.rotation = this.tankIcon.rotation = param1 < 0?-TANK_NAME_ROTATION:TANK_NAME_ROTATION;
        }
