package
{
    public class PO_FILES extends Object
    {
        ...
        public static const TEXT_BOB:String = "../text/bob.po";
        ...
        public static const TEXT_POSTBATTLE_SCREEN:String = "../text/postbattle_screen.po";
        ...
        public static const TEXT_TEN_YEAR_COUNTDOWN:String = "../text/ten_year_countdown.po";

        public static const TEXT_TIPS:String = "../text/tips.po";

        public static const TEXT_TOOLTIPS:String = "../text/tooltips.po";

        public static const TEXT_TRANSFER_GIVEAWAY:String = "../text/transfer_giveaway.po";
        ...
        public static const TEXT_WT_EVENT:String = "../text/wt_event.po";

        public static const ALL_ENUM:Array = [TEXT_ACHIEVEMENTS,TEXT_AOGAS,TEXT_ARENAS,TEXT_ARTEFACTS,TEXT_BADGE,TEXT_BAN_REASON,TEXT_BATTLE_PASS_2020,TEXT_BATTLE_RESULTS,TEXT_BATTLE_ROYALE,TEXT_BATTLE_TUTORIAL,TEXT_BLUEPRINTS,TEXT_BOB,TEXT_BOOTCAMP,TEXT_CAT,TEXT_CHAT,TEXT_CHINA_TANKMEN,TEXT_CHINA_VEHICLES,TEXT_CLANS,TEXT_COMMON,TEXT_CONTROLS,TEXT_CREW_BOOKS,TEXT_CREW_OPERATIONS,TEXT_CREW_SKINS,TEXT_CYBERSPORT,TEXT_CZECH_TANKMEN,TEXT_CZECH_VEHICLES,TEXT_DEMOUNT_KIT,TEXT_DEVELOPMENT,TEXT_DIALOGS,TEXT_ENVIRONMENT_TOOLTIPS,TEXT_EPIC_BATTLE,TEXT_ERROR_DLG,TEXT_EVENT,TEXT_EVENT_BOARDS,TEXT_EVENT_PROGRESSION,TEXT_FALLOUT,TEXT_FAQ,TEXT_FORTIFICATIONS,TEXT_FRANCE_TANKMEN,TEXT_FRANCE_VEHICLES,TEXT_GB_TANKMEN,TEXT_GB_VEHICLES,TEXT_GERMANY_TANKMEN,TEXT_GERMANY_VEHICLES,TEXT_IGR_VEHICLES,TEXT_INGAME_GUI,TEXT_INGAME_HELP,TEXT_INVITES,TEXT_ITALY_TANKMEN,TEXT_ITALY_VEHICLES,TEXT_ITEM_TYPES,TEXT_JAPAN_TANKMEN,TEXT_JAPAN_VEHICLES,TEXT_LINKEDSET,TEXT_LOBBY_HELP,TEXT_LOOTBOXES,TEXT_MANUAL,TEXT_MARATHON,TEXT_MENU,TEXT_MESSENGER,TEXT_MINICLIENT,TEXT_MOTIVATION_QUESTS,TEXT_MULTINATIONAL_VEHICLES,TEXT_NATIONS,TEXT_OFFERS,TEXT_PERSONAL_MISSIONS,TEXT_PERSONAL_MISSIONS_DETAILS,TEXT_POLAND_TANKMEN,TEXT_POLAND_VEHICLES,TEXT_POSTBATTLE_SCREEN,TEXT_PREBATTLE,TEXT_PREMACC,TEXT_PROFILE,TEXT_PROGRESSIVE_REWARD,TEXT_QUESTS,TEXT_RANKED_BATTLES,TEXT_READABLE_KEY_NAMES,TEXT_RETRAIN_CREW,TEXT_SENIORITY_AWARDS,TEXT_SESSION_STATS,TEXT_SETTINGS,TEXT_STORAGE,TEXT_STORE,TEXT_SWEDEN_TANKMEN,TEXT_SWEDEN_VEHICLES,TEXT_SYSTEM_MESSAGES,TEXT_TANK_CAROUSEL_FILTER,TEXT_TANK_SETUP,TEXT_TEN_YEAR_COUNTDOWN,TEXT_TIPS,TEXT_TOOLTIPS,TEXT_TRANSFER_GIVEAWAY,TEXT_TUTORIAL,TEXT_USA_TANKMEN,TEXT_USA_VEHICLES,TEXT_USSR_TANKMEN,TEXT_USSR_VEHICLES,TEXT_VEHICLE_CUSTOMIZATION,TEXT_VEHICLE_CUSTOMIZATION_CN,TEXT_VEHICLE_PREVIEW,TEXT_VEH_COMPARE,TEXT_W2C,TEXT_WAITING,TEXT_WT_EVENT];
