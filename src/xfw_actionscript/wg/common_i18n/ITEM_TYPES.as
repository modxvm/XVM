package
{
    public class ITEM_TYPES extends Object
    {
        ...
        public static const WHEEL_NAME:String = "#item_types:wheel/name";
        ...
        public static const BATTLEBOOSTER_NAME:String = "#item_types:battleBooster/name";

        public static const BATTLEABILITY_NAME:String = "#item_types:battleAbility/name";
        ...
        public static const TANKMAN_SKILLS_FIREFIGHTING:String = "#item_types:tankman/skills/fireFighting";
        ...
        public static const TANKMAN_SKILLS_TYPE_PERK_SHORT:String = "#item_types:tankman/skills/type/perk_short";
        ...
        public static const CUSTOMIZATION_PAINT:String = "#item_types:customization/paint";

        public static const CUSTOMIZATION_CAMOUFLAGE:String = "#item_types:customization/camouflage";

        public static const CUSTOMIZATION_MODIFICATION:String = "#item_types:customization/modification";

        public static const CUSTOMIZATION_OUTFIT:String = "#item_types:customization/outfit";

        public static const CUSTOMIZATION_STYLE:String = "#item_types:customization/style";

        public static const CUSTOMIZATION_DECAL:String = "#item_types:customization/decal";

        public static const CUSTOMIZATION_EMBLEM:String = "#item_types:customization/emblem";

        public static const CUSTOMIZATION_INSCRIPTION:String = "#item_types:customization/inscription";

        public static const CUSTOMIZATION_PROJECTIONDECAL:String = "#item_types:customization/projectionDecal";

        public static const CUSTOMIZATION_PERSONALNUMBER_3:String = "#item_types:customization/personalNumber_3";

        public static const CUSTOMIZATION_PERSONALNUMBER_2:String = "#item_types:customization/personalNumber_2";
        ...
        public static const CUSTOMIZATION_PLURAL_MODIFICATION:String = "#item_types:customization/plural/modification";
        ...
        public static const CUSTOMIZATION_PLURAL_EMBLEM:String = "#item_types:customization/plural/emblem";

        public static const CUSTOMIZATION_PLURAL_INSCRIPTION:String = "#item_types:customization/plural/inscription";
        ...
        public static const CREWSKINS_ITEMTYPE_RARE:String = "#item_types:crewSkins/itemType/rare";

        public static const CREWSKINS_ITEMTYPE_EPIC:String = "#item_types:crewSkins/itemType/epic";

        public static const TANKMAN_GENDER_MAN:String = "#item_types:tankman/gender/man";
        ...
        public static function shell_kindsabbreviation(param1:String) : String
        {
            ...
            if(SHELL_KINDSABBREVIATION_ENUM.indexOf(_loc2_) == -1)
            {
                DebugUtils.LOG_WARNING("[shell_kindsabbreviation]:locale key \"" + _loc2_ + "\" was not found");
                return null;
            }
            return _loc2_;
        }
        ...
        public static function shell_kinds(param1:String) : String
        {
            ...
            if(SHELL_KINDS_ENUM.indexOf(_loc2_) == -1)
            {
                DebugUtils.LOG_WARNING("[shell_kinds]:locale key \"" + _loc2_ + "\" was not found");
                return null;
            }
            return _loc2_;
        }
        ...
        public static function tankman_skills_type(param1:String) : String
        {
            ...
            if(TANKMAN_SKILLS_TYPE_ENUM.indexOf(_loc2_) == -1)
            {
                DebugUtils.LOG_WARNING("[tankman_skills_type]:locale key \"" + _loc2_ + "\" was not found");
                return null;
            }
            return _loc2_;
        }
