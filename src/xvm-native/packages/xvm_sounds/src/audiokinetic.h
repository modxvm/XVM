...
enum AKRESULT __cdecl AK_SoundEngine_LoadBank(const char * in_pszString, AkMemPoolId in_memPoolId, AkBankID* out_bankID);
typedef enum AKRESULT (__cdecl *AK_SoundEngine_LoadBank_Func)(const char * in_pszString, AkMemPoolId in_memPoolId, AkBankID* out_bankID);
...
typedef enum AKRESULT(__cdecl *AK_SoundEngine_UnloadBank_Func)(const char * in_pszString, const void * in_pInMemoryBankPtr, AkMemPoolId * out_pMemPoolId);