...
void pythonWrapperInit(void)
{
    ...
    wrp_PyArg_ParseTuple_func = (wrp_PyArg_ParseTuple_typedef*)(FindFunction(startpos, endpos, &curpos, "\x55\x8B\xEC\x51\x8D\x45\x10\x89\x45\xFC\x6A\x00\x8D\x45\xFC\x50","xxxxxxxxxxxxxxxx"));
    ...
    wrp_Py_InitModule4_func = (wrp_Py_InitModule4_typedef*)(FindFunction(startpos, endpos, &curpos, "\x55\x8B\xEC\x81\xEC\x14\x02\x00\x00\xA1\x00\x00\x00\x00\x33\xC5\x89\x45\xFC\x8B\x45\x10\x53\x8B\x5D\x0C\x89\x85\xF4\xFD\xFF\xFF","xxxxxxxxxx????xxxxxxxxxxxxxxxxxx"));
