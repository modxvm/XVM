...
class XVM(object):
    _version_parts = openwg_loader.get_mod_version('com.modxvm.xvm').split('.')
    XVM_VERSION    = '.'.join(_version_parts[0:3])
    XVM_REVISION   = _version_parts[3]
    ...
    CONFIG_DIR = openwg_loader.PATH_ROOT + u'res_mods/configs/xvm'
    CONFIG_FILE = CONFIG_DIR + u'/xvm.xc'
    PY_MACRO_DIR = CONFIG_DIR + u'/py_macro'
    SHARED_RESOURCES_DIR = openwg_loader.PATH_ROOT + u'res_mods/mods/shared_resources/xvm'
