 ...
 * https://modxvm.com/
 */
package com.xvm.battle.epicrandom.fullStats
{
    import com.xfw.*;
    import com.xvm.*;
    ...
    public class UI_EpicRandomFullStats extends epicRandomFullStatsUI
    {
        ...
        public function UI_EpicRandomFullStats()
        {
            //Logger.add("UI_EpicRandomFullStats");
            super();
        ...
        {
            //Xvm.swfProfilerBegin("UI_EpicRandomFullStats.setup()");
            try
            {
            ...
            //Xvm.swfProfilerEnd("UI_EpicRandomFullStats.setup()");
            return null;
        }
