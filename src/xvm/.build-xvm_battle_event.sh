...
build_as3_swf \
    ...
    -external-library-path+=../../~output/xfw/swc/wg_battle_event_ui.swc \
    ...
    -output ../../~output/xvm/res_mods/mods/xfw_packages/xvm_battle/as_battle_event/xvm_battle_event.swf \
    $doc
