...
build_as3_swf \
    ...
    -external-library-path+=../../~output/$XVMBUILD_FLAVOR/xfw/swc/wg_battle_royale_ui.swc \
    ...
    -output ../../~output/$XVMBUILD_FLAVOR/xvm/res_mods/mods/xfw_packages/xvm_battle/as_battle_royale/xvm_battle_royale.swf \
    $doc
