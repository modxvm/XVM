...
build_as3_swf \
    ...
    -external-library-path+=../xfw/~output/swc/wg_battle_royale_ui.swc \
    ...
    -output ../../~output/res_mods/mods/xfw_packages/xvm_battle/as_battle_royale/xvm_battle_royale.swf \
    $doc
