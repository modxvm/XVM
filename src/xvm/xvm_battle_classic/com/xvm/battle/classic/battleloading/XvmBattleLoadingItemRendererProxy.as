...
package com.xvm.battle.classic.battleloading
{
    ...
    public class XvmBattleLoadingItemRendererProxy implements IExtraFieldGroupHolder
    {
        ...
        private function alignSquad():void
        {
            if (_isLeftPanel)
            {
        ...
        private function alignNameField():void
        {
            ...
            if (_isLeftPanel)
            {
                ...
                if (!cfg.removeRankBadgeIcon)
                {
                    ...
                    ui.nameField.x += BADGE_ICON_WIDTH + 1;
                    ui.nameField.width -= BADGE_ICON_WIDTH + 1;
                }
            }
            else
            {
                ...
                if (!cfg.removeRankBadgeIcon)
                {
                    ui.badgeIcon.x = ui.nameField.x + ui.nameField.width - BADGE_ICON_WIDTH;
                    ui.nameField.width -= BADGE_ICON_WIDTH + 1;
                }
            }
        }
        ...
        private function alignVehicleIcon():void
        {
            ...
            ui.vehicleLevelIcon.isCentralizeByX = true;
        }
