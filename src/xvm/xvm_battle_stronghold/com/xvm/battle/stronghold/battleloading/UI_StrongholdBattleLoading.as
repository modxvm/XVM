...
package com.xvm.battle.stronghold.battleloading
{
    ...
    public class UI_StrongholdBattleLoading extends BattleLoadingUI
    {
        ...
        public function UI_StrongholdBattleLoading()
        {
            //Logger.add("UI_StrongholdBattleLoading");
            super();
        ...
        {
            //Xvm.swfProfilerBegin("UI_StrongholdBattleLoading.setup()");
            try
            {
            ...
            //Xvm.swfProfilerEnd("UI_StrongholdBattleLoading.setup()");
        }
        ...
        private function initRenderers():void
        {
            ...
            var cls:Class = isTipsForm ? XvmStrongholdTipPlayerItemRenderer : XvmStrongholdTablePlayerItemRenderer;
