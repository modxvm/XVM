...
package com.xvm.battle.stronghold.playersPanel
{
    ...
    public class UI_StrongholdPlayersPanelListItemRight extends PlayersPanelListItemRightUI
    {
        private var proxy:StrongholdPlayersPanelListItemProxy;

        public function UI_StrongholdPlayersPanelListItemRight()
        {
            super();
            proxy = new StrongholdPlayersPanelListItemProxy(this, false);
        ...
        {
            if (XfwUtils.getPrivateField(this, "xfw_state") != param1)
            {
