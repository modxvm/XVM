...
package com.xvm.battle.playersPanel
{
    ...
    public dynamic class UI_EpicRandomPlayersPanelListItemLeft extends EpicRandomPlayersPanelListItemLeftUI
    {
        private var proxy:EpicRandomPlayersPanelListItemProxy;

        public function UI_EpicRandomPlayersPanelListItemLeft()
        {
            super();
            proxy = new EpicRandomPlayersPanelListItemProxy(this, true);
            // TODO:EPIC
