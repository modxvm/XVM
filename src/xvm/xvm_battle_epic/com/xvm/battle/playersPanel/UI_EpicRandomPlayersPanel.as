...
package com.xvm.battle.playersPanel
{
    ...
    public /*dynamic*/ class UI_EpicRandomPlayersPanel extends epicRandomPlayersPanelUI
    {
        ...
        private var XVM_PLAYERS_PANEL_LIST_ITEM_LEFT_LINKAGE:String = getQualifiedClassName(UI_EpicRandomPlayersPanelListItemLeft);
        private var DEFAULT_PLAYERS_PANEL_LIST_ITEM_RIGHT_LINKAGE:String = PlayersPanelListRight.LINKAGE;
        private var XVM_PLAYERS_PANEL_LIST_ITEM_RIGHT_LINKAGE:String = getQualifiedClassName(UI_EpicRandomPlayersPanelListItemRight);
        ...
        public function UI_EpicRandomPlayersPanel()
        {
            //Logger.add("UI_EpicRandomPlayersPanel()");
            super();
