...
package com.xvm.battle.playersPanel
{
    ...
    public dynamic class UI_EpicRandomPlayersPanelListItemRight extends EpicRandomPlayersPanelListItemRightUI
    {
        private var proxy:EpicRandomPlayersPanelListItemProxy;

        public function UI_EpicRandomPlayersPanelListItemRight()
        {
            super();
            proxy = new EpicRandomPlayersPanelListItemProxy(this, false);
            // TODO:EPIC
        ...
        override public function setPlayerNameFullWidth(param1:Number):void
        {
            ...
            else
            {
                ...
                proxy.invalidate(EpicRandomPlayersPanelListItemProxy.INVALIDATE_PANEL_STATE);
                proxy.validateNow();
            }
        }*/
        ...
        override protected function draw():void
        {
            try
            {
                ...
                if (proxy.xvm_enabled)
                {
                    ...
                    {
                        proxy.invalidate(EpicRandomPlayersPanelListItemProxy.INVALIDATE_UPDATE_COLORS);
                    }
