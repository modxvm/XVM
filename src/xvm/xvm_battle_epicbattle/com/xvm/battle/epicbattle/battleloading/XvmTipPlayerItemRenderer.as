...
package com.xvm.battle.epicbattle.battleloading
{
    ...
    import net.wg.gui.battle.epicBattle.battleloading.renderers.*;
    import net.wg.gui.components.icons.*;

    public class XvmTipPlayerItemRenderer extends TableEpicBattlePlayerItemRenderer implements IXvmBattleLoadingItemRenderer
    {
