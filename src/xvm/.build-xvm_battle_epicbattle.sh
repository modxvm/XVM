...
build_as3_swf \
    ...
    -external-library-path+=../xfw/~output/swc/wg_battle_epicbattle_ui.swc \
    ...
    -output ../../~output/res_mods/mods/xfw_packages/xvm_battle/as_battle_epicbattle/xvm_battle_epicbattle.swf \
    $doc
