...
build_as3_swf \
    ...
    -external-library-path+=../../~output/$XVMBUILD_FLAVOR/xfw/swc/wg_battle_classic_ui.swc \
    ...
    -output ../../~output/$XVMBUILD_FLAVOR/xvm/res_mods/mods/xfw_packages/xvm_battle/as_battle_classic/xvm_battle_classic.swf \
    $doc
