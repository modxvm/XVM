...
build_as3_swf \
    ...
    -external-library-path+=../xfw/~output/swc/wg_battle_classic_ui.swc \
    ...
    -output ../../~output/res_mods/mods/xfw_packages/xvm_battle/as_battle_classic/xvm_battle_classic.swf \
    $doc
