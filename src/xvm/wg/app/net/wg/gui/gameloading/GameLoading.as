package net.wg.gui.gameloading
{
    ...
    public class GameLoading extends UIComponent
    {
        ...
        private static var AWARDS_PATH:String = "../maps/loading_award.png";
        
        private static var INVALID_VERSION:String = "invalidVersion";
        
        private static var INVALID_PROGRESS:String = "invalidProgress";
        
        private static var INVALID_LOCALE:String = "invalidLocale";
        
        private static var MIN_APP_WIDTH:Number = 1024;
        
        private static var MIN_APP_HEIGHT:Number = 768;
        
        private static var FORM_VERTICAL_OFFSET:Number = 52;
        
        private static var INFO_TEXT_PADDING:Number = 20;
        
        private static var MAX_INFO_FONT_SIZE:Number = 64;
