package net.wg.gui.components.common.crosshair
{
    ...
    public class CrosshairStrategic extends CrosshairBase
    {
        ...
        private static var NODE_TYPE_RED:String = "red";
        
        private static var NODE_TYPE_GREEN:String = "green";
        
        private static var NODE_TYPE_DEBUG:String = "debug";
        
        private static var NODES_COUNT:uint = 37;
