package net.wg.gui.components.tooltips
{
    ...
    public class ToolTipMarkOfMastery extends ToolTipSpecial
    {
        ...
        override protected function redraw() : void
        {
            ...
            var _loc4_:String = "<img src=\"img://gui/maps/icons/library/proficiency/class_icons_" + _loc1_.localizedValue + ".png\" WIDTH=\"32\" HEIGHT=\"32\" VSPACE=\"-10\"/>&nbsp;&nbsp;" + this.utils.htmlWrapper(_loc1_.name,this.utils.COLOR_HEADER,18,"$TitleFont",false);
            ...
            _loc9_ = "<br/><br/>" + Utils.instance.htmlWrapper(_loc9_,Utils.instance.COLOR_NORMAL,14,"$TitleFont",true);
            ...
            while(_loc11_ > 0)
            {
                ...
                _loc10_.leftText = _loc10_.leftText + (this.utils.htmlWrapper(_loc13_,this.utils.COLOR_NUMBER,11,"$TextFont",false) + "<br>");
