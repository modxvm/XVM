package net.wg.gui.components.controls.events
{
   ...
   public class RangeSliderEvent extends SliderEvent
   {
      ...
      public function RangeSliderEvent(param1:String, param2:Boolean=false, param3:Boolean=true, param4:Number=undefined, param5:Number=undefined, param6:Number=undefined) {
