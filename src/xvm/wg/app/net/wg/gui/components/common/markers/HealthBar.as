package net.wg.gui.components.common.markers
{
    ...
    public class HealthBar extends UIComponent
    {
        ...
        private static var ORIGINAL_SPLASH_WIDTH:Number = 26;
        
        private static var HEALTH_BAR_WIDTH:Number = 70;
        
        private static var INVALIDATE_COLOR:String = "invalidateColor";
        
        private static var INVALIDATE_BAR:String = "invalidateBar";
