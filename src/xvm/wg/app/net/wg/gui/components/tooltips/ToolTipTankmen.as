    ...
    public class ToolTipTankmen extends ToolTipSpecial
    {
        ...
        override protected function redraw() : void
        {
            ...
            if(this.dataVO.params)
            {
                ...
                _loc8_.rightTextCSS.setStyle("h1",{"color":Utils.instance.COLOR_NORMAL,
                "fontSize":"11px",
                "fontFamily":"$TextFont",
                "leading":"2px"
            });
            _loc8_.rightTextCSS.setStyle("h2",{"color":Utils.instance.COLOR_ALERT,
            "fontSize":"11px",
            "fontFamily":"$TextFont",
            "leading":"2px"
        });
        _loc8_.rightTextCSS.setStyle("p",{"color":Utils.instance.COLOR_ALERT,
        "fontSize":"11px",
        "fontFamily":"$TextFont",
        "leading":"2px"
    });
