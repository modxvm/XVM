package net.wg.gui.components.common.markers
{
    ...
    public class VehicleMarker extends UIComponent
    {
        ...
        public static var s_markerSettings:Object = {"ally":new VehicleMarkerSettings(),
    ...
    public static var STATE_HIT_PIERCED:String = "hit_pierced";
    
    public static var STATE_HIT:String = "hit";
    
    public static var STATE_DEAD:String = "dead";
    
    public static var STATE_IMMEDIATE_DEAD:String = "immediate_dead";
    
    private static var ICON_HORIZONTAL_OFFSET:Number = 6;
    
    private static var HP_FIELD_VERTICAL_OFFSET:Number = -3;
    
    private static var EXPLOSION_HORIZONTAL_OFFSET:Number = 15;
    
    private static var VEHICLE_DESTROY_COLOR:Number = 6710886;
