package net.wg.gui.components.common.ticker
{
    ...
    public class Ticker extends TickerMeta implements ITickerMeta
    {
        ...
        public static var STATE_HANGAR:String = "hangar";
        
        public static var STATE_BATTLE:String = "battle";
        
        private static var INVALID_ITEMS:String = "invalidItems";
        
        private static var ITEMS_GAP:Number = 100;
        
        private static var HIDE_SHOW_SPEED:Number = 500;
        
        private static var UPDATE_INTERVAL:Number = 50;
