package net.wg.gui.components.carousels
{
    ...
    public class CarouselBase extends CoreList implements IDraggable
    {
        ...
        private static var SHOW_EMPTY_ITEMS:Boolean = false;
        
        public static var INIT_CAROUSEL:String = "initCarousel";
        
        private static var DRAG_ENABLE:Boolean = true;
        
        private static var DRAG_ACCELERATOR:Number = 3;
        
        private static var SLIDE_SELF_ACCELERATOR:Number = 7;
        
        private static var SLIDE_TO_POS_ACCELERATOR:Number = 7;
        
        private static var MAX_DRAG_OFFSET:Number = 100;
        
        private static var MAX_DX:Number = 30;
        
        private static var ARROW_LEFT:String = "left";
        
        private static var ARROW_RIGHT:String = "right";
