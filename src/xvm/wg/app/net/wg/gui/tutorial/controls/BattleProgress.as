package net.wg.gui.tutorial.controls
{
    ...
    public class BattleProgress extends UIComponent
    {
        ...
        private static var PHASE_DONE:String = "done";
        
        private static var PHASE_FAIL:String = "fail";
        
        private static var PHASE_NONE:String = "none";
        
        private static var MASK:uint = 3;
        
        private static var BODY_WIDTH_CORRECTION:Number = 8;
