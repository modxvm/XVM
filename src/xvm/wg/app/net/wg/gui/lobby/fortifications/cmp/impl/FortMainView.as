package net.wg.gui.lobby.fortifications.cmp.impl
{
   ...
   public class FortMainView extends FortMainViewMeta implements IFortMainView
   {
      ...
      private static const CHAT_HEIGHT:Number = 33;
      ...
      public function as_toggleCommanderHelp(param1:Boolean) : void {
         if(param1)
         {
            App.utils.asserter.assertNull(this.commanderHelpView,"toggleCommanderHelp already showed");
         ...
         {
            App.utils.asserter.assertNotNull(this.commanderHelpView,"toggleCommanderHelp not showed, can`t be hidden.");
      ...
      private function onLeaveButtonClickHandler(param1:ButtonEvent) : void {
         ...
         {
            if(_loc2_ == FORTIFICATION_ALIASES.MODE_DIRECTIONS)
            {
