package net.wg.gui.lobby.techtree.data.vo
{
   ...
   public class UnlockProps extends Object implements IValueObject
   {
      ...
      public function UnlockProps(param1:Number=undefined, param2:Number=undefined, param3:Number=undefined, param4:Array=null, param5:Object=null) {
         super();
      ...
      public function fromArray(param1:Array, param2:ILocale) : void {
         if(param1.length > 3)
         {
            ...
            this._actionPriceDataVo = param1[3]?new ActionPriceVO(param1[3]):null;
