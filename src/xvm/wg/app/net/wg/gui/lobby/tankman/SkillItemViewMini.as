package net.wg.gui.lobby.tankman
{
    ...
    public class SkillItemViewMini extends UIComponent
    {
        ...
        public static var TYPE_SKILL:String = "skill";
        
        public static var TYPE_NEW_SKILL:String = "new_skill";
        
        public static var TYPE_SKILLS:String = "skills";
        
        public static var TYPE_NEW_SKILLS:String = "new_skills";
        
        public static var TYPE_CURRENT_SKILL:String = "current_skill";
        
        public static var TYPE_CURRENT_NEW_SKILL:String = "current_new_skill";
        
        public static var LEVEL_POSTFIX:String = "%";
        
        public static var COUNT_POSTFIX:String = " x 100%";
