package net.wg.gui.lobby.hangar.maintenance
{
    ...
    public class TechnicalMaintenance extends TechnicalMaintenanceMeta implements ITechnicalMaintenanceMeta
    {
        ...
        private static var PERCENT_CHAR:String = "%";
        
        private static var SPLITTER_CHAR:String = "/";
        
        private static var MONEY:String = "money";
        
        private static var EQUIPMENT:String = "equipment";
        
        private static var EQUIPMENT_CHANGED:String = "equipmentChanged";
