package net.wg.gui.lobby.window
{
    ...
    public class ProfileWindow extends ProfileWindowMeta implements IProfileWindowMeta
    {
        ...
        public static var INIT_DATA_INV:String = "initDataInv";
        
        public static var ADDFRIENDAVAILABLE:String = "addAvailableChanged";
        
        public static var SETIGNOREDAVAILABLE:String = "setIgnoreChanged";
        
        public static var CREATEPRIVATECHANNELAVAILABLE:String = "createChannelChanged";
