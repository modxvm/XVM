package net.wg.gui.lobby.fortifications.intelligence.impl
{
    ...
    public class FortIntelligenceWindow extends FortIntelligenceWindowMeta implements IFortIntelligenceWindowMeta
    {
        ...
        private function initTable() : void
        {
            ...
            _loc1_.buttonWidth = 120;
            _loc1_.iconId = "avgBuildingLvl";
            _loc1_.sortOrder = 3;
            _loc2_.push(_loc1_);
            _loc1_ = new NormalSortingBtnInfo();
            _loc1_.label = FORTIFICATIONS.FORTINTELLIGENCE_SORTBTNS_AVAILABILITY;
            _loc1_.toolTip = TOOLTIPS.FORTIFICATION_INTELLIGENCEWINDOW_SORTBTN_AVAILABILITY;
            _loc1_.buttonWidth = 150;
            _loc1_.iconId = "availabilityDays";
            _loc1_.sortOrder = 4;
            _loc2_.push(_loc1_);
