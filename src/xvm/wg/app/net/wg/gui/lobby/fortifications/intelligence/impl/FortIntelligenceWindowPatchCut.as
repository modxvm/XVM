...
{
    import net.wg.infrastructure.base.meta.impl.FortIntelligenceWindowPatchCutMeta;
    import net.wg.infrastructure.base.meta.IFortIntelligenceWindowPatchCutMeta;
    import flash.text.TextField;
    import scaleform.clik.constants.InvalidationType;
    import scaleform.gfx.TextFieldEx;
    
    public class FortIntelligenceWindowPatchCut extends FortIntelligenceWindowPatchCutMeta implements IFortIntelligenceWindowPatchCutMeta
    {
        
        public function FortIntelligenceWindowPatchCut()
        {
            super();
            isModal = false;
            isCentered = true;
