package net.wg.gui.lobby.fortifications.cmp.impl
{
   ...
   public class FortWelcomeView extends FortWelcomeViewMeta implements IFortWelcomeView
   {
      ...
      private static const RIGHT_ALIGN_FACTOR:Number = 0.6666666666666666;

      private static const CREATE_BUTTON_BG_OFFSET_X:uint = 58;

      private static const CREATE_BUTTON_BG_OFFSET_Y:uint = 85;

      private static const MIN_APP_HGHT_FOR_TEXT_V_ALIGN:uint = 768;

      private static const V_ALIGN_THRESHOLD:uint = 5;

      private static const TEXT_V_ALIGN_START_POSITION_Y:uint = 93;

      private static const WARNING_OFFSET_Y:uint = 8;

      private static const REQUIREMENT_TEXT_OFFSET_Y:int = 12;
      ...
      public var createButtonBg:MovieClip = null;
      ...
      override protected function draw() : void {
         ...
         {
            this.createFortBtn.visible = this.createButtonBg.visible = this._data.canRoleCreateFort();
            ...
            this.warningText.visible = !this.createFortBtn.enabled;
         }
      }
      ...
      private function updateControlPositions() : void {
         ...
         this.createFortBtn.y = this.detail.y + this.detail.height;
         this.createButtonBg.x = this.createFortBtn.x - CREATE_BUTTON_BG_OFFSET_X;
         this.createButtonBg.y = this.createFortBtn.y - CREATE_BUTTON_BG_OFFSET_Y;
         this.createClanText.x = this.searchClanText.x + this.searchClanText.width;
