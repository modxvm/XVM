package net.wg.gui.lobby.hangar.ammunitionPanel
{
    ...
    public class FittingListItemRenderer extends SoundListItemRenderer
    {
        ...
        private static var DESTROY_IMG:String = "destroy.png";
        
        private static var REMOVE_IMG:String = "remove.png";
        
        private static var REMOVE_GOLD_IMG:String = "removeGold.png";
        
        private static var SHOP_STATE:String = "shop";
        
        private static var HANGAR_STATE:String = "hangar";
        
        private static var HANGAR_CANT_INSTALL_STATE:String = "hangarCantInstall";
        
        private static var VEHICLE_STATE:String = "vehicle";
