package net.wg.gui.lobby.hangar.maintenance
{
    ...
    public class EquipmentItem extends SoundButtonEx implements IResettable
    {
        ...
        private static var MODULE_INFO:String = "moduleInfo";
        
        private static var CANCEL_BUY:String = "cancelBuy";
        
        private static var UNLOAD:String = "unload";
        
        private static var SLOTS_MIN_COUNT:int = 9;
        
        private static var EMPTY_ICON:String = "../maps/icons/artefact/empty.png";
        
        private static var MULTY_CHARS:String = " x ";
        
        private static var TO_BUY_POS:int = 775;
        ...
        public function setData(param1:Array, param2:int, param3:Array, param4:Array, param5:Number, param6:Number) : void
        {
            ...
            while(_loc9_ < _loc10_)
            {
                ...
                _loc8_.userCredits = {"credits":param5,
                "gold":param6
            };
