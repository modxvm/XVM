package net.wg.gui.lobby.fortifications.data
{
    ...
    public class FortBuildingConstants extends Object
    {
        ...
        public static var WAR_SCHOOL_BUILDING:String = "warSchool_building";
        
        public static var TROPHY_BUILDING:String = "trophy_building";
        
        public static var TRAINING_BUILDING:String = "training_building";
        
        public static var TANKODROM_BUILDING:String = "tankodrom_building";
        
        public static var INTENDANCY_BUILDING:String = "intendancy_building";
        
        public static var FINANCE_BUILDING:String = "finance_building";
        
        public static var CAR_BUILDING:String = "car_building";
