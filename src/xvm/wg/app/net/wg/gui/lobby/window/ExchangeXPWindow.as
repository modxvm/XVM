package net.wg.gui.lobby.window
{
    ...
    public class ExchangeXPWindow extends BaseExchangeWindow implements IExchangeXpWindowMeta
    {
        ...
        private static var VEHICLES_DATA_INVALID:String = "listInv";
        
        private static var TOTAL_AVAILABLE_XP_INVALID:String = "totalAvailXP";
        
        private static var TOTAL_RESULT_INVALID:String = "resAll";
