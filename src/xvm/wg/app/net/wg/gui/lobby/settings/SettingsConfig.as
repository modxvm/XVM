package net.wg.gui.lobby.settings
{
    ...
    public class SettingsConfig extends Object
    {
        ...
        public static var tabsDataProvider:Array = [{"label":SETTINGS.GAMETITLE,
...
public static var markerTabsDataProvider:Array = [{"label":"#settings:marker/EnemyTitle",
"linkage":null,
"id":"enemy",
"formID":"enemyForm",
...
public static var cursorTabsDataProvider:Array = [{"label":"#settings:cursor/ArcadeTitle",
"linkage":null,
"id":"arcade",
"formID":"arcadeForm",
...
public static var settingsData:Object = {"GameSettings":{"enableOlFilter":new SettingsControlProp(null,null,TYPE_CHECKBOX),
...
"ControlsSettings":{"keysLayoutOrder":null,
"keyboard":null,
...
"AimSettings":{"arcade":{"netType":new SettingsControlProp(null,null,TYPE_DROPDOWN),
...
"sniper":{"netType":new SettingsControlProp(null,null,TYPE_DROPDOWN),
"net":new SettingsControlProp(null,null,TYPE_SLIDER,true,true),
"centralTagType":new SettingsControlProp(null,null,TYPE_DROPDOWN),
"centralTag":new SettingsControlProp(null,null,TYPE_SLIDER,true,true),
"reloader":new SettingsControlProp(null,null,TYPE_SLIDER,true,true),
...
"MarkerSettings":{"enemy":{"markerBaseIcon":new SettingsControlProp(null,null,TYPE_CHECKBOX),
...
"ally":{"markerBaseIcon":new SettingsControlProp(null,null,TYPE_CHECKBOX),
"markerBaseDamage":new SettingsControlProp(null,null,TYPE_CHECKBOX),
"markerAltIcon":new SettingsControlProp(null,null,TYPE_CHECKBOX),
"markerAltDamage":new SettingsControlProp(null,null,TYPE_CHECKBOX),
"markerBaseVehicleName":new SettingsControlProp(null,null,TYPE_CHECKBOX),
...
"dead":{"markerBaseIcon":new SettingsControlProp(null,null,TYPE_CHECKBOX),
"markerBaseDamage":new SettingsControlProp(null,null,TYPE_CHECKBOX),
"markerAltIcon":new SettingsControlProp(null,null,TYPE_CHECKBOX),
"markerAltDamage":new SettingsControlProp(null,null,TYPE_CHECKBOX),
"markerBaseVehicleName":new SettingsControlProp(null,null,TYPE_CHECKBOX),
...
"OtherSettings":{"vibroIsConnected":new SettingsControlProp(null,null,TYPE_CHECKBOX,false,false,null,true),
...
public static var liveUpdateVideoSettingsData:Object = {"monitor":null,
"fullScreen":null,
"windowSize":null,
"resolution":null,
"refreshRate":null,
...
_loc1_.push({"label":SETTINGS.OTHERTITLE,
