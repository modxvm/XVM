      ...
      override protected function draw() : void {
         ...
         if((isInvalid(InvalidationType.DATA)) && (this.model))
         {
            ...
            if(this.model.selectorsData)
            {
               ...
               while(_loc2_ < _loc1_)
               {
                  ChoiceDivisionSelector(this.selectors[_loc2_]).setData(this.model.selectorsData[_loc2_]);
                  ChoiceDivisionSelector(this.selectors[_loc2_]).groupName = "divisionGroup";
                  ChoiceDivisionSelector(this.selectors[_loc2_]).allowDeselect = false;
                  ChoiceDivisionSelector(this.selectors[_loc2_]).addEventListener(MouseEvent.DOUBLE_CLICK,this.doubleClickHandler);
