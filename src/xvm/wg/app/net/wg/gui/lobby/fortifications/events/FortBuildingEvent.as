package net.wg.gui.lobby.fortifications.events
{
   ...
   public class FortBuildingEvent extends Event
   {
      ...
      public static const FIRST_TRANSPORTING_STEP:String = EVENT_LOG_CONSTANTS.EVENT_TYPE_STEP_1;

      public static const NEXT_TRANSPORTING_STEP:String = EVENT_LOG_CONSTANTS.EVENT_TYPE_STEP_2;
