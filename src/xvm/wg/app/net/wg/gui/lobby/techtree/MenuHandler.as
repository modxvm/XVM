package net.wg.gui.lobby.techtree
{
    ...
    public class MenuHandler extends Object
    {
        ...
        {
            var _loc2_:Vector.<IContextItem> = Vector.<IContextItem>([]);
            _loc2_.push(new ContextItem(ActionName.VEHICLE_INFO,MENU.CONTEXTMENU_VEHICLEINFOEX));
            _loc2_.push(new ContextItem(ActionName.SHOW_VEHICLE_STATS,MENU.CONTEXTMENU_SHOWVEHICLESTATISTICS,{"enabled":param1.isWasInBattle()}));
            _loc2_.push(new SeparateItem());
            _loc2_.push(new ContextItem(ActionName.UNLOCK,MENU.CONTEXTMENU_UNLOCK,{"enabled":!param1.isPremium() && param1.isAvailable4Unlock()}));
            if(!param1.isPremiumIGR())
            {
                _loc2_.push(new ContextItem(ActionName.BUY,MENU.CONTEXTMENU_BUY,{"enabled":param1.isAvailable4Buy()}));
            }
            _loc2_.push(new ContextItem(ActionName.SELL,param1.isRemovable()?MENU.CONTEXTMENU_VEHICLEREMOVE:MENU.CONTEXTMENU_SELL,{"enabled":param1.isAvailable4Sell()}));
            _loc2_.push(new SeparateItem());
            _loc2_.push(new ContextItem(ActionName.SELECT_VEHICLE,MENU.CONTEXTMENU_SELECTVEHICLEINHANGAR,{"enabled":param1.inInventory() && param1.isVehicleCanBeChanged()}));
