package net.wg.gui.rally.views.room
{
    ...
    public class ChatSectionWithDescription extends BaseChatSection implements IChatSectionWithDescription
    {
        ...
        override protected function draw() : void
        {
            ...
            {
                _loc2_ = _rallyData?_rallyData.isCommander:false;
                this.editDescriptionButton.visible = (_loc2_) && !_inEditMode;
                this.editCommitButton.visible = (_loc2_) && (_inEditMode);
                this.descriptionInput.visible = this.descriptionInput.editable = (_loc2_) && (_inEditMode);
        ...
        private function onEditClick(param1:ButtonEvent) : void
        {
            _inEditMode = true;
            invalidate(INVALID_EDIT_MODE);
            App.utils.scheduler.envokeInNextFrame(updateFocus);
        }
        ...
        {
            if(param1.details.code == Keyboard.ESCAPE && param1.details.value == InputValue.KEY_DOWN && (_inEditMode))
            {
