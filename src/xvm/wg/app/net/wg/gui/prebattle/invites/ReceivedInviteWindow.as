package net.wg.gui.prebattle.invites
{
    ...
    public class ReceivedInviteWindow extends ReceivedInviteWindowMeta implements IReceivedInviteWindowMeta
    {
        ...
        private static var UPDATE_DATA:String = "updateData";
        
        private static var SIMPLE_INVITE_LABEL:String = "simple";
        
        private static var INVITE_WITH_NOTE_LABEL:String = "withNote";
