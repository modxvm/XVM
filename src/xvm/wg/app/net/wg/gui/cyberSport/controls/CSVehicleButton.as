package net.wg.gui.cyberSport.controls
{
    ...
    public class CSVehicleButton extends SoundButtonEx implements IVehicleButton
    {
        ...
        public static var CHOOSE_VEHICLE:int = 1;
        
        public static var COUNT_VEHICLE:int = 2;
        
        public static var DEFAULT_STATE:int = 3;
        
        public static var RANGE_ROSTER:int = 4;
        
        public static var ROSTER_SETTINGS:int = 5;
        
        private static var UPDATE_INIT_DATA:String = "updateInitDFata";
