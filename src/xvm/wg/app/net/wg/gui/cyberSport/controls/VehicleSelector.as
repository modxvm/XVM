package net.wg.gui.cyberSport.controls
{
    ...
    public class VehicleSelector extends UIComponent implements IViewStackContent
    {
        ...
        private static var INVALID_SELECTION_MODE:String = "invalidSelectionMode";
        
        private static var INVALID_FILTERS_MODE:String = "invalidFiltersMode";
