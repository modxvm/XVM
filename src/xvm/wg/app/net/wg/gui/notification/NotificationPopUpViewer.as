package net.wg.gui.notification
{
    ...
    public class NotificationPopUpViewer extends NotificationPopUpViewerMeta implements INotificationPopUpViewerMeta
    {
        ...
        {
            this.layoutInfo = new LayoutInfoVO({"paddingRight":0,
            "paddingBottom":0
        });
    ...
    private var TWEEN_DURATION:uint = 500;
    ...
    override protected function draw() : void
    {
        ...
        if((this.arrangeLayout) && (this.stageDimensions))
        {
            ...
            while(_loc9_ < _loc8_)
            {
                ...
                this.animationManager.registerAndLaunch(this.TWEEN_DURATION,_loc6_,{"y":_loc11_,
                "alpha":1,
