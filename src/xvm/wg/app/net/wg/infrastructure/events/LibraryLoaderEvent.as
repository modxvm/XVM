package net.wg.infrastructure.events
{
    ...
    public class LibraryLoaderEvent extends Event
    {
        ...
        public static var LOADED:String = "libLoaded";
        
        public static var ICON_LOADED:String = "iconLoaded";
        
        public static var ICON_LOADING_FAILED:String = "iconLoadingFailed";
