package net.wg.infrastructure.events
{
    ...
    public class DropEvent extends Event
    {
        ...
        public static var BEFORE_DROP:String = "onBeforeDrop";
        
        public static var AFTER_DROP:String = "onAfterDrop";
        
        public static var START_DROP:String = "onStartDrop";
        
        public static var END_DROP:String = "onEndDrop";
