package net.wg.infrastructure.managers.utils.impl
{
    ...
    public class TweenManagerHelper extends Object implements ITweenManagerHelper
    {
        ...
        public function TweenManagerHelper(param1:TweenConstraintsVO)
        {
            super();
            this.data = param1;
            this.durationByType = new <Object>[{"types":TweenTypes.FADE_TYPES,
...
private static var NOT_INIT:String = "Initialize TweenManagerHelper before using.";
