package 
{
   ...
   public class INVITES extends Object
   {
      ...
      public static const INVITES_TEXT_ENUM:Array = [INVITES_TEXT_SQUAD,INVITES_TEXT_COMPANY,INVITES_TEXT_TRAINING,INVITES_TEXT_UNIT,INVITES_TEXT_SORTIE];
      ...
      public static const INVITES_NOTE_LEAVE_ENUM:Array = [INVITES_NOTE_LEAVE_COMPANY,INVITES_NOTE_LEAVE_SQUAD,INVITES_NOTE_LEAVE_TRAINING,INVITES_NOTE_LEAVE_UNIT,INVITES_NOTE_LEAVE_CLAN,INVITES_NOTE_LEAVE_TOURNAMENT,INVITES_NOTE_LEAVE_HISTORICAL,INVITES_NOTE_LEAVE_SORTIE];
