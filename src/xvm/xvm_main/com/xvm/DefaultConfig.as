...
package com.xvm
{
    ...
    internal class DefaultConfig
    {
        ...
        private static function getTooltipsSection():CTooltips
        {
        ...
        private static function getHangarSection():CHangar
        {
            ...
            c.xwnInCompany = true;
            c.enableGoldLocker = false;
            c.enableFreeXpLocker = false;
            c.defaultBoughtForCredits = false;
            c.hidePricesInTechTree = false;
            c.masteryMarkInTechTree = true;
            c.allowExchangeXPInTechTree = true;
            c.enableCrewAutoReturn = true;
        ...
        private static function getBattleSection():CBattle
        {
            ...
            c.sixthSenseIcon = "xvm://res/SixthSense.png";
        ...
        private static function getHotkeysSection():CHotkeys
        {
            ...
            c.markersAltMode = { enabled: true, onHold: true };
            /*
            c.messages: [
        ...
        private static function getBattleLoadingSection():CBattleLoading
        {
            ...
            c.formatLeftNick = "<img src='xvm://res/icons/lang/{{region|CT}}/{{language|default}}.png' width='16' height='13'> <img src='xvm://res/icons/xvm/xvm-user-{{xvm-user}}.png'> {{name%.15s~..}} <font alpha='#A0'>{{clan}}</font>";
            c.formatRightNick = "<font alpha='#A0'>{{clan}}</font> {{name%.15s~..}} <img src='xvm://res/icons/xvm/xvm-user-{{xvm-user}}.png'> <img src='xvm://res/icons/lang/{{region|CT}}/{{language|default}}.png' width='16' height='13'>";
        ...
        private static function getMinimapSection():CMinimap
        {
            ...
            c.labels.units.antiAliasType = "advanced";
        ...
        private static function getHitlogSection():CHitlog
        {
            ...
            c.formatHeader =  "<font color='#FFFFFF'>{{l10n:Hits}}:</font> <font size='13'>#{{n}}</font> <font color='#FFFFFF'>{{l10n:Total}}: </font><b>{{dmg-total}}</b>  <font color='#FFFFFF'>{{l10n:Last}}:</font> <font color='{{c:dmg-kind}}'><b>{{dmg}}</b></font> <font face='xvm' size='21'>{{dead=&#x77;?&#x29;|{{dead=&#x78;?&#x28;}}}}</font>";
            c.formatHistory = "<textformat leading='-4' tabstops='[20,50,90,190]'><font size='12'>\u00D7{{n-player}}:</font><tab><font color='{{c:dmg-kind}}'>{{dmg}}</font><tab>| {{dmg-player}}<tab>|<font color='{{c:vtype}}'>{{vehicle}}</font> <font face='xvm' size='19' color='#FF0000'>{{dead}}</font><tab><font color='#FFFFFF'>|{{name%.15s~..}} <font alpha='#A0'>{{clan}}</font></font></textformat>";
            c.shadow = {
              alpha: 100,
              color: "0x000000",
              angle: 45,
            ...
            c.ally = {
                alive: {
                    ...
                    extended: {
                        ...
                        levelIcon: li,
                        actionMarker: am,
                        textFields: [ playerName_alive, healthRatio, winrateText ]
                    }
                },
                dead: {
                    normal: {
        ...
        private static function getColorsSection():CColors
        {
            ...
            c.hp = [
                { value: 201,  color: XfwConst.C_REDBRIGHT },
                { value: 401,  color: XfwConst.C_REDSMOOTH },
                { value: 1001, color: XfwConst.C_ORANGE },
                { value: 9999, color: XfwConst.C_WHITE }
            ];
            c.hp_ratio = [
                { value: 10,  color: XfwConst.C_REDBRIGHT },
                { value: 25,  color: XfwConst.C_REDSMOOTH },
                { value: 50,  color: XfwConst.C_ORANGE },
                { value: 101, color: XfwConst.C_WHITE }
            ];
            ...
            c.winChance = [
                { value: 24.5,  color: XfwConst.C_RED },
                { value: 39.5,  color: XfwConst.C_ORANGE },
                { value: 59.5,  color: XfwConst.C_YELLOW },
                { value: 74.5,  color: XfwConst.C_GREEN },
                { value: 89.5,  color: XfwConst.C_BLUE },
                { value: 101,   color: XfwConst.C_PURPLE }
            ];
            c.winrate = [
            ...
            c.kb = [
                ...
                { value: 16,  color: XfwConst.C_YELLOW },
                { value: 30,  color: XfwConst.C_GREEN },
                { value: 43,  color: XfwConst.C_BLUE },
                { value: 999, color: XfwConst.C_PURPLE }
            ];
            c.avglvl = [
                { value: 2,  color: XfwConst.C_RED },
                { value: 3,  color: XfwConst.C_ORANGE },
                { value: 5,  color: XfwConst.C_YELLOW },
                { value: 7,  color: XfwConst.C_GREEN },
                { value: 9,  color: XfwConst.C_BLUE },
                { value: 11, color: XfwConst.C_PURPLE }
            ];
            c.t_battles = [
                { value: 100,   color: XfwConst.C_RED },
                { value: 250,   color: XfwConst.C_ORANGE },
                { value: 500,   color: XfwConst.C_YELLOW },
                { value: 1000,  color: XfwConst.C_GREEN },
                { value: 1800,  color: XfwConst.C_BLUE },
                { value: 99999, color: XfwConst.C_PURPLE }
            ];
            c.tdb = [
                { value: 500,  color: XfwConst.C_RED },
                { value: 750,  color: XfwConst.C_ORANGE },
                { value: 1000, color: XfwConst.C_YELLOW },
                { value: 1800, color: XfwConst.C_GREEN },
                { value: 2500, color: XfwConst.C_BLUE },
                { value: 9999, color: XfwConst.C_PURPLE }
            ];
            c.tdv = [
                { value: 0.6,  color: XfwConst.C_RED },
                { value: 0.8,  color: XfwConst.C_ORANGE },
                { value: 1.0,  color: XfwConst.C_YELLOW },
                { value: 1.3,  color: XfwConst.C_GREEN },
                { value: 2.0,  color: XfwConst.C_BLUE },
                { value: 15,   color: XfwConst.C_PURPLE }
            ];
            c.tfb = [
                { value: 0.6,  color: XfwConst.C_RED },
                { value: 0.8,  color: XfwConst.C_ORANGE },
            ...
            c.damageRating = [
                { value: 20,    color: XfwConst.C_RED },
                { value: 60,    color: XfwConst.C_ORANGE },
                { value: 90,    color: XfwConst.C_YELLOW },
                { value: 99,    color: XfwConst.C_GREEN },
                { value: 99.9,  color: XfwConst.C_BLUE },
                { value: 101,   color: XfwConst.C_PURPLE }
            ];
            c.hitsRatio = [
                { value: 47.5,  color: XfwConst.C_RED },
                { value: 60.5,  color: XfwConst.C_ORANGE },
                { value: 68.5,  color: XfwConst.C_YELLOW },
                { value: 74.5,  color: XfwConst.C_GREEN },
                { value: 78.5,  color: XfwConst.C_BLUE },
                { value: 101,   color: XfwConst.C_PURPLE }
            ];
            return c;
        }
        ...
        private static function getTextsSection():CTexts
        {
            ...
            c.battletype = new CTextsBattleType();
            c.battletype.unknown = "unknown";
            c.battletype.regular = "regular";
            c.battletype.training = "training";
            c.battletype.company = "company";
            c.battletype.tournament = "tournament";
            c.battletype.clan = "clan";
            c.battletype.tutorial = "tutorial";
            c.battletype.cybersport = "cybersport";
            c.battletype.historical = "historical";
            c.battletype.event_battles = "event_battles";
            c.battletype.sortie = "sortie";
            c.battletype.fort_battle = "fort_battle";
            c.battletype.rated_cybersport = "rated_cybersport";

            c.topclan = new CTextsTopClan();
            c.topclan.top = "top";
            c.topclan.persist = "persist";
            c.topclan.regular = "";
        ...
        private static function getExportSection():CExport
        {
            var c:CExport = new CExport();
            c.fps = { "enabled": false, "interval": 0.1, "outputDir": "replays" };
            return c;
        }
        ...
        // winrateText
        public static function get winrateText(): Object
        {
            return {
                name: "Win rate",
                visible: true,
