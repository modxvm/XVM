...
package com.xvm.lobby.ui.battleloading
{
    ...
    public /*dynamic*/ class UI_RightItemRendererTable extends RightItemRendererTableUI
    {
        private var proxy:BattleLoadingItemRendererProxy;

        public function UI_RightItemRendererTable()
        {
            try
            {
                super();
                proxy = new BattleLoadingItemRendererProxy(this, BattleLoadingItemRendererProxy.UI_TYPE_TABLE, false);
            }
            catch (ex:Error)
            {
                Logger.err(ex);
