            ...
            if (value != null)
            {
                if (Config.gameRegion == "RU")
                {
                    value.messageVO.message = Locale.get(value.messageVO.message)
                      ...
                      .split("#XVM_SITE_INACTIVE#")	.join('event:http://www.modxvm.com/%D1%81%D0%B5%D1%82%D0%B5%D0%B2%D1%8B%D0%B5-%D1%81%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D1%8B-%D0%BD%D0%B5%D0%B0%D0%BA%D1%82%D0%B8%D0%B2%D0%BD%D1%8B/#wot-main')
                ...
                else
                {
                    value.messageVO.message = Locale.get(value.messageVO.message)
                      ...
                      .split("#XVM_SITE_INACTIVE#")	.join('event:http://www.modxvm.com/en/network-services-inactive/#wot-main')
