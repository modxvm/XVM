    ...
    public class JSONxLoader
    {
        ...
        private function _Load():*
        {
            ...
            while (pendingFiles.length > 0)
            {
                ...
                {
                    Logger.add("LoadFile: " + filename
                        .replace(Defines.XVM_CONFIGS_DIR_NAME, '[cfg]/')
                        .replace(Defines.XVM_RESOURCES_DIR_NAME, '[res]/'));
                    var data:String = Xvm.cmd(Defines.XFW_COMMAND_LOADFILE, filename);
                    if (data == null)
        ...
        private function Deref(data:Object, level:int = 0, file:String = null, obj_path:String = null):Object
        {
            ...
            else
            {
                try
                {
                    ...
                    var value:* = Utils.getObjectValueByPath(obj_cache[fn], data.$ref.path);
                    if (value === undefined)
