...
build_as3_swf \
    ...
    -external-library-path+=../xfw/~output/swc/wg_battle_epicrandom_ui.swc \
    ...
    -output ../../~output/res_mods/mods/xfw_packages/xvm_battle/as_battle_epicrandom/xvm_battle_epicrandom.swf \
    $doc
