...
# USSR
    # Light
    'ussr:R11_MS-1':                          [ 14.99 , 11.29 , 3.70 , 1     ],
    'ussr:Tetrarch_LL':                       [ 15.67 , 11.74 , 4.00 , 1     ],
    'ussr:T-60':                              [ 17.45 , 13.05 , 4.45 , 1     ],
    'ussr:BT-2':                              [ 14.95 , 11.23 , 3.81 , 1.005 ],
    'ussr:T-26':                              [ 13.81 , 10.37 , 3.52 , 0.989 ],
    'ussr:M3_Stuart_LL':                      [ 15.22 , 15.22 , 4.57 , 1     ],
    'ussr:R56_T-127':                         [ 17.96 , 13.45 , 5.21 , 1     ],
    'ussr:BT-SV':                             [ 16.87 , 12.65 , 4.89 , 1     ],
    'ussr:R105_BT_7A':                        [ 15.68 , 11.75 , 4.08 , 1     ],
    'ussr:R03_BT-7':                          [ 16.53 , 16.53 , 4.96 , 1     ],
    'ussr:R86_LTP':                           [ 20.18 , 15.16 , 5.85 , 1     ],
    'ussr:R22_T-46':                          [ 16.12 , 12.08 , 4.45 , 0.972 ],
    'ussr:T-70':                              [ 17.61 , 13.18 , 4.86 , 0.936 ],
    'ussr:Valentine_LL':                      [ 17.95 , 17.95 , 5.21 , 1     ],
    'ussr:R12_A-20':                          [ 16.06 , 16.06 , 4.43 , 1.006 ],
    'ussr:R44_T80':                           [ 18.30 , 18.30 , 5.05 , 1     ],
    'ussr:T-50':                              [ 17.73 , 17.73 , 4.89 , 1     ],
    'ussr:MT25':                              [ 14.73 , 14.73 , 3.92 , 0.916 ],
    ...
    'ussr:R07_T-34-85':                       [ 13.97 , 10.49 , 3.32 , 1     ],    
    'ussr:R108_T34_85M':                      [ 14.08 , 10.55 , 3.52 , 1     ],
    'ussr:R117_T34_85_Rudy':                  [ 13.97 , 10.49 , 3.49 , 1     ],
    'ussr:A43':                               [ 12.14 ,  9.13 , 3.23 , 0.766 ],
    'ussr:R23_T-43':                          [ 14.71 , 11.07 , 3.50 , 0.981 ],
    'ussr:KV-13':                             [ 15.21 , 11.41 , 3.62 , 1.026 ],
    'ussr:A44':                               [ 12.54 ,  9.41 , 2.76 , 1     ],
    'ussr:T-44':                              [ 16.03 , 12.05 , 3.35 , 0.983 ],
    'ussr:Object416':                         [ 24.19 , 14.55 , 4.79 , 1.013 ],
    'ussr:R112_T54_45':                       [ 16.7  , 12.54 , 3.67 , 1     ],
    'ussr:T-54':                              [ 15.59 , 11.70 , 3.26 , 0.977 ],
    'ussr:R104_Object_430_II':                [ 16.59 , 12.42 , 2.56 , 0.977 ],
    'ussr:Object_907':                        [ 17.21 , 12.94 , 3.41 , 1     ],
    'ussr:Object_140':                        [ 16.15 , 12.09 , 3.20 , 1     ],
    'ussr:R96_Object_430':                    [ 17.84 , 13.39 , 3.53 , 1     ],
    'ussr:R87_T62A':                          [ 15.28 , 11.46 , 3.02 , 1     ],
    # Heavy
    'ussr:R38_KV-220_action':                 [  7.13 ,  3.59 , 1.85 , 1     ],
    'ussr:Churchill_LL':                      [  8.04 ,  4.05 , 2.25 , 1     ],
    'ussr:R80_KV1':                           [  7.30 ,  3.65 , 1.82 , 1     ],
    ...
    'ussr:R01_IS':                            [  7.92 ,  3.99 , 1.51 , 1     ],
    'ussr:R54_KV-5':                          [  3.08 ,  1.54 , 0.68 , 1     ],
    'ussr:R61_Object252':                     [  6.96 ,  3.48 , 1.32 , 1     ],
    'ussr:R113_Object_730':                   [  6.96 ,  3.48 , 1.32 , 1     ],
    #'ussr:R123_Kirovets_1':                   [ ],
    #'ussr:R127_T44_100_P':                    [ ],
    #'ussr-R128_KV4_Kreslavskiy':              [ ],
    'ussr:KV4':                               [  1.78 ,  0.89 , 0.37 , 0.433 ],
    'ussr:R19_IS-3':                          [  6.75 ,  3.37 , 1.21 , 0.97  ],
    'ussr:R81_IS8':                           [  6.07 ,  3.04 , 1.09 , 0.951 ],
    'ussr:ST_I':                              [  6.10 ,  3.08 , 1.10 , 0.915 ],
    'ussr:R110_Object_260':                   [  5.81 ,  2.91 , 1.05 , 1     ],
    'ussr:IS-7':                              [  6.61 ,  3.31 , 1.01 , 1     ],
    'ussr:R90_IS_4M':                         [  6.67 ,  3.36 , 1.20 , 1     ],
    # TD
    'ussr:AT-1':                              [ 21.21 , 12.71 , 5.05 , 1     ],
    'ussr:SU76I':                             [ 20.63 , 12.38 , 7.51 , 1     ],
    'ussr:R24_SU-76':                         [ 22.51 , 13.51 , 6.30 , 1     ],
    'ussr:R25_GAZ-74b':                       [ 22.63 , 13.57 , 5.39 , 1     ],
    'ussr:SU_85I':                            [ 20.41 , 12.26 , 7.14 , 1     ],
    'ussr:R02_SU-85':                         [ 22.29 , 13.39 , 5.30 , 1     ],
    'ussr:SU100Y':                            [  6.67 ,  3.99 , 1.53 , 1     ],
    'ussr:R17_SU-100':                        [ 22.06 , 13.22 , 4.19 , 1     ],
    ...
    #'ussr-R126_Object_730_5':                  [],
    'ussr:R75_SU122_54':                      [ 21.77 , 13.05 , 3.92 , 1     ],
    ...
    'ussr:R51_Object_212':                    [  3.48 ,  1.71 , 0.30 , 1     ],
    'ussr:Object_261':                        [  6.16 ,  3.08 , 0.70 , 1     ],
# Germany
    # Light
    'germany:Ltraktor':                       [ 13.43 , 10.07 , 3.43 , 1.052 ],
    'germany:H39_captured':                   [ 15.73 , 11.80 , 4.01 , 1     ],
    'germany:G108_PzKpfwII_AusfD':            [ 15.73 , 11.80 , 3.74 , 1     ],
    'germany:G06_PzII':                       [ 15.11 , 11.34 , 3.38 , 1     ],
    'germany:PzI':                            [ 16.16 , 12.12 , 3.85 , 0.971 ],
    ...
    'germany:G08_Pz38t':                      [ 17.99 , 13.51 , 5.22 , 1.035 ],
    ...
    'germany:PzIII_AusfJ':                    [ 16.34 , 12.27 , 4.51 , 1.006 ],
    'germany:G86_VK2001DB':                   [ 15.85 , 11.91 , 4.37 , 1     ],
    'germany:Pz_IV_AusfD':                    [ 14.82 , 11.11 , 3.66 , 1     ],
    'germany:PzIV_Hydro':                     [ 14.71 , 11.06 , 3.63 , 1     ],
    'germany:G46_T-25':                       [ 12.88 ,  9.63 , 3.35 , 1     ],
    ...
    'germany:VK3002DB_V1':                    [ 13.77 , 10.34 , 3.22 , 0.94  ],
    'germany:G27_VK3001P':                    [ 10.49 ,  7.85 , 2.50 , 1.102 ],
    'germany:VK3002M':                        [  9.58 ,  7.17 , 2.24 , 0.983 ],
    'germany:G78_Panther_M10':                [  9.23 ,  6.90 , 2.28 , 1     ],
    'germany:VK3002DB':                       [ 12.64 ,  9.49 , 3.01 , 0.92  ],
    'germany:PzV':                            [  9.15 ,  6.84 , 2.14 , 0.991 ],
    ...
    'germany:G16_PzVIB_Tiger_II':             [  4.27 ,  2.17 , 0.85 , 1     ],
    'germany:E-75':                           [  4.01 ,  2.00 , 0.61 , 0.976 ],
    'germany:VK4502P':                        [  4.78 ,  2.39 , 0.73 , 0.952 ],
    'germany:G92_VK7201':                     [  3.76 ,  1.88 , 0.51 , 1     ],
    'germany:E-100':                          [  2.91 ,  1.48 , 0.39 , 1     ],
    'germany:Maus':                           [  1.43 ,  0.68 , 0.23 , 1     ],
    # TD
    'germany:G21_PanzerJager_I':              [ 19.38 , 11.63 , 4.79 , 1     ],
    'germany:G20_Marder_II':                  [ 21.43 , 12.88 , 5.29 , 1     ],
    'germany:Hetzer':                         [ 24.00 , 14.42 , 5.02 , 1     ],
    'germany:G39_Marder_III':                 [ 19.27 , 11.57 , 4.76 , 1     ],
    'germany:G101_StuG_III':                  [ 23.14 , 13.91 , 4.84 , 1     ],
    'germany:G104_Stug_IV':                   [ 20.86 , 12.54 , 5.15 , 1     ],
    'germany:G05_StuG_40_AusfG':              [ 21.89 , 13.11 , 5.41 , 1     ],
    'germany:Pz_Sfl_IVc':                     [ 12.79 ,  7.66 , 3.04 , 1.034 ],
    'germany:DickerMax':                      [ 16.87 , 10.09 , 5.01 , 1     ],
    'germany:G17_JagdPzIV':                   [ 23.77 , 14.25 , 5.94 , 1     ],
    'germany:G40_Nashorn':                    [ 12.37 ,  7.41 , 2.78 , 1     ],
    'germany:G48_E-25':                       [ 25.14 , 15.05 , 8.82 , 1     ],
    'germany:JagdPanther':                    [ 13.11 ,  7.87 , 2.74 , 1     ],
    'germany:Sturer_Emil':                    [ 11.29 ,  6.78 , 1.73 , 1     ],
    'germany:G65_JagdTiger_SdKfz_185':        [ 10.66 ,  6.38 , 2.40 , 1     ],
    'germany:G112_KanonenJagdPanzer':         [ 23.60 , 14.14 , 5.62 , 1     ],
    'germany:G71_JagdPantherII':              [ 10.20 ,  6.10 , 1.65 , 1     ],
    'germany:Ferdinand':                      [ 10.89 ,  6.55 , 1.76 , 1     ],
    'germany:RhB_Waffentrager':               [ 22.51 , 13.51 , 3.44 , 1     ],
    'germany:G44_JagdTiger':                  [ 10.66 ,  6.38 , 1.73 , 1     ],
    'germany:Waffentrager_IV':                [ 15.67 ,  9.41 , 2.40 , 1     ],
    'germany:JagdPz_E100':                    [  3.02 ,  1.82 , 0.33 , 1     ],
    'germany:Waffentrager_E100':              [  0.40 ,  0.23 , 0.06 , 1     ],
    #'germany:G121_Grille_15_L63':             [ ],
    # SPG
    'germany:G93_GW_Mk_VIe':                  [ 16.13 ,  8.10 , 3.02 , 1     ],
    'germany:G19_Wespe':                      [ 16.19 ,  8.09 , 3.38 , 1     ],
    'germany:G11_Bison_I':                    [  8.83 ,  4.39 , 1.33 , 1     ],
    'germany:Pz_Sfl_IVb':                     [ 16.76 ,  8.38 , 3.50 , 1     ],
    'germany:G22_Sturmpanzer_II':             [ 17.33 ,  8.66 , 2.60 , 1     ],
    'germany:G23_Grille':                     [ 15.39 ,  7.70 , 2.31 , 1     ],
    'germany:G02_Hummel':                     [ 12.20 ,  6.10 , 1.74 , 1     ],
    'germany:G_Panther':                      [  3.76 ,  1.88 , 0.51 , 1     ],
    'germany:GW_Tiger_P':                     [  3.19 ,  1.60 , 0.27 , 1     ],
    'germany:G45_G_Tiger':                    [  4.90 ,  2.45 , 0.42 , 1     ],
    'germany:G_E':                            [  1.60 ,  0.80 , 0.14 , 1     ],
# USA
    # Light
    'usa:A01_T1_Cunningham':                  [ 12.76 ,  9.59 , 2.86 , 0.995 ],
    'usa:T2_lt':                              [ 14.99 , 11.29 , 3.36 , 1     ],
    'usa:T1_E6':                              [ 14.25 , 10.72 , 2.78 , 1     ],
    'usa:T7_Combat_Car':                      [ 13.51 , 10.09 , 3.22 , 1     ],
    'usa:A02_M2_lt':                          [ 13.56 , 10.20 , 3.46 , 0.908 ],
    'usa:MTLS-1G14':                          [ 12.54 ,  9.41 , 3.01 , 1     ],
    'usa:M22_Locust':                         [ 20.35 , 20.35 , 6.11 , 1     ],
    'usa:A03_M3_Stuart':                      [ 15.31 , 15.31 , 4.59 , 1.006 ],
    'usa:M5_Stuart':                          [ 16.19 , 16.19 , 3.88 , 1.044 ],
    'usa:M24_Chaffee':                        [ 15.68 , 15.68 , 3.87 , 1     ],
    'usa:T21':                                [ 15.28 , 15.28 , 3.77 , 1     ],
    'usa:A94_T37':                            [ 13.67 , 13.67 , 3.20 , 0.952 ],
    'usa:A103_T71E1':                         [ 14.08 , 14.08 , 3.29 , 1     ],
    #'usa:A112_T71E2':                         [ ],
    'usa:M41_Bulldog':                        [ 14.25 , 14.25 , 3.33 , 1     ],
    'usa:T49':                                [ 15.27 , 15.27 , 2.29 , 1.218 ],
    # Medium
    'usa:A24_T2_med':                         [ 10.26 ,  7.70 , 2.62 , 1     ],
    'usa:A25_M2_med':                         [ 12.22 ,  9.15 , 3.18 , 1.099 ],
    'usa:M3_Grant':                           [  7.87 ,  5.87 , 2.05 , 1     ],
    'usa:M4A2E4':                             [ 11.74 ,  8.78 , 3.05 , 1     ],
    'usa:Ram-II':                             [ 12.65 ,  9.52 , 3.54 , 1     ],
    'usa:A05_M4_Sherman':                     [ 12.57 ,  9.40 , 2.77 , 0.976 ],
    'usa:A23_M7_med':                         [ 14.71 , 11.06 , 4.12 , 1     ],
    'usa:A104_M4A3E8A':                       [ 11.34 ,  8.49 , 2.80 , 1     ],
    #'usa:A111_T25_Pilot':                     [ ],
    'usa:M4A3E8_Sherman':                     [ 12.25 ,  9.18 , 3.03 , 1     ],
    'usa:A36_Sherman_Jumbo':                  [ 11.51 ,  8.67 , 2.53 , 1     ],
    'usa:A86_T23E3':                          [ 14.42 , 10.83 , 3.75 , 1     ],
    'usa:A07_T20':                            [ 16.04 , 12.05 , 3.82 , 1.062 ],
    'usa:A80_T26_E4_SuperPershing':           [ 13.17 ,  9.86 , 2.96 , 1     ],
    ...
    'usa:A92_M60':                            [  6.95 ,  5.19 , 1.45 , 1     ],
    'usa:A84_M48A1':                          [  8.27 ,  6.21 , 1.73 , 1     ],
    # Heavy
    'usa:T14':                                [  7.75 ,  3.88 , 2.02 , 1     ],
    'usa:A09_T1_hvy':                         [  4.37 ,  2.19 , 1.14 , 0.959 ],
    ...
    'usa:A69_T110E5':                         [  4.56 ,  2.28 , 0.82 , 1     ],
    'usa:T57_58':                             [  4.90 ,  2.45 , 0.88 , 1     ],
    # TD
    'usa:A46_T3':                             [ 15.96 ,  9.58 , 3.53 , 1     ],
    'usa:A109_T56_GMC':                       [ 18.93 , 11.34 , 4.92 , 1     ],
    'usa:A29_T40':                            [ 20.98 , 12.60 , 5.45 , 1     ],
    'usa:M8A1':                               [ 21.49 , 12.89 , 5.72 , 0.979 ],
    'usa:A58_T67':                            [ 20.63 , 12.36 , 5.36 , 0.885 ],
    'usa:A30_M10_Wolverine':                  [ 17.79 , 10.66 , 4.39 , 1     ],
    ...
    'usa:A68_T28_Prototype':                  [ 12.60 ,  7.53 , 2.27 , 1     ],
    ...
    'usa:A18_M41':                            [ 16.19 ,  8.09 , 2.43 , 1     ],
    'usa:A87_M44':                            [  9.75 ,  4.90 , 1.46 , 1     ],
    'usa:M12':                                [ 11.69 ,  5.81 , 1.67 , 1     ],
    'usa:M40M43':                             [ 10.55 ,  5.30 , 0.91 , 1     ],
    'usa:A88_M53_55':                         [  6.10 ,  3.08 , 0.52 , 1     ],
...
# France
    ...
    'france:F73_M4A1_Revalorise':             [ 10.83 ,  8.15 , 2.14 , 1     ],
    'france:Lorraine40t':                     [ 11.63 ,  8.72 , 2.30 , 1     ],
    'france:F71_AMX_30_prototype':            [ 14.91 , 11.18 , 3.12 , 1.006 ],
    #'france:F75_Char_de_25t':                 [ ],
    'france:Bat_Chatillon25t':                [ 16.87 , 12.65 , 3.34 , 1     ],
    'france:F72_AMX_30':                      [ 15.28 , 11.46 , 3.19 , 1     ],
    # Heavy  vs. Machine guns =)
    'france:B1':                              [  7.46 ,  3.71 , 2.16 , 0.903 ],
    'france:BDR_G1B':                         [  6.28 ,  3.14 , 1.57 , 1.102 ],
    'france:F06_ARL_44':                      [  5.25 ,  2.62 , 1.18 , 2.421 ],
    'france:F07_AMX_M4_1945':                 [  6.22 ,  3.14 , 1.40 , 1.039 ],
    'france:F65_FCM_50t':                     [  4.33 ,  2.17 , 0.97 , 1     ],
    'france:F08_AMX_50_100':                  [  5.59 ,  2.62 , 1.11 , 1     ],
    'france:F09_AMX_50_120':                  [  4.73 ,  2.34 , 0.66 , 1     ],
...
# UK
    ...
    'uk:GB14_M2':                             [ 13.08 ,  9.84 , 3.34 , 0.918 ],
    'uk:GB69_Cruiser_Mk_II':                  [ 14.84 , 11.15 , 3.71 , 1.013 ],
    'uk:GB59_Cruiser_Mk_IV':                  [ 15.39 , 11.57 , 3.46 , 1     ],
    'uk:GB15_Stuart_I':                       [ 15.04 , 11.28 , 4.51 , 1.047 ],
    ...
    'uk:GB05_Vickers_Medium_Mk_II':           [  9.25 ,  6.98 , 2.20 , 1.02  ],
    ...
    'uk:GB23_Centurion':                      [ 10.99 ,  8.29 , 2.62 , 0.914 ],
    'uk:GB24_Centurion_Mk3':                  [ 11.51 ,  8.66 , 2.74 , 1     ],
    #'uk:GB35_Sentinel_AC_IV':                 [ ],
    'uk:GB70_FV4202_105':                     [ 13.74 , 10.32 , 2.87 , 1     ],
    'uk:GB86_Centurion_Action_X':             [ 12.03 ,  9.01 , 2.51 , 1     ],
    # Heavy
    ...
    'uk:GB41_Challenger':                     [ 13.38 ,  7.99 , 3.13 , 0.935 ],
    ...
    # SPG
    'uk:GB25_Loyd_Gun_Carriage':              [ 18.64 ,  9.35 , 4.12 , 1     ],
...
# China
    ...
    'china:Ch07_Vickers_MkE_Type_BT26':       [ 14.35 , 10.78 , 2.80 , 1.011 ],
    'china:Ch08_Type97_Chi_Ha':               [ 16.50 , 12.36 , 4.55 , 0.968 ],
...
# Japan
    ...
    'japan:J06_Ke_Ho':                        [ 19.21 , 19.21 , 5.11 , 1     ],
    # Medium
    'japan:J15_Chi_Ni':                       [ 15.96 , 11.97 , 3.80 , 1     ],
    'japan:J26_Type_89':                      [ 12.63 ,  9.49 , 3.01 , 1.003 ],
    'japan:J07_Chi_Ha':                       [ 16.50 , 12.36 , 4.79 , 0.968 ],
    'japan:J09_Chi_He':                       [ 15.37 , 11.56 , 4.00 , 0.943 ],
    'japan:J12_Chi_Nu_Kai':                   [ 13.85 , 10.37 , 3.60 , 1     ],
    'japan:J08_Chi_Nu':                       [ 13.98 , 10.48 , 3.63 , 0.973 ],
    'japan:Chi_To':                           [ 12.57 ,  9.44 , 3.10 , 1.016 ],
    'japan:Chi_Ri':                           [  9.95 ,  7.46 , 2.46 , 0.839 ],
...
# USSR
    ...
    '_20mm_TNSH':
        [
            [ ['ussr:BT-2', 'ussr:R11_MS-1', 'ussr:T-60'], 0.238 ]
        ],
    '_23mm_VJA':
        [
            [ ['ussr:R03_BT-7'], 0.280 ],
            [ ['ussr:BT-2', 'ussr:R11_MS-1', 'ussr:T-26'], 0.238 ]
        ],
    '_23mm_PT-23TB':
        [
            [ ['ussr:T-60'], 0.238 ]
    ...
    '_37mm_ZiS-19':
        [
            [ ['ussr:R12_A-20', 'ussr:R03_BT-7', 'ussr:R22_T-46', 'ussr:T-70'], 0.300 ],
    ...
    '_37mm_Gochkins':
        [
            [ ['ussr:BT-2', 'ussr:R11_MS-1'], 0.255 ]
        ],
    '_37mm_B-3':
        [
            [ ['ussr:BT-2', 'ussr:R11_MS-1', 'ussr:T-26'], 0.255 ]
        ],
    '_37mm_automatic_SH-37':
        [
            [ ['ussr:R12_A-20', 'ussr:MT25', 'ussr:R22_T-46', 'ussr:T-50', 'ussr:R44_T80'], 0.225 ]
        ],
    '_45mm_20K':
        [
            [ ['ussr:R12_A-20', 'ussr:R03_BT-7', 'ussr:MT25', 'ussr:R22_T-46', 'ussr:T-50', 'ussr:T-70', 'ussr:R44_T80'], 0.290 ],
    ...
    '_45mm_VT-42':
        [
            [ ['ussr:R12_A-20', 'ussr:R22_T-46', 'ussr:T-50', 'ussr:T-70', 'ussr:R44_T80'], 0.276 ]
        ],
    '_45mm_VT-43':
        [
            [ ['ussr:MT25', 'ussr:T-50', 'ussr:R44_T80'], 0.276 ]
        ],
    '_45mm_mod_1932':
        [
            [ ['ussr:R11_MS-1'], 0.247 ]
    ...
    '_57mm_ZiS-2':
        [
            [ ['ussr:R25_GAZ-74b', 'ussr:R24_SU-76'], 0.280 ]
        ],
    '_57mm_ZiS-8':
        [
            [ ['ussr:R06_T-28'], 0.280 ]
    ...
    '_57mm_ZiS-8_S':
        [
            [ ['ussr:R24_SU-76'], 0.280 ],
            [ ['ussr:AT-1'], 0.238 ]
        ],
    '_57mm_413':
        [
            [ ['ussr:R80_KV1', 'ussr:T150'], 0.266 ]
        ],
    '_57mm_ZiS-4':
        [
            [ ['ussr:A43', 'ussr:A44', 'ussr:MT25', 'ussr:R06_T-28', 'ussr:R04_T-34'], 0.266 ]
        ],
    '_76mm_L-10':
        [
            [ ['ussr:R06_T-28', 'ussr:R22_T-46'], 0.260 ]
        ],
    '_76mm_L-11':
        [
            [ ['ussr:R12_A-20', 'ussr:R04_T-34'], 0.260 ]
        ],
    '_76mm_KT-28':
        [
            [ ['ussr:R06_T-28'], 0.260 ]
    ...
    '_76mm_ZiS-5':
        [
            [ ['ussr:KV-13', 'ussr:KV-1s', 'ussr:R80_KV1', 'ussr:T150'], 0.260 ]
        ],
    ...
    '_76mm_S-54_S':
        [
            [ ['ussr:R02_SU-85'], 0.247 ]
        ],
    '_76mm_ZiS-3_mod_42':
        [
            [ ['ussr:R25_GAZ-74b', 'ussr:R24_SU-76'], 0.247 ]
        ],
    '_76mm_L-10_S':
        [
            [ ['ussr:AT-1'], 0.221 ]
    ...
    '_85mm_D-5S-85A':
        [
            [ ['ussr:R25_GAZ-74b'], 0.250 ]
        ],
    '_85mm_D-5S':
        [
            [ ['ussr:R17_SU-100', 'ussr:R02_SU-85'], 0.250 ]
        ],
    '_85mm_ZiS_S-53':
        [
            [ ['ussr:R23_T-43', 'ussr:T-44', 'ussr:R107_LTB'], 0.250 ]
        ],
    '_85mm_D-5T':
        [
            [ ['ussr:R01_IS', 'ussr:R106_KV85', 'ussr:KV-13'], 0.250 ]
        ],
    '_85mm_F-30':
        [
    ...
    '_85mm_D5T-85BM':
        [
            [ ['ussr:R01_IS', 'ussr:KV-13', 'ussr:R23_T-43', 'ussr:T-44', 'ussr:R107_LTB'], 0.238 ]
        ],
    '_85mm_D10_85':
        [
            [ ['ussr:R107_LTB'], 0.238 ]
    ...
    '_85mm_D5S-85BM':
        [
            [ ['ussr:R17_SU-100', 'ussr:R02_SU-85'], 0.238 ]
        ],
    '_85mm_LB-2S':
        [
            [ ['ussr:R25_GAZ-74b'], 0.238 ]
        ],
    '_100mm_D10T':
        [
            [ ['ussr:R19_IS-3', 'ussr:R01_IS', 'ussr:R39_KV-3', 'ussr:Object416', 'ussr:T-44'], 0.238 ],
    ...
    '_100mm_D54S':
        [
            [ ['ussr:SU-101', 'ussr:R75_SU122_54'], 0.154 ]
        ],
    '_107mm_ZiS-6':
        [
    ...
    '_122mm_M-30':
        [
            [ ['ussr:R100_SU122A'], 0.200 ]
        ],
    '_122mm_cannon_M-30S':
        [
            [ ['ussr:R02_SU-85'], 0.200 ]
        ],
    ...
    '_122mm_cannon_U-11':
        [
            [ ['ussr:KV-13', 'ussr:R80_KV1', 'ussr:KV2', 'ussr:R23_T-43', 'ussr:T150'], 0.200 ]
        ],
    '_122mm_S-41':
        [
            [ ['ussr:KV-1s'], 0.200 ]
    ...
    '_122-mm_D-25T_with_a_piston_shutter':
        [
            [ ['ussr:R19_IS-3', 'ussr:R01_IS', 'ussr:R106_KV85', 'ussr:R39_KV-3', 'ussr:KV4'], 0.190 ]
        ],
    '_122-mm_D-25S_with_a_piston_shutter':
        [
            [ ['ussr:R17_SU-100'], 0.190 ]
        ],
    '_122-mm_D-25T_with_wedges_shutter':
        [
            [ ['ussr:R19_IS-3', 'ussr:R90_IS_4M', 'ussr:R01_IS', 'ussr:R81_IS8', 'ussr:R39_KV-3', 'ussr:KV4', 'ussr:ST_I'], 0.190 ]
        ],
    ...
    '_122mm_BL-9':
        [
            [ ['ussr:R19_IS-3', 'ussr:R81_IS8', 'ussr:ST_I'], 0.180 ]
        ],
    '_122mm_M62-T2':
        [
            [ ['ussr:R90_IS_4M', 'ussr:R81_IS8', 'ussr:ST_I'], 0.180 ]
        ],
    '_152mm_M-10':
        [
            [ ['ussr:KV2'], 0.150 ]
    ...
    '_152mm_howitzer_D-1':
        [
            [ ['ussr:R100_SU122A'], 0.143 ]
        ],
    '_152mm_BR-2':
        [
            [ ['ussr:R51_Object_212', 'ussr:S-51', 'ussr:SU-14', 'ussr:SU14_1'], 0.143 ]
        ],
    '_152mm_BL-10':
        [
    ...
    '_203mm_B-4':
        [
            [ ['ussr:R51_Object_212', 'ussr:S-51', 'ussr:SU-14', 'ussr:SU14_1'], 0.086 ]
        ],
# Germany
    ...
    '_20mm_Flak_38_L112':
        [
            ...
            [ ['germany:G07_Pz35t', 'germany:G08_Pz38t', 'germany:G06_PzII'], 0.224 ]
        ],
    '_20mm_Breda':
        [
    ...
    '_20mm_KwK_30':
        [
            [ ['germany:G07_Pz35t', 'germany:PzI', 'germany:G06_PzII'], 0.238 ]
        ],
    '_30mm_MK103':
        [
    ...
    '_37mm_KwK_38t_L47':
        [
            [ ['germany:G52_Pz38_NA'], 0.300 ],
            [ ['germany:G07_Pz35t', 'germany:G08_Pz38t'], 0.255 ]
        ],
    '_37mm_KwK_L46':
        [
    ...
    '_37mm_KwK_34t_L40':
        [
            [ ['germany:G07_Pz35t'], 0.240 ]
        ],
    '_47mm_PaK_38t_L43':
        [
            [ ['germany:G08_Pz38t', 'germany:G52_Pz38_NA'], 0.290 ]
        ],
    '_50mm_KwK_38_L42':
        [
    ...
    '_50mm_KwK_39_L60':
        [
            [ ['germany:Auf_Panther', 'germany:DW_II', 'germany:PzIII_AusfJ', 'germany:Pz_IV_AusfD', 'germany:G86_VK2001DB', 'germany:VK2801', 'germany:G13_VK3001H'], 0.276 ],
    ...
    '_75mm_KwK41_L58_conic':
        [
            [ ['germany:Auf_Panther', 'germany:G13_VK3001H', 'germany:G15_VK3601H'], 0.260 ]
        ],
    '_75mm_KwK_37_L24':
        [
            [ ['germany:DW_II', 'germany:PzIII_AusfJ', 'germany:Pz_IV_AusfA', 'germany:Pz_IV_AusfD', 'germany:G86_VK2001DB', 'germany:VK2801', 'germany:G13_VK3001H'], 0.260 ]
        ],
    '_75mm_PaK_39_L48':
        [
            [ ['germany:Hetzer'], 0.260 ],
            [ ['germany:G17_JagdPzIV', 'germany:G101_StuG_III', 'germany:G05_StuG_40_AusfG'], 0.247 ]
        ],
    '_75mm_KwK_40_L48':
        [
            [ ['germany:Auf_Panther', 'germany:PzIII_IV', 'germany:Pz_IV_AusfH', 'germany:VK2801', 'germany:G13_VK3001H', 'germany:G27_VK3001P', 'germany:VK3002DB', 'germany:VK3002DB_V1', 'germany:VK3002M'], 0.247 ]
        ],
    '_75mm_KwK_40_L43':
        [
            [ ['germany:PzIII_IV', 'germany:Pz_IV_AusfD', 'germany:Pz_IV_AusfH', 'germany:VK2801', 'germany:G13_VK3001H'], 0.247 ]
        ],
    '_75mm_StuK_40_L43':
        [
            [ ['germany:Hetzer', 'germany:G101_StuG_III', 'germany:G05_StuG_40_AusfG'], 0.247 ]
        ],
    '_75mm_PaK_40_2':
        [
            [ ['germany:G20_Marder_II', 'germany:G39_Marder_III'], 0.247 ]
        ],
    '_75mm_PaK_40_3':
        [
            [ ['germany:G39_Marder_III'], 0.247 ]
        ],
    '_75mm_StuK42_L70':
        [
            [ ['germany:G17_JagdPzIV', 'germany:G40_Nashorn', 'germany:G05_StuG_40_AusfG'], 0.247 ],
    ...
    '_75mm_KwK_L70':
        [
            [ ['germany:E-50', 'germany:Panther_II', 'germany:PzVI', 'germany:PzVI_Tiger_P', 'germany:G13_VK3001H', 'germany:G27_VK3001P', 'germany:VK3002DB', 'germany:VK3002DB_V1', 'germany:VK3002M', 'germany:G15_VK3601H'], 0.234 ]
        ],
    '_76mm_PaK_36r':
        [
            [ ['germany:G20_Marder_II', 'germany:G39_Marder_III'], 0.247 ]
    ...
    '_88mm_PaK_36_L56':
        [
            [ ['germany:G17_JagdPzIV'], 0.250 ],
            [ ['germany:JagdPanther', 'germany:G40_Nashorn'], 0.238 ]
        ],
    '_88mm_KwK_36_L56':
        [
            [ ['germany:Indien_Panzer', 'germany:PzVI', 'germany:PzVI_Tiger_P', 'germany:G27_VK3001P', 'germany:VK3002DB', 'germany:G15_VK3601H', 'germany:VK4502A'], 0.238 ]
        ],
    '_88mm_Flak_41_L74':
        [
    ...
    '_88mm_KwK_43_L71':
        [
            ...
            [ ['germany:E-75', 'germany:Indien_Panzer', 'germany:PzVI', 'germany:G16_PzVIB_Tiger_II', 'germany:PzVI_Tiger_P', 'germany:VK4502A', 'germany:VK4502P'], 0.225 ]
        ],
    '_88mm_PaK_43_L71':
        [
            [ ['germany:Ferdinand', 'germany:JagdPanther', 'germany:G71_JagdPantherII', 'germany:G40_Nashorn'], 0.225 ]
        ],
    '_88mm_KwK_L100':
        [
            [ ['germany:E-50'], 0.188 ]
    ...
    '_9cm_KwK_51_L71':
        [
            [ ['germany:Indien_Panzer', 'germany:G91_Pro_Ag_A'], 0.225 ]
        ],
    '_105mm_KwK45_L52':
        [
            [ ['germany:E-75', 'germany:G16_PzVIB_Tiger_II', 'germany:VK4502P'], 0.220 ],
            [ ['germany:G16_PzVIB_Tiger_II', 'germany:VK4502A', 'germany:VK4502P'], 0.209 ]
        ],
    '_105mm_K18_L52':
        [
            [ ['germany:Ferdinand', 'germany:JagdPanther', 'germany:G71_JagdPantherII'], 0.209 ]
        ],
    '_105mm_K18_L52_R':
        [
    ...
    '_105mm_leFH16_L22':
        [
            [ ['germany:Pz_Sfl_IVb', 'germany:G19_Wespe'], 0.209 ]
        ],
    '_105mm_leFH18_L28':
        [
            [ ['germany:Pz_Sfl_IVb', 'germany:G19_Wespe'], 0.209 ]
    ...
    '_105mm_StuH42_L28Pz':
        [
            [ ['germany:Auf_Panther', 'germany:Panther_II', 'germany:Pz_IV_AusfH', 'germany:PzVI', 'germany:PzVI_Tiger_P', 'germany:VK2801', 'germany:G13_VK3001H', 'germany:G27_VK3001P', 'germany:VK3002DB', 'germany:G15_VK3601H'], 0.209 ]
        ],
    '_105mm_StuH42_L28':
        [
            [ ['germany:Hetzer', 'germany:G17_JagdPzIV', 'germany:G101_StuG_III', 'germany:G05_StuG_40_AusfG'], 0.209 ]
        ],
    '_105mm_KwK46_L68':
        [
            [ ['germany:E-75', 'germany:G16_PzVIB_Tiger_II', 'germany:VK4502P'], 0.209 ]
        ],
    '_128mm_PaK44_2_L61':
        [
            [ ['germany:G44_JagdTiger'], 0.162 ]
        ],
    '_128mm_KwK44_L55':
        [
            [ ['germany:E-100'], 0.162 ],
    ...
    '_128mm_PaK44_L55':
        [
            [ ['germany:Ferdinand', 'germany:G71_JagdPantherII', 'germany:G44_JagdTiger'], 0.162 ]
        ],
    '_128mm_SF_L61':
        [
    ...
    '_150mm_sIG33L11':
        [
            [ ['germany:G23_Grille'], 0.150 ]
        ],
    '_150mm_sFH13_L17':
        [
            [ ['germany:G23_Grille', 'germany:G02_Hummel'], 0.150 ]
        ],
    '_150mm_sFH18_L30':
        [
            [ ['germany:G_Panther', 'germany:G02_Hummel'], 0.143 ]
        ],
    '_150mm_sFH36_L43':
        [
    ...
    '_170mm_K72_Sf_':
        [
            [ ['germany:GW_Tiger_P', 'germany:G45_G_Tiger'], 0.108 ]
        ],
    '_210mm_Morser_21':
        [
            [ ['germany:GW_Tiger_P', 'germany:G45_G_Tiger'], 0.086 ]
        ],
# USA
    '_12.7mm_MG_HB_M2':
        [
    ...
    '_20mm_Hispano_Suiza_Birgikt_gun':
        [
            [ ['usa:A03_M3_Stuart'], 0.266 ],
            [ ['usa:A02_M2_lt', 'usa:A01_T1_Cunningham', 'usa:A24_T2_med'], 0.224 ]
        ],
    '_37mm_M-6_L53':
        [
            [ ['usa:A25_M2_med', 'usa:A03_M3_Stuart', 'usa:M5_Stuart', 'usa:A23_M7_med'], 0.300 ],
            [ ['uk:GB15_Stuart_I'], 0.300 ],
            [ ['china:Ch09_M5'], 0.300 ]
        ],
    '_37mm_M-5':
        [
            [ ['usa:A25_M2_med', 'usa:A03_M3_Stuart'], 0.300 ],
            [ ['usa:A02_M2_lt', 'usa:A24_T2_med'], 0.255 ],
            [ ['uk:GB15_Stuart_I'], 0.300 ],
            [ ['uk:GB14_M2'], 0.255 ]
        ],
    ...
    '_37mm_semiautomatic_gun_M1924':
        [
            [ ['usa:A01_T1_Cunningham', 'usa:A24_T2_med'], 0.195 ]
        ],
    ...
    '_57mm_Gun_M1_L50':
        [
            [ ['usa:A109_T56_GMC', 'usa:M8A1', 'usa:A29_T40', 'usa:A58_T67'], 0.266 ]
        ],
    '_75mm_Howitzer_M1A1':
        [
            [ ['usa:A46_T3', 'usa:A29_T40'], 0.260 ],
        ],
    '_75mm_Howitzer_M3':
        [
            [ ['usa:A25_M2_med'], 0.260 ]
        ],
    ...
    '_75mm_Gun_M3_L37':
        [
            [ ['usa:M3_Grant', 'usa:M4A3E8_Sherman', 'usa:A05_M4_Sherman', 'usa:A23_M7_med', 'usa:A36_Sherman_Jumbo', 'usa:T21'], 0.260 ],
    ...
    '_75mm_Gun_M2_L28':
        [
            [ ['usa:M3_Grant', 'usa:A23_M7_med'], 0.260 ],
    ...
    '_75mm_Gun_M7_L50':
        [
            [ ['usa:M6', 'usa:A09_T1_hvy'], 0.260 ]
        ],
    '_75mm_AT_Gun_M7_L50':
        [
            [ ['usa:A109_T56_GMC', 'usa:A30_M10_Wolverine', 'usa:M18_Hellcat', 'usa:M8A1', 'usa:A58_T67'], 0.260 ]
        ],
    '_76mm_Gun_M1A1':
        [
            [ ['usa:M4A3E8_Sherman', 'usa:A05_M4_Sherman', 'usa:M6', 'usa:A35_Pershing', 'usa:A36_Sherman_Jumbo', 'usa:A09_T1_hvy', 'usa:A07_T20', 'usa:T21'], 0.260 ],
            [ ['france:F06_ARL_44'], 0.260 ],
            [ ['uk:GB19_Sherman_Firefly', 'uk:GB50_Sherman_III'], 0.260 ]
        ],
    '_76mm_AT_Gun_M1A1':
        [
            [ ['usa:A30_M10_Wolverine', 'usa:M18_Hellcat', 'usa:A29_T40', 'usa:A58_T67'], 0.260 ]
        ],
    '_76mm_Gun_M1A2':
        [
            [ ['usa:M4A3E8_Sherman', 'usa:M6', 'usa:A35_Pershing', 'usa:A36_Sherman_Jumbo', 'usa:A07_T20', 'usa:T21', 'usa:A11_T29', 'usa:A103_T71E1'], 0.247 ]
        ],
    '_76mm_AT_Gun_M1A2':
        [
            [ ['usa:A30_M10_Wolverine', 'usa:M18_Hellcat', 'usa:M36_Slagger'], 0.247 ]
        ],
    '_76mm_Gun_T185':
        [
            [ ['usa:T69', 'usa:A103_T71E1'], 0.234 ]
        ],
    '_76mm_Gun_T102':
        [
            [ ['usa:A94_T37'], 0.234 ]
    ...
    '_90mm_Gun_M3':
        [
            [ ['usa:M6'], 0.250 ],
            [ ['usa:A63_M46_Patton', 'usa:A35_Pershing', 'usa:A07_T20', 'usa:A11_T29'], 0.238 ]
        ],
    '_90mm_AT_Gun_M3':
        [
    ...
    '_90mm_AT_Gun_T15E2':
        [
            [ ['usa:T25_2', 'usa:T25_AT', 'usa:T28', 'usa:A68_T28_Prototype'], 0.225 ]
        ],
    '_105mm_Howitzer_M3':
        [
    ...
    '_105mm_SPH_M4_L23':
        [
            [ ['usa:A63_M46_Patton', 'usa:M4A3E8_Sherman', 'usa:A05_M4_Sherman', 'usa:A35_Pershing', 'usa:A36_Sherman_Jumbo', 'usa:A07_T20'], 0.220 ],
            [ ['uk:GB19_Sherman_Firefly', 'uk:GB50_Sherman_III'], 0.220 ]
        ],
    '_105mm_AT_SPH_M4_L23':
        [
            [ ['usa:A30_M10_Wolverine'], 0.220 ]
        ],
    '_105mm_Gun_T5E1':
        [
            [ ['usa:A11_T29'], 0.220 ],
    ...
    '_105mm_AT_Gun_T5E1':
        [
            [ ['usa:T25_AT', 'usa:T28', 'usa:A68_T28_Prototype', 'usa:A14_T30', 'usa:T95'], 0.209 ]
        ],
    '_105mm_Gun_M68':
        [
            [ ['usa:A84_M48A1'], 0.209 ]
    ...
    '_105mm_Gun_T5E1M2':
        [
            [ ['usa:A63_M46_Patton', 'usa:A84_M48A1'], 0.198 ]
        ],
    '_105mm_Gun_T140E2':
        [
            [ ['usa:A89_T54E1'], 0.198 ]
    ...
    '_120mm_AT_Gun_T53':
        [
            [ ['usa:T28', 'usa:A68_T28_Prototype', 'usa:A14_T30', 'usa:T95'], 0.180 ]
        ],
    '_120mm_Gun_T122':
        [
            [ ['usa:M103'], 0.180 ]
...
# France
    ...
    '_75mm_SA49_L48':
        [
            [ ['france:F15_AMX_12t', 'france:AMX_13_75'], 0.247 ]
        ],
    '_75mm_SA50':
        [
            [ ['france:F15_AMX_12t', 'france:AMX_13_75', 'france:AMX_13_90'], 0.234 ]
        ],
    '_17_pdr_Gan_MK.II':
        [
            [ ['france:S_35CA'], 0.234 ]
    ...
    '_90mm_canon_DCA_30':
        [
            [ ['france:F07_AMX_M4_1945', 'france:F06_ARL_44', 'france:BDR_G1B'], 0.250 ]
        ],
    '_90mm_canon_DCA_30_CA':
        [
            [ ['france:F35_AMX_AC_Mle1946', 'france:ARL_V39', 'france:S_35CA'], 0.250 ]
        ],
    '_90mm_D914':
        [
    ...
    '_90mm_F3':
        [
            [ ['france:AMX_13_90', 'france:F08_AMX_50_100', 'france:F07_AMX_M4_1945', 'france:F06_ARL_44', 'france:Bat_Chatillon25t', 'france:Lorraine40t', 'france:F71_AMX_30_prototype'], 0.238 ]
        ],
    '_90mm_canon_DCA_45':
        [
            [ ['france:F08_AMX_50_100', 'france:F09_AMX_50_120', 'france:F07_AMX_M4_1945', 'france:F06_ARL_44'], 0.225 ]
        ],
    ...
    '_100mm_SA_47':
        [
            [ ['france:F08_AMX_50_100', 'france:F09_AMX_50_120', 'france:Bat_Chatillon25t', 'france:Lorraine40t', 'france:F71_AMX_30_prototype'], 0.198 ]
        ],
    '_100mm_SA_47_AC':
        [
    ...
    '_105mm_canon_13TR':
        [
            [ ['france:F07_AMX_M4_1945', 'france:F06_ARL_44'], 0.209 ]
        ],
    '_105mm_mle_F1':
        [
...
# Japan
    '_13.2mm_Type93':
        [
            [ ['japan:J15_Chi_Ni', 'japan:NC27'], 0.238 ]
        ],
    '_37mm_Type_100':
        [
            [ ['japan:J07_Chi_Ha', 'japan:J04_Ke_Ni'], 0.3 ]
        ],
    '_37mm_Type1':
        [
            [ ['japan:J07_Chi_Ha', 'japan:J04_Ke_Ni'], 0.3 ]
    ...
    '_37mm_Sogekiho':
        [
            [ ['japan:J15_Chi_Ni', 'japan:NC27'], 0.255 ]
        ],
    '_37mm_Type_94':
        [
    ...
    '_47mm_Gun_Type1':
        [
            [ ['japan:J07_Chi_Ha', 'japan:J09_Chi_He', 'japan:J06_Ke_Ho', 'japan:J21_Type_91'], 0.29 ]
        ],
    '_57mm_Gun_Type97':
        [
            [ ['japan:J07_Chi_Ha'], 0.28 ]
        ],
    '_57mm_Gun_Shin':
        [
            [ ['japan:J09_Chi_He', 'japan:J08_Chi_Nu', 'japan:J06_Ke_Ho'], 0.266 ]
        ],
    '_57mm_Gun_Type97':
        [
            [ ['japan:J15_Chi_Ni', 'japan:J03_Ha_Go', 'japan:J26_Type_89'], 0.238 ]
        ],
    '_57mm_Gun_Type90':
        [
    ...
    '_75mm_Gun_Type_99':
        [
            [ ['japan:J09_Chi_He', 'japan:J08_Chi_Nu', 'japan:J22_Type_95'], 0.26 ]
        ],
    '_75mm_Gun_Type3':
        [
            [ ['japan:J08_Chi_Nu', 'japan:J23_Mi_To'], 0.26 ]
        ],
    '_75mm_Gun_Type5':
        [
            [ ['japan:J08_Chi_Nu', 'japan:Chi_Ri', 'japan:Chi_To'], 0.26 ],
...
# get vehicles without camo defined, vehicles and guns names that are defined but not exist
def _testAllVehiclesCamo():
    ...
    for nationID in range(len(nations.NAMES)):
        ...
        for gun in vehicles.g_cache.guns(nationID).values():
            ...
            if gun_name in verify_guns:
                verify_guns.remove(gun_name)
    for extra_vehicle in sorted(verify_tanks):
        debug('vehinfo_camo: extra camo for vehicle: %s' % extra_vehicle)
    for extra_gun in verify_guns:
        debug('vehinfo_camo: extra camo for gun: %s' % extra_gun)
