...
# USSR
    ...
    'ussr:R19_IS-3':                          [  6.75 ,  3.37 , 1.21 , 1.971 ],
...
# USA
    ...
    'usa:A35_Pershing':                       [ 12.99 ,  9.71 , 2.92 , 1.118 ],
...
def _testAllVehiclesCamo():
    verify_tanks = vehinfo_camo._tanks_camo.keys()
    verify_guns = vehinfo_camo._gun_camo_modifier.keys()
