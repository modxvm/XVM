...
class XfwArenaGuiType:
    ...
    # constants.ARENA_GUI_TYPE.HALLOWEEN (WG 1.25 PvE event)
    HALLOWEEN = 101
    # constants.ARENA_GUI_TYPE.HALLOWEEN_DEFENCE (WG 1.25 PvE event)
    HALLOWEEN_DEFENCE = 102
    # STORY_MODE_REGULAR (WG 1.25)
    STORY_MODE = 104
    # Lesta 1.25.0.0
    COSMIC_EVENT = 300
    # Lesta 1.30.0.0 WT: Hyperion copycat
    WHITE_TIGER = 301
    ...
    EVENT_RANGE = (ARENA_GUI_TYPE.EVENT_BATTLES, HALLOWEEN, HALLOWEEN_DEFENCE, WHITE_TIGER, )
