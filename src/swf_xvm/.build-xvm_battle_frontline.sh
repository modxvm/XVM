...
build_as3_swf \
    ...
    -source-path xvm_battle_frontline \
    ...
    -external-library-path+=../../~output/$XVMBUILD_FLAVOR/swc/wg_battle_frontline_ui.swc \
    ...
    -output ../../~output/$XVMBUILD_FLAVOR/xvm/res_mods/mods/xfw_packages/xvm_battle/as_battle_frontline/xvm_battle_frontline.swf \
    $doc
