...
package com.xvm.battle.shared.minimap.entries.personal
{
    ...
    public class UI_RectangleAreaMinimapEntry extends RectangleAreaMinimapEntry
    {
        ...
        public function UI_RectangleAreaMinimapEntry()
        {
            super();
            visible = false;
        ...
        override protected function configUI():void
        {
            if (_entryDeleted)
            {
                Logger.add("WARNING: draw() on deleted RectangleAreaMinimapEntry");
                return;
            }
