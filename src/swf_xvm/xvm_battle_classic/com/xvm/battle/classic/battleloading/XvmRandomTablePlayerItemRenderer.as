...
package com.xvm.battle.classic.battleloading
{
    ...
    public class XvmRandomTablePlayerItemRenderer extends TablePlayerItemRenderer
    {
        private var _proxy:XvmRandomBattleLoadingItemRendererProxy;

        public function XvmRandomTablePlayerItemRenderer(container:BaseRendererContainer, position:int, isEnemy:Boolean)
        {
        ...
        {
            _proxy = new XvmRandomBattleLoadingItemRendererProxy(this, XvmBattleLoadingItemRendererProxyBase.UI_TYPE_TABLE,
