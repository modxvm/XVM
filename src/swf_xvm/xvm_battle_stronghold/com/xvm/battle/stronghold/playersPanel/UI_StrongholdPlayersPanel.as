...
package com.xvm.battle.stronghold.playersPanel
{
    ...
    public class UI_StrongholdPlayersPanel extends PlayersPanelUI
    {
        // from PlayersPanel.as
        static private const EXPAND_AREA_WIDTH:Number = 230;

        static private const XVM_PLAYERS_PANEL_LIST_ITEM_LEFT_LINKAGE:String = getQualifiedClassName(UI_StrongholdPlayersPanelListItemLeft);
        static private const XVM_PLAYERS_PANEL_LIST_ITEM_RIGHT_LINKAGE:String = getQualifiedClassName(UI_StrongholdPlayersPanelListItemRight);
        ...
        public function UI_StrongholdPlayersPanel()
        {
            Logger.add("UI_StrongholdPlayersPanel()");
            super();
        ...
        {
            //Logger.add("UI_StrongholdPlayersPanel.setListsState(): " + state);
            try
            {
        ...
        private function _onListRollOverHandler(e:MouseEvent):void
        {
            _isMouseRollOver = true;
        }

        private function _onListRollOutHandler(e:MouseEvent):void
        {
        ...
        {
            //Xvm.swfProfilerBegin("UI_StrongholdPlayersPanel.setup()");
            try
            {
            ...
            //Xvm.swfProfilerEnd("UI_StrongholdPlayersPanel.setup()");
            return null;
        }
