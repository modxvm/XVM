...
package com.xvm.battle.stronghold.playersPanel
{
    ...
    public class StrongholdPlayersPanelXvmView extends XvmViewBase
    {

        public function StrongholdPlayersPanelXvmView(view:IView)
        {
            super(view);
        }
        ...
        private function init():void
        {
            ...
            var component:UI_StrongholdPlayersPanel = new UI_StrongholdPlayersPanel();
