...
build_as3_swf \
    ...
    -source-path xvm_battle_historical \
    ...
    -external-library-path+=../../~output/$XVMBUILD_FLAVOR/swc/wg_battle_historical_ui.swc \
    ...
    -output ../../~output/$XVMBUILD_FLAVOR/xvm/res_mods/mods/xfw_packages/xvm_battle/as_battle_historical/xvm_battle_historical.swf \
    $doc
