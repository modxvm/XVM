...
package com.xvm.battle.winback.battleloading
{
    ...
    public class UI_WinbackBattleLoading extends BattleLoadingUI
    {
        ...
        public function UI_WinbackBattleLoading()
        {
            //Logger.add("UI_WinbackBattleLoading");
            super();
        ...
        private function initRenderers():void
        {
            ...
            var cls:Class = isTipsForm ? XvmWinbackTipPlayerItemRenderer : XvmWinbackTablePlayerItemRenderer;
