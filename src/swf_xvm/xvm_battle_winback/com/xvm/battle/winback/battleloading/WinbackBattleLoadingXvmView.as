...
package com.xvm.battle.winback.battleloading
{
    ...
    public class WinbackBattleLoadingXvmView extends XvmViewBase
    {
        public function WinbackBattleLoadingXvmView(view:IView)
        {
            super(view);
        }
        ...
        private function init():void
        {
            ...
            var component:UI_WinbackBattleLoading = new UI_WinbackBattleLoading();
