...
package com.xvm.battle.winback.battleloading
{
    ...
    public class XvmWinbackTablePlayerItemRenderer extends TablePlayerItemRenderer
    {
        private var _proxy:XvmWinbackBattleLoadingItemRendererProxy;

        public function XvmWinbackTablePlayerItemRenderer(container:BaseRendererContainer, position:int, isEnemy:Boolean)
        {
        ...
        {
            _proxy = new XvmWinbackBattleLoadingItemRendererProxy(this, XvmBattleLoadingItemRendererProxyBase.UI_TYPE_TABLE,
