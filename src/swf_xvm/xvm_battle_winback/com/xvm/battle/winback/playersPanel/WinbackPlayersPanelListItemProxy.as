...
package com.xvm.battle.winback.playersPanel
{
    ...
    public class WinbackPlayersPanelListItemProxy extends PlayersPanelListItemProxyBase
    {
        ...
        public function WinbackPlayersPanelListItemProxy(ui:PlayersPanelListItem, isLeftPanel:Boolean)
        {
            this.ui = ui;
        ...
        {
            return UI_WinbackPlayersPanel.fix_state(state);
        }
        ...
        {
            var winbackBattlePage:BattlePage = BattleXvmMod.winbackBattlePage;
            var playersPanel:UI_WinbackPlayersPanel = winbackBattlePage.playersPanel as UI_WinbackPlayersPanel;
            ...
            BattleXvmView.battlePage.addChildAt(extraFieldsHidden, winbackBattlePage.getChildIndex(playersPanel));
        }
    }
}
