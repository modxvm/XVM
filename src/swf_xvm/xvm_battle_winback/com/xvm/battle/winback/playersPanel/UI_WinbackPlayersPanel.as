 ...
 * https://modxvm.com/
 */
package com.xvm.battle.winback.playersPanel
{
    import com.xfw.*;
    ...
    public class UI_WinbackPlayersPanel extends PlayersPanelUI
    {
        // from PlayersPanel.as
        static private const EXPAND_AREA_WIDTH:Number = 230;

        static private const XVM_PLAYERS_PANEL_LIST_ITEM_LEFT_LINKAGE:String = getQualifiedClassName(UI_WinbackPlayersPanelListItemLeft);
        static private const XVM_PLAYERS_PANEL_LIST_ITEM_RIGHT_LINKAGE:String = getQualifiedClassName(UI_WinbackPlayersPanelListItemRight);
        ...
        public function UI_WinbackPlayersPanel()
        {
            Logger.add("UI_WinbackPlayersPanel()");
            super();
        ...
        {
            //Logger.add("UI_WinbackPlayersPanel.setListsState(): " + state);
            try
            {
        ...
        {
            //Xvm.swfProfilerBegin("UI_WinbackPlayersPanel.setup()");
            try
            {
            ...
            //Xvm.swfProfilerEnd("UI_WinbackPlayersPanel.setup()");
            return null;
        }
