...
package com.xvm.battle.winback.playersPanel
{
    ...
    public class UI_WinbackPlayersPanelListItemRight extends PlayersPanelListItemRightUI
    {
        private var proxy:WinbackPlayersPanelListItemProxy;

        public function UI_WinbackPlayersPanelListItemRight()
        {
            super();
            proxy = new WinbackPlayersPanelListItemProxy(this, false);
