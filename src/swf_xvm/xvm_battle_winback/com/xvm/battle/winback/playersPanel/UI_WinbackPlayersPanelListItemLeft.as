...
package com.xvm.battle.winback.playersPanel
{
    ...
    public class UI_WinbackPlayersPanelListItemLeft extends PlayersPanelListItemLeftUI
    {
        private var proxy:WinbackPlayersPanelListItemProxy;

        public function UI_WinbackPlayersPanelListItemLeft()
        {
            super();
            proxy = new WinbackPlayersPanelListItemProxy(this, true);
