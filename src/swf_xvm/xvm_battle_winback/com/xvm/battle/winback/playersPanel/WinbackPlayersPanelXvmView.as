...
package com.xvm.battle.winback.playersPanel
{
    ...
    public class WinbackPlayersPanelXvmView extends XvmViewBase
    {
        public function WinbackPlayersPanelXvmView(view:IView)
        {
            super(view);
        }
        ...
        private function init():void
        {
            ...
            var component:UI_WinbackPlayersPanel = new UI_WinbackPlayersPanel();
