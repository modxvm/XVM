...
package com.xvm.battle.winback.fullStats
{
    ...
    public class WinbackStatsTableItemXvm extends StatsTableItem implements IExtraFieldGroupHolder
    {
        ...
        public function WinbackStatsTableItemXvm(table:MovieClip, col:int, row:int)
        {
        ...
        override protected function draw():void
        {
            ...
            {
                var atlasName:String = _isLeftPanel ? UI_WinbackFullStats.leftAtlas : UI_WinbackFullStats.rightAtlas;
        ...
        private function updateExtraFields():void
        {
            if (extraFields)
            {
                ...
                if (_isLeftPanel)
                {
                    ...
                    bindToIconOffset = icon_x - offsetX;
                }
                else
                {
                    offsetX = EXTRA_FIELDS_X_RIGHT;
                    bindToIconOffset = icon_x - offsetX + (Config.config.battle.mirroredVehicleIcons ? 0 : ICONS_AREA_WIDTH);
                }
                extraFields.visible = true;
                extraFields.update(currentPlayerState, bindToIconOffset, offsetX, icon_y);
            }
        }
    }
}
