...
package com.xvm.battle.winback.fullStats
{
    ...
    public class WinbackFullStatsXvmView extends XvmViewBase
    {
        public function WinbackFullStatsXvmView(view:IView)
        {
            super(view);
        }
        ...
        private function init():void
        {
            ...
            var component:UI_WinbackFullStats = new UI_WinbackFullStats();
