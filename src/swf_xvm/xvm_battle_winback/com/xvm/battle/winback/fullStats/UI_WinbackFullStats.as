...
package com.xvm.battle.winback.fullStats
{
    ...
    public class UI_WinbackFullStats extends FullStatsUI
    {
        ...
        public function UI_WinbackFullStats()
        {
            Logger.add("UI_WinbackFullStats");
            super();
        ...
        {
            return new WinbackFullStatsTableCtrlXvm(FullStatsTable(statsTable), this);
        }
