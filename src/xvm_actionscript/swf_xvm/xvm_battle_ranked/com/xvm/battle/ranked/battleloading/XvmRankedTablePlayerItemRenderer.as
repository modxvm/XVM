...
package com.xvm.battle.ranked.battleloading
{
    ...
    public class XvmRankedTablePlayerItemRenderer extends TablePlayerItemRenderer
    {
        ...
        public function XvmRankedTablePlayerItemRenderer(container:BaseRendererContainer, position:int, isEnemy:Boolean)
        {
        ...
        {
            _proxy = new XvmRankedBattleLoadingItemRendererProxy(this, XvmBattleLoadingItemRendererProxyBase.UI_TYPE_TABLE,
