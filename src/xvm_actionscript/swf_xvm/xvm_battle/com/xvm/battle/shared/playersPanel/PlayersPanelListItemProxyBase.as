...
package com.xvm.battle.shared.playersPanel
{
    ...
    public class PlayersPanelListItemProxyBase extends UIComponent implements IExtraFieldGroupHolder
    {
        ...
        private var DEFAULT_PRESTIGE_WIDTH:int;
        ...
        public function PlayersPanelListItemProxyBase(ui:BasePlayersPanelListItem, isLeftPanel:Boolean)
        {
            ...
            CLIENT::WG{
                DEFAULT_PRESTIGE_WIDTH = ui.prestigeLevel.width;
            }
        ...
        private function _setup():void
        {
            try
            {
                ...
                else
                {
                    ...
                    CLIENT::WG {
                        ui.prestigeLevel.width = DEFAULT_PRESTIGE_WIDTH;
                    }
                }
        ...
        private function _applyState():void
        {
            ...
            switch (state)
            {
                ...
                case PLAYERS_PANEL_STATE.SHORT:
                    ...
                    CLIENT::WG {
                        ui.prestigeLevel.visible = false;
                    }
                    ...
                    if (mcfg.standardFields)
                    {
                        ...
                        {
                            var field:DisplayObject = _getFieldByConfigName(mcfg.standardFields[i].toLowerCase());
                            if(field != null){
                                field.visible = true;
                            }
                        }
        ...
        private function _getFieldOffsetXLeft(field:*):int
        {
            ...
            CLIENT::WG{
                if(field == ui.prestigeLevel){
                    return Macros.FormatNumber(mcfg.prestigeOffsetXLeft, currentPlayerState, 0);
                }
            }
        ...
        private function _getFieldOffsetXRight(field:*):int
        {
            ...
            CLIENT::WG{
                if(field == ui.prestigeLevel){
                    return Macros.FormatNumber(mcfg.prestigeOffsetXRight, currentPlayerState, 0);
                }
            }
