...
package com.xvm.battle.classic.battleloading
{
    ...
    public class XvmRandomTipPlayerItemRenderer extends TipPlayerItemRenderer
    {
        private var _proxy:XvmRandomBattleLoadingItemRendererProxy;

        public function XvmRandomTipPlayerItemRenderer(container:BaseRendererContainer, position:int, isEnemy:Boolean)
        {
        ...
        {
            _proxy = new XvmRandomBattleLoadingItemRendererProxy(this, XvmBattleLoadingItemRendererProxyBase.UI_TYPE_TIP,
