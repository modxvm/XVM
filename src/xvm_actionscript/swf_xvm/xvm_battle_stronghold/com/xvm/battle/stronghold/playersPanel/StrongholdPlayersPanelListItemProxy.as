...
package com.xvm.battle.stronghold.playersPanel
{
    ...
    public class StrongholdPlayersPanelListItemProxy extends PlayersPanelListItemProxyBase
    {
        ...
        public function StrongholdPlayersPanelListItemProxy(ui:PlayersPanelListItem, isLeftPanel:Boolean)
        {
            this.ui = ui;
        ...
        {
            return UI_StrongholdPlayersPanel.fix_state(state);
        }
        ...
        override protected function createExtraFields():void
        {
            ...
            var playersPanel:UI_StrongholdPlayersPanel = battlePageClassic.playersPanel as UI_StrongholdPlayersPanel;
