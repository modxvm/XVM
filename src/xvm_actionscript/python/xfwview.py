...
class XfwArenaGuiType:
    ...
    HB_OFFENCE = 101 # Lesta 1.42 Historical Battles
    LAST_STAND = 102 # WG 2.2.1
    HB_DEFENCE = 102 # Lesta 1.42 Historical Battles
    STORY_MODE_REGULAR = 104 # WG 1.25
    WHITE_TIGER = 110 # WG 2.4.0
    COSMIC_EVENT = 300 # Lesta 1.25
    WHITE_TIGER_LESTA = 301 # Lesta 1.45
    ...
    EVENT_RANGE = (ARENA_GUI_TYPE.EVENT_BATTLES, WINBACK, HB_OFFENCE, LAST_STAND, HB_DEFENCE, WHITE_TIGER, WHITE_TIGER_LESTA, )
