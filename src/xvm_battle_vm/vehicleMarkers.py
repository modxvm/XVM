...
# XVM Main
from xvm_main.consts import XVM_COMMAND, XVM_EVENT, XVM_PROFILER_COMMAND
import xvm_main.config as config
import xvm_main.pymacro as pymacro
import xvm_main.stats as stats
import xvm_main.vehinfo as vehinfo

# XVM Battle
from xvm_battle.consts import INV, XVM_BATTLE_COMMAND
from xvm_battle.shared import getGlobalBattleData
