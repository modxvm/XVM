...
_SUPPORTED_SECTIONS = _SUPPORTED_SECTIONS + _ADDITIONAL_SUPPORTED_SECTIONS
_SUPPORTED_CLIENT_SECTIONS = _SUPPORTED_CLIENT_SECTIONS + _ADDITIONAL_SUPPORTED_CLIENT_SECTIONS
