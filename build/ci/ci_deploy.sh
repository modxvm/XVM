...
deploy_xvminst()
{
    mv -f "$XVMBUILD_REPOSITORY_PATH"/xvminst/output/"$XVMBUILD_XVM_BRANCH"/"$XVMBUILD_XVM_REVISION"_"$XVMBUILD_XVM_BRANCH"_xvm.exe "$XVMBUILD_OUTPUT_PATH"/
    mv -f "$XVMBUILD_REPOSITORY_PATH"/xvminst/output/"$XVMBUILD_XVM_BRANCH"/latest_"$XVMBUILD_XVM_BRANCH"_xvm.exe "$XVMBUILD_OUTPUT_PATH"/
}
