...
deploy(){
    ...
    cp -f "$XVMBUILD_OUTPUT_PATH"/"$REPOSITORY_BRANCH"/xfw_"$REPOSITORY_COMMITS_NUMBER"_"$REPOSITORY_HASH".zip "$XVMBUILD_OUTPUT_PATH"/"$REPOSITORY_BRANCH"/xfw_latest.zip
