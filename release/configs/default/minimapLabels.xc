 ...
 */
{
  ...
  "labels": [
    ...
    //   "ally", "enemy", "squad", "teamKiller"
    {
      ...
      "format": "<font size='8' color='{{c:system:minimap.labels_data.colors.txt}}'>{{vehicle}}</font>",
      "position": { "x": 3, "y": -2 }
    },
    //   "squad"
    {
      ...
      "format": "<font size='8' color='{{c:system:minimap.labels_data.colors.txt}}'><i>{{name%.5s}}</i></font>",
      "position": { "x": 3, "y": 8 }
    },
    // "lost", "alive"
    //   "ally", "enemy", "squad", "teamKiller"
    {
      ...
      "format": "<font face='Arial' size='17' color='{{c:system:minimap.labels_data.colors.lost_dot}}'>{{.minimap.labels_data.vtype.{{vtype}}}}</font>",
      "alpha": 70
    },
    {
      "$ref": { "path":"defaultItem" },
      "flags": [ "ally", "enemy", "squad", "teamKiller", "lost", "alive" ],
      "format": "<font size='8' color='{{c:system:minimap.labels_data.colors.txt}}'><i>{{vehicle}}</i></font>",
      "alpha": 70,
      "position": { "x": -5, "y": -11 }
    },
    //   "squad"
    ...
    //   "ally", "enemy", "squad", "teamKiller"
    {
      "$ref": { "path":"defaultItem" },
      "flags": [ "ally", "enemy", "squad", "teamKiller", "lost", "alive" ],
      "format": "<font face='Arial' size='17' color='{{c:system:minimap.labels_data.colors.dot}}'>{{.minimap.labels_data.vtype.{{vtype}}}}</font>",
