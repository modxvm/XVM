...
//            { "uk-GB01_Medium_Mark_I": { "alpha": 60, "color": "0xEE4444", "distance": 100, "enabled": true, "thickness": 0.5 } }
    ...
    "labels": {
      "units": {
        "format": {
          "ally":           "<span class='mm_a'><font color='{{c:xwn8}}' alpha='{{alive?#FF|#80}}'>*</font> {{vehicle-short}}</span>",
          "teamkiller":     "<span class='mm_t'><font color='{{c:xwn8}}' alpha='{{alive?#FF|#80}}'>*</font> {{vehicle-short}}</span>",
          "enemy":          "<span class='mm_e'><font color='{{c:xwn8}}' alpha='{{alive?#FF|#80}}'>*</font> {{vehicle-short}}</span>"
        },
        "alpha" : {
          //"deadenemy": 50
        }
  ...
  "minimapAlt": {
    ...
    "labels": {
      "units": {
        "format": {
          "ally":           "<span class='mm_a'><font color='{{c:xwn8}}' alpha='{{alive?#FF|#80}}'>*</font></span>",
          "squad":          "<span class='mm_s'><font color='{{c:xwn8}}' alpha='{{alive?#FF|#80}}'>*</font></span>",
          "teamkiller":     "<span class='mm_t'><font color='{{c:xwn8}}' alpha='{{alive?#FF|#80}}'>*</font></span>",
          "enemy":          "<span class='mm_e'><font color='{{c:xwn8}}' alpha='{{alive?#FF|#80}}'>*</font></span>",
