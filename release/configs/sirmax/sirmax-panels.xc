{
  ...
  "rightPanel": {
    ...
    "formats": [
      ...
      "<textformat leading='4'>{{name%.20s~..}}<font alpha='#A0'>{{clan}}</font> <font color='{{c:xwn8}}'>{{xwn8|--}}</font></textformat>"//,
      //"<textformat leading='4' tabstops='[0,250,300]'>{{vehicle}}<tab>{{frags}}<tab><img src='xvm://configs/sirmax/img/_enemy_50.png' width='1' height='25'></tabstops>"
    ]
  }*/
}
