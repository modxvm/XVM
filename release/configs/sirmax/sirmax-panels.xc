{
  ...
  "large": {
    ...
    "extraFieldsLeft": [
      ...
      { "x": "{{r_size=2?13|{{r_size=4?16|19}}}}", "y": 0, "valign": "center", "align": "center", "format": "<font color='{{c:r}}' alpha='{{alive?#FF|#80}}'>{{r}}</font>", "shadow": {} },
    ...
    "extraFieldsRight": [
      ...
      { "x": "{{r_size=2?13|{{r_size=4?20|21}}}}", "y": 0, "valign": "center", "align": "center", "format": "<font color='{{c:r}}' alpha='{{alive?#FF|#80}}'>{{r}}</font>", "shadow": {} },
