  ...
  "carousel": {
    ...
    "normal": {
      ...
      "extraFields": [
        ...
        { "y": 33, "x": 5, "width": 60, "height": 22, "shadow": ${ "def.textFieldShadow" },
        ...
        { "y": 31, "x": 20, "width": 60, "height": 22, "shadow": ${ "def.textFieldShadow" },
        ...
        { "y": 48, "x": 7, "width": 60, "height": 22, "shadow": ${ "def.textFieldShadow" },
        ...
        { "y": 46, "x": 20, "width": 60, "height": 22, "shadow": ${ "def.textFieldShadow" },
          "format": "<font size='11' color='{{v.c_tfb}}'>{{v.tfb%0.1f}}</font>" },
        // wn8 exp
        { "y": 65, "height": 10, "bgColor": "0xFF4444", "alpha": "{{v.wn8expd?30|0}}", "x": 5, "width": 45 },
        { "y": 65, "height": 10, "bgColor": "0x00FF00", "alpha": "{{v.wn8expd?30|0}}", "x": 50, "width": 45 },
        { "y": 63, "x": 5, "width": 60, "height": 22, "shadow": ${ "def.textFieldShadow" },
          "format": "<font size='8'>wn8</font>" },
        { "y": 63, "height": 14, "bgColor": "{{v.c_wn8effd}}", "alpha": "{{v.wn8effd?100|0}}", "width": 1,
          "x": "{{py:add(5, {{py:min(90, {{py:mul({{v.wn8effd|0}}, 45)}})}})}}" },
        { "y": 61, "x": 20, "width": 60, "height": 22, "shadow": ${ "def.textFieldShadow" }, "alpha": "{{v.wn8effd?100|0}}",
