### XVM 13.0.0
  ...
  * Совместимость с World of Tanks 2.0
  * Совместимость с Мир Танков 1.37.0.0
  * Переход на единую структуру wotmod вместо множества файлов в папках mods и res_mods
  * Добавлены макросы `{{hangar}}`, `{{v.role}}`, `{{v.role_l}}`, `{{v.battlePassPoints}}`
  * Добавлена возможность обновления виджетов при выборе типа боя (`{{battletype-key}}`)
  * Добавлена опция `carousel/showSlotHighlight` для скрытия подсветки при наведении курсора, введенная в клиенте MT с версии Альфа (1.32)
  * Исправлены ошибки в работе и отображении виджетов вне окна ангара для клиента WoT
  * Исправлены опции `hangar/showGeneralChatButton` и `carousel/slotBackgroundAlpha` для клиента MT
  * Исправлен размер кнопки для перехода к лутбоксам в карусели для MT-клиента
  * Временно отключены функционал замков (лимиты) из-за переработки ангара на Coherent Gameface
  * Временно отключен функционал карусель танков из-за переработки ангара на Coherent Gameface
  * Удалена опция `hangar/showHangarPrestigeWidget` для клиента WoT

### XVM 12.8.0

  * Совместимость с World of Tanks 1.29.1.1
  * Совместимость с Мир Танков 1.36.0.0

### XVM 12.7.0

  * Совместимость с World of Tanks 1.29.1.0

### XVM 12.6.0

  * Совместимость с Мир Танков 1.35.0.0

### XVM 12.5.0

  * Совместимость с World of Tanks 1.29.0.0

### XVM 12.4.1

  * Совместимость с World of Tanks 1.28.1.1

### XVM 12.4.0

  * Совместимость с Мир Танков 1.34.0.0

### XVM 12.3.0

  **ВНИМАНИЕ**
  * Совместимость с World of Tanks 1.28.1.0
     - функциональность изменения statisticForm (окно статистики боя по нажатию на TAB) не будет работать начиная с этой версии WoT вследствие смены технологии для создания этого окна с Autodesk Scaleform на Coherent Gameface. В клиенте "Мира Танков" (Lesta) данное окно останется работоспособным.
    - На текущий момент приблизительных сроков решения проблемы нет.

### XVM 12.2.0

  * Совместимость с Мир Танков 1.33.0.0

### XVM 12.1.0

  * Совместимость с World of Tanks 1.28.0.0
  * Обновлена реализация фичи возврата экипажа

### XVM 12.0.0

  * Совместимость с Мир Танков 1.32.0.0
  * Добавлена опция `"hangar/allowChannelButtonBlinking"`
  * Добавлена опция `"battleResults/showPlayerSatisfactionWidget"`
  * Исправлена опция `"hangar/showDailyQuestWidget"`
  * Удалена поддержка режима боёв "Разминка" (режим для игроков, которые вернулись недавно в игру)

### XVM 11.9.0

  * Совместимость с World of Tanks 1.27.1.0

### XVM 11.8.1

  * Совместимость с World of Tanks 1.27.0.1
  * Исправлена опция `"hangar/showLootboxesWidget"`

### XVM 11.8.0

  * Совместимость с Мир Танков 1.31.0.0
  * Исправлена опция `"hangar/showLootboxesWidget"`

### XVM 11.7.0

  * Совместимость с World of Tanks 1.27.0.0
  * Добавлена поддержка режима боёв Зимний рейд
  * Исправлена опция `"hangar/showCustomizationCounter"`

  #### damageLog

  * Обновлён список источников урона
  * Исправлен "неизвестный снаряд" (теперь выбирается найболее схожий)
  * Исправлен группирование урона в последнем полученом уроне (lastHit)

### XVM 11.6.1

  * Совместимость с World of Tanks 1.26.1.1 nanopatch 3
  * Исправлена опция `"hangar/showBattlePassBanner"`

  #### damageLog, hitLog

  * Добавлена поддержка для снарядов типа БОПС

### XVM 11.6.0

  * Совместимость с Мир Танков 1.30.0.0
  * Добавлены опции`"hangar/lockerIconsPath"`, `"hangar/showBattleSelectorCounter"`, `"hangar/showBattleSelectorCounter"`, `"hangar/showNewCrewBooksCounter"`, `"hangar/showBattlePassBanner"`
  * Обновлён XFW.Native и зависимости, которые требуют его под Lesta клиент в связи с глобальные изменениями в методе линковки библиотеки Python 2.7
  * Добавлена поддержка режима Ваффентрагер 2025 на Lesta клиенте
  * Убран патчинг окна исследования в связи с рефактором окна на Gameface на Lesta клиенте

### XVM 11.5.1

  * Совместимость с World of Tanks 1.26.1.1

### XVM 11.5.0

  * Совместимость с World of Tanks 1.26.1.0

### XVM 11.4.0

  * Совместимость с Мир Танков 1.29.0.0
  * Добавлена поддержка танков 11 уровней (Lesta)
  * Переименована опция `"hangar/showComp7TournamentWidget"` на `"hangar/showEventTournamentWidget"`

### XVM 11.3.0

  * Совместимость с World of Tanks 1.26.0.0
  * Обновлены звуковые банки к версии WWISE 2023.1

  #### damageLog

  * Исправлен макрос {{shell-dmg}}

### XVM 11.2.0

  * Совместимость с Мир Танков 1.28.0.0
  * Добавлена поддержка режима боёв Гонки для Lesta клиенте
  * Исправлены клиентские ошибки миникарты при завершении боя (dispose)

### XVM 11.1.0

  * Совместимость с World of Tanks 1.25.1.0

  #### damageLog

  * Исправлено определния типа полученного урона

### XVM 11.0.0

  * Совместимость с World of Tanks 1.25.0.0 and Мир Танков 1.27.0.0
  * Совместимость с World of Tanks 1.24.1.0 and Мир Танков 1.26.0.0
  * Совместимость с World of Tanks 1.24.0.0 and Мир Танков 1.25.0.0
  * Добавлена поддержка для загрузки данных wn8exp, xte, xtdb и xvmscales по регионам
  * Добавлена поддержка кастомного масштаба интерфейса (2k и 4k дисплеи) для `xvm.screenWidth` и `xvm.screenHeight`
  * Добавлена поддержка для бета поддержки UTF-8 в Windows
  * Добавлена поддержка `vehicleDist` для World of Tanks в маркерах
  * Добавлена опция `"hangar/showLootboxesWidget"` option
  * Добавлена опции `"hangar/showAchievementRewardWindow"` и `"hangar/showAchievementPopups"`
  * Добавлена опция `"battle/showPrebattleDogTags"`
  * Добавлена опция `"hangar/showComp7TournamentWidget"`
  * Добавлена поддержка режима боёв "Истории"
  * Добавлена начальная поддержка режима "Натиск"
  * Добавлена поддержка для нового поведения лампы шестого чувства для Lesta клиента
  * Добавлена поддержка режима боёв На марс для Lesta клиента
  * Добавлена поддержка режима боёв Время героев для Lesta клиента
  * Исправлена опция `"battle/showPostmortemTips"` для WG клиента
  * Исправлен статус взрыва боеукладки в маркерах в Линии Фронта для Lesta клиента
  * Удалена устаревшая опция `"hangar/crewMaxPerksCount"`
  * Удалена опция-дубликат `"hangar/showButtonCounters"`
  * Отключены маркеры в режиме Разведка карт (Maps Training)
  * Убрана поддержка модификации казарм на Scaleform в связи с их переделкой на Gameface

### XVM 10.9.0

  * Совместимость с World of Tanks 1.23.1.0
  * Добавлены настройки оффсета иконки `престижа` в конфиг
  * Добавлена изначальная поддержка для иконки `престижа`
  * Опция `"carousel/cellType"` теперь использует клиентское поведение если её значение `"default"`

### XVM 10.8.1

  * Совместимость с Мир Танков 1.23.0.0
  * Исправлена опция `"hangar/blockVehicleIfLowAmmo"`
  * Исправление иконки `престижа` в статистике по Tab
  * Обновлен список коротких имен танков
  * Инсталятор: Добавлена поддержка клиента Lesta
...
### XVM 10.4.2
  ...
  * В секции "type-shell" и "c:type-shell" добавлен параметр "flame" (Lesta)
  * Добавлен параметр "groupDamageFromShots"
...
### XVM 10.4.1
  ...
  * Маркеры: добавлено отображение дистанции до техники (только для Lesta)
  * В секции `"colors"/"system"` изменены несколько параметров
  * Различные исправления и улучшения

### XVM 10.4.0

  * Совместимость с World of Tanks 1.20.0.0
  * Совместимость с Мир Танков 1.20.0.0
  * Маркеры: добавлена возможность сокрытия/перемещения точки взаимодействия

### XVM 10.3.0

  * Совместимость с World of Tanks 1.19.1.0

### XVM 10.2.1

  * Совместимость с World of Tanks 1.19.0.2
  * Различные исправления и улучшения
...
### XVM 10.2.0
  ...
  * Совместимость с World of Tanks 1.19.0.1
  * Различные исправления и улучшения

### XVM 10.1.2

  * Совместимость с World of Tanks 1.18.1.2
  * Различные исправления и улучшения

### XVM 10.1.1

  * Совместимость с World of Tanks  1.18.1.1
  * Различные исправления и улучшения

### XVM 10.1.0

  * Совместимость с World of Tanks 1.18.1.0

  #### Бой

  * Из конфига удален макрос `{{x-sense-on}}`

### XVM 10.0.0

  * Совместимость с World of Tanks 1.18.0.1

  #### Бой

  * Добавлена поддержка специальных боевых режимов в Укрепрайонах

  #### Миникарта

  * Добавлена опция:

    * `"deadAnimationAlpha"` — прозрачность анимации при уничтожении техники

  * Перемещены слои на миникарте

  #### Карусель техники

  * Добавлена опция в секциях `"carousel"/"normal"/"fields"` и `"carousel"/"small"/"fields"`:

    * `"coreBorder"` — маркер ключевой техники боевого пропуска

  * Добавлен макрос `{{v.core}}`

### XVM 9.3.4

  * Совместимость с World of Tanks 1.17.1.3

  #### Бой

  * Добавлена поддержка нормализации для макроса `{{cap.points}}`.

  * В "captureBar" добавлена настройка полосы захвата при блокировании захвата базы.

### XVM 9.3.3

  * py_macro/total_hp: исправлена нормализация в макросах `{{py:xvm.total_hp.enemy}}` and `{{py:xvm.total_hp.ally}}`

### XVM 9.3.2

  * ангар/карусель: исправление отображение карусель в которых больше чем два ряда
...
### XVM 9.2.1
  ...
  * Совместимость с World of Tanks 1.17.0.1
